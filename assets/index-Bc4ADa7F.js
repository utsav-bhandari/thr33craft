...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function kp(i,e,t){const n=new Float32Array(Xn),r=new U(0,1,0);return new un({name:"SphericalGaussianBlur",defines:{n:Xn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Wr(),fragmentShader:`
	...
	`}function xp(i){let e=new WeakMap,t=null;function n(s){if(s&&s.isTexture){const c=s.mapping,l=c===$o||c===qo,d=c===Kn||c===xi;if(l||d){let h=e.get(s);const f=h!==void 0?h.texture.pmremVersion:0;if(s.isRenderTargetTexture&&s.pmremVersion!==f)return t===null&&(t=new qs(i)),h=l?t.fromEquirectangular(s,h):t.fromCubemap(s,h),h.texture.pmremVersion=s.pmremVersion,e.set(s,h),h.texture;if(h!==void 0)return h.texture;{const m=s.image;return l&&m&&m.height>0||d&&m&&r(m)?(t===null&&(t=new qs(i)),h=l?t.fromEquirectangular(s):t.fromCubemap(s),h.texture.pmremVersion=s.pmremVersion,e.set(s,h),s.addEventListener("dispose",o),h.texture):null}}}return s}function r(s){let c=0;const l=6;for(let d=0;d<l;d++)s[d]!==void 0&&c++;return c===l}function o(s){const c=s.target;c.removeEventListener("dispose",o);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function vp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&qi("WebGLRenderer: "+n+" extension not supported."),r}}}function wp(i,e,t,n){const r={},o=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const b in f.attributes)e.remove(f.attributes[b]);f.removeEventListener("dispose",a),delete r[f.id];const m=o.get(f);m&&(e.remove(m),o.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function s(h,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function c(h){const f=h.attributes;for(const m in f)e.update(f[m],i.ARRAY_BUFFER)}function l(h){const f=[],m=h.index,b=h.attributes.position;let g=0;if(m!==null){const v=m.array;g=m.version;for(let M=0,y=v.length;M<y;M+=3){const E=v[M+0],A=v[M+1],T=v[M+2];f.push(E,A,A,T,T,E)}}else if(b!==void 0){const v=b.array;g=b.version;for(let M=0,y=v.length/3-1;M<y;M+=3){const E=M+0,A=M+1,T=M+2;f.push(E,A,A,T,T,E)}}else return;const p=new(Xc(f)?Zc:jc)(f,1);p.version=g;const u=o.get(h);u&&e.remove(u),o.set(h,p)}function d(h){const f=o.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&l(h)}else l(h);return o.get(h)}return{get:s,update:c,getWireframeAttribute:d}}function Sp(i,e,t){let n;function r(f){n=f}let o,a;function s(f){o=f.type,a=f.bytesPerElement}function c(f,m){i.drawElements(n,m,o,f*a),t.update(m,n,1)}function l(f,m,b){b!==0&&(i.drawElementsInstanced(n,m,o,f*a,b),t.update(m,n,b))}function d(f,m,b){if(b===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,o,f,0,b);let p=0;for(let u=0;u<b;u++)p+=m[u];t.update(p,n,1)}function h(f,m,b,g){if(b===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let u=0;u<f.length;u++)l(f[u]/a,m[u],g[u]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,o,f,0,g,0,b);let u=0;for(let v=0;v<b;v++)u+=m[v]*g[v];t.update(u,n,1)}}this.setMode=r,this.setIndex=s,this.render=c,this.renderInstances=l,this.renderMultiDraw=d,this.renderMultiDrawInstances=h}function Mp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(o,a,s){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=s*(o/3);break;case i.LINES:t.lines+=s*(o/2);break;case i.LINE_STRIP:t.lines+=s*(o-1);break;case i.LINE_LOOP:t.lines+=s*o;break;case i.POINTS:t.points+=s*o;break;default:We("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function yp(i,e,t){const n=new WeakMap,r=new lt;function o(a,s,c){const l=a.morphTargetInfluences,d=s.morphAttributes.position||s.morphAttributes.normal||s.morphAttributes.color,h=d!==void 0?d.length:0;let f=n.get(s);if(f===void 0||f.count!==h){let k=function(){T.dispose(),n.delete(s),s.removeEventListener("dispose",k)};f!==void 0&&f.texture.dispose();const m=s.morphAttributes.position!==void 0,b=s.morphAttributes.normal!==void 0,g=s.morphAttributes.color!==void 0,p=s.morphAttributes.position||[],u=s.morphAttributes.normal||[],v=s.morphAttributes.color||[];let M=0;m===!0&&(M=1),b===!0&&(M=2),g===!0&&(M=3);let y=s.attributes.position.count*M,E=1;y>e.maxTextureSize&&(E=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const A=new Float32Array(y*E*4*h),T=new $c(A,y,E,h);T.type=jt,T.needsUpdate=!0;const I=M*4;for(let w=0;w<h;w++){const P=p[w],z=u[w],F=v[w],V=y*E*4*w;for(let $=0;$<P.count;$++){const H=$*I;m===!0&&(r.fromBufferAttribute(P,$),A[V+H+0]=r.x,A[V+H+1]=r.y,A[V+H+2]=r.z,A[V+H+3]=0),b===!0&&(r.fromBufferAttribute(z,$),A[V+H+4]=r.x,A[V+H+5]=r.y,A[V+H+6]=r.z,A[V+H+7]=0),g===!0&&(r.fromBufferAttribute(F,$),A[V+H+8]=r.x,A[V+H+9]=r.y,A[V+H+10]=r.z,A[V+H+11]=F.itemSize===4?r.w:1)}}f={count:h,texture:T,size:new $e(y,E)},n.set(s,f),s.addEventListener("dispose",k)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let m=0;for(let g=0;g<l.length;g++)m+=l[g];const b=s.morphTargetsRelative?1:1-m;c.getUniforms().setValue(i,"morphTargetBaseInfluence",b),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:o}}function Ep(i,e,t,n){let r=new WeakMap;function o(c){const l=n.render.frame,d=c.geometry,h=e.get(c,d);if(r.get(h)!==l&&(e.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",s)===!1&&c.addEventListener("dispose",s),r.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return h}function a(){r=new WeakMap}function s(c){const l=c.target;l.removeEventListener("dispose",s),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:o,dispose:a}}const Ap={[Rc]:"LINEAR_TONE_MAPPING",[Pc]:"REINHARD_TONE_MAPPING",[Lc]:"CINEON_TONE_MAPPING",[Dc]:"ACES_FILMIC_TONE_MAPPING",[Uc]:"AGX_TONE_MAPPING",[Nc]:"NEUTRAL_TONE_MAPPING",[Ic]:"CUSTOM_TONE_MAPPING"};function Tp(i,e,t,n,r){const o=new cn(e,t,{type:i,depthBuffer:n,stencilBuffer:r}),a=new cn(e,t,{type:vn,depthBuffer:!1,stencilBuffer:!1}),s=new Vt;s.setAttribute("position",new Ct([-1,3,0,-1,-1,0,3,-1,0],3)),s.setAttribute("uv",new Ct([0,2,0,0,2,0],2));const c=new fu({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new zt(s,c),d=new Gr(-1,1,1,-1,0,1);let h=null,f=null,m=!1,b,g=null,p=[],u=!1;this.setSize=function(v,M){o.setSize(v,M),a.setSize(v,M);for(let y=0;y<p.length;y++){const E=p[y];E.setSize&&E.setSize(v,M)}},this.setEffects=function(v){p=v,u=p.length>0&&p[0].isRenderPass===!0;const M=o.width,y=o.height;for(let E=0;E<p.length;E++){const A=p[E];A.setSize&&A.setSize(M,y)}},this.begin=function(v,M){if(m||v.toneMapping===sn&&p.length===0)return!1;if(g=M,M!==null){const y=M.width,E=M.height;(o.width!==y||o.height!==E)&&this.setSize(y,E)}return u===!1&&v.setRenderTarget(o),b=v.toneMapping,v.toneMapping=sn,!0},this.hasRenderPass=function(){return u},this.end=function(v,M){v.toneMapping=b,m=!0;let y=o,E=a;for(let A=0;A<p.length;A++){const T=p[A];if(T.enabled!==!1&&(T.render(v,E,y,M),T.needsSwap!==!1)){const I=y;y=E,E=I}}if(h!==v.outputColorSpace||f!==v.toneMapping){h=v.outputColorSpace,f=v.toneMapping,c.defines={},Ve.getTransfer(h)===Ze&&(c.defines.SRGB_TRANSFER="");const A=Ap[f];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=y.texture,v.setRenderTarget(g),v.render(l,d),g=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){o.dispose(),a.dispose(),s.dispose(),c.dispose()}}const ll=new vt,Ca=new Yi(1,1),dl=new $c,ul=new Vd,hl=new el,Zs=[],Js=[],Qs=new Float32Array(16),ec=new Float32Array(9),tc=new Float32Array(4);function Ai(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let o=Zs[r];if(o===void 0&&(o=new Float32Array(r),Zs[r]=o),e!==0){n.toArray(o,0);for(let a=1,s=0;a!==e;++a)s+=t,i[a].toArray(o,s)}return o}function mt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function _t(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Xr(i,e){let t=Js[e];t===void 0&&(t=new Int32Array(e),Js[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Cp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Rp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2fv(this.addr,e),_t(t,e)}}function Pp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(mt(t,e))return;i.uniform3fv(this.addr,e),_t(t,e)}}function Lp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4fv(this.addr,e),_t(t,e)}}function Dp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),_t(t,e)}else{if(mt(t,n))return;tc.set(n),i.uniformMatrix2fv(this.addr,!1,tc),_t(t,n)}}function Ip(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),_t(t,e)}else{if(mt(t,n))return;ec.set(n),i.uniformMatrix3fv(this.addr,!1,ec),_t(t,n)}}function Up(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),_t(t,e)}else{if(mt(t,n))return;Qs.set(n),i.uniformMatrix4fv(this.addr,!1,Qs),_t(t,n)}}function Np(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Fp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2iv(this.addr,e),_t(t,e)}}function Op(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;i.uniform3iv(this.addr,e),_t(t,e)}}function Bp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4iv(this.addr,e),_t(t,e)}}function zp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Vp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2uiv(this.addr,e),_t(t,e)}}function Hp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;i.uniform3uiv(this.addr,e),_t(t,e)}}function Gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4uiv(this.addr,e),_t(t,e)}}function Wp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let o;this.type===i.SAMPLER_2D_SHADOW?(Ca.compareFunction=t.isReversedDepthBuffer()?Ha:Va,o=Ca):o=ll,t.setTexture2D(e||o,r)}function Xp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||ul,r)}function $p(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||hl,r)}function qp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||dl,r)}function Yp(i){switch(i){case 5126:return Cp;case 35664:return Rp;case 35665:return Pp;case 35666:return Lp;case 35674:return Dp;case 35675:return Ip;case 35676:return Up;case 5124:case 35670:return Np;case 35667:case 35671:return Fp;case 35668:case 35672:return Op;case 35669:case 35673:return Bp;case 5125:return zp;case 36294:return Vp;case 36295:return Hp;case 36296:return Gp;case 35678:case 36198:case 36298:case 36306:case 35682:return Wp;case 35679:case 36299:case 36307:return Xp;case 35680:case 36300:case 36308:case 36293:return $p;case 36289:case 36303:case 36311:case 36292:return qp}}function Kp(i,e){i.uniform1fv(this.addr,e)}function jp(i,e){const t=Ai(e,this.size,2);i.uniform2fv(this.addr,t)}function Zp(i,e){const t=Ai(e,this.size,3);i.uniform3fv(this.addr,t)}function Jp(i,e){const t=Ai(e,this.size,4);i.uniform4fv(this.addr,t)}function Qp(i,e){const t=Ai(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function em(i,e){const t=Ai(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function tm(i,e){const t=Ai(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function nm(i,e){i.uniform1iv(this.addr,e)}function im(i,e){i.uniform2iv(this.addr,e)}function rm(i,e){i.uniform3iv(this.addr,e)}function om(i,e){i.uniform4iv(this.addr,e)}function am(i,e){i.uniform1uiv(this.addr,e)}function sm(i,e){i.uniform2uiv(this.addr,e)}function cm(i,e){i.uniform3uiv(this.addr,e)}function lm(i,e){i.uniform4uiv(this.addr,e)}function dm(i,e,t){const n=this.cache,r=e.length,o=Xr(t,r);mt(n,o)||(i.uniform1iv(this.addr,o),_t(n,o));let a;this.type===i.SAMPLER_2D_SHADOW?a=Ca:a=ll;for(let s=0;s!==r;++s)t.setTexture2D(e[s]||a,o[s])}function um(i,e,t){const n=this.cache,r=e.length,o=Xr(t,r);mt(n,o)||(i.uniform1iv(this.addr,o),_t(n,o));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||ul,o[a])}function hm(i,e,t){const n=this.cache,r=e.length,o=Xr(t,r);mt(n,o)||(i.uniform1iv(this.addr,o),_t(n,o));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||hl,o[a])}function fm(i,e,t){const n=this.cache,r=e.length,o=Xr(t,r);mt(n,o)||(i.uniform1iv(this.addr,o),_t(n,o));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||dl,o[a])}function pm(i){switch(i){case 5126:return Kp;case 35664:return jp;case 35665:return Zp;case 35666:return Jp;case 35674:return Qp;case 35675:return em;case 35676:return tm;case 5124:case 35670:return nm;case 35667:case 35671:return im;case 35668:case 35672:return rm;case 35669:case 35673:return om;case 5125:return am;case 36294:return sm;case 36295:return cm;case 36296:return lm;case 35678:case 36198:case 36298:case 36306:case 35682:return dm;case 35679:case 36299:case 36307:return um;case 35680:case 36300:case 36308:case 36293:return hm;case 36289:case 36303:case 36311:case 36292:return fm}}class mm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Yp(t.type)}}class _m{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=pm(t.type)}}class bm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let o=0,a=r.length;o!==a;++o){const s=r[o];s.setValue(e,t[s.id],n)}}}const Po=/(\w+)(\])?(\[|\.)?/g;function nc(i,e){i.seq.push(e),i.map[e.id]=e}function gm(i,e,t){const n=i.name,r=n.length;for(Po.lastIndex=0;;){const o=Po.exec(n),a=Po.lastIndex;let s=o[1];const c=o[2]==="]",l=o[3];if(c&&(s=s|0),l===void 0||l==="["&&a+2===r){nc(t,l===void 0?new mm(s,i,e):new _m(s,i,e));break}else{let h=t.map[s];h===void 0&&(h=new bm(s),nc(t,h)),t=h}}}class Ir{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const s=e.getActiveUniform(t,a),c=e.getUniformLocation(t,s.name);gm(s,c,this)}const r=[],o=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):o.push(a);r.length>0&&(this.seq=r.concat(o))}setValue(e,t,n,r){const o=this.map[t];o!==void 0&&o.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let o=0,a=t.length;o!==a;++o){const s=t[o],c=n[s.id];c.needsUpdate!==!1&&s.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,o=e.length;r!==o;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function ic(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const km=37297;let xm=0;function vm(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),o=Math.min(e+6,t.length);for(let a=r;a<o;a++){const s=a+1;n.push(`${s===e?">":" "} ${s}: ${t[a]}`)}return n.join(`
`)}const rc=new Re;function wm(i){Ve._getMatrix(rc,Ve.workingColorSpace,i);const e=`mat3( ${rc.elements.map(t=>t.toFixed(4))} )`;switch(Ve.getTransfer(i)){case Nr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return Ae("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function oc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),o=(i.getShaderInfoLog(e)||"").trim();if(n&&o==="")return"";const a=/ERROR: 0:(\d+)/.exec(o);if(a){const s=parseInt(a[1]);return t.toUpperCase()+`

`+o+`

`+vm(i.getShaderSource(e),s)}else return o}function Sm(i,e){const t=wm(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Mm={[Rc]:"Linear",[Pc]:"Reinhard",[Lc]:"Cineon",[Dc]:"ACESFilmic",[Uc]:"AgX",[Nc]:"Neutral",[Ic]:"Custom"};function ym(i,e){const t=Mm[e];return t===void 0?(Ae("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Er=new U;function Em(){Ve.getLuminanceCoefficients(Er);const i=Er.x.toFixed(4),e=Er.y.toFixed(4),t=Er.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Um={[Tr]:"SHADOWMAP_TYPE_PCF",[Bi]:"SHADOWMAP_TYPE_VSM"};function Nm(i){return Um[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Fm={[Kn]:"ENVMAP_TYPE_CUBE",[xi]:"ENVMAP_TYPE_CUBE",[zr]:"ENVMAP_TYPE_CUBE_UV"};function Om(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Fm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Bm={[xi]:"ENVMAP_MODE_REFRACTION"};function zm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Bm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Vm={[Cc]:"ENVMAP_BLENDING_MULTIPLY",[wd]:"ENVMAP_BLENDING_MIX",[Sd]:"ENVMAP_BLENDING_ADD"};function Hm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Vm[i.combine]||"ENVMAP_BLENDING_NONE"}function Gm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Wm(i,e,t,n){const r=i.getContext(),o=t.defines;let a=t.vertexShader,s=t.fragmentShader;const c=Nm(t),l=Om(t),d=zm(t),h=Hm(t),f=Gm(t),m=Am(t),b=Tm(o),g=r.createProgram();let p,u,v=t.glslVersion?"#version "+t.glslVersion+`
...
}`;function H_(i){const e=document.createElement("style");e.innerHTML=i;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let _c=!1;class Ka{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:r,title:o="Controls",closeFolders:a=!1,injectStyles:s=!0,touchStyles:c=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",l=>{(l.code==="Enter"||l.code==="Space")&&(l.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(o),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),c&&this.domElement.classList.add("allow-touch-styles"),!_c&&s&&(H_(V_),_c=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=a}add(e,t,n,r,o){if(Object(n)===n)return new B_(this,e,t,n);const a=e[t];switch(typeof a){case"number":return new O_(this,e,t,n,r,o);case"boolean":return new P_(this,e,t);case"string":return new z_(this,e,t);case"function":return new Do(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,a)}addColor(e,t,n=1){return new F_(this,e,t,n)}addFolder(e){const t=new Ka({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof Do||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof Do)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=o=>{o.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}class G_{keyMap;keyStore;constructor(e,t){this.keyMap=e,this.keyStore=t}isPressed(e){const t=this.keyMap.getKey(e);return typeof t=="string"?this.keyStore.hasPressedKey(t):!1}}class W_{keys;constructor(){this.keys=new Map}init(e){Object.keys(e).forEach(t=>{this.keys.set(t,e[t])})}setKey(e,t){this.keys.set(e,t)}getKey(e){return this.keys.get(e)}}class X_{curPressedKeys;constructor(){this.curPressedKeys=new Set}hasPressedKey(e){return this.curPressedKeys.has(e)}addPressedKey(e){this.curPressedKeys.add(e)}removePressedKey(e){this.curPressedKeys.delete(e)}clear(){this.curPressedKeys.clear()}}class $_{player;inputManager;camera;constructor(e,t,n){this.player=e,this.inputManager=t,this.camera=n}}class q_ extends $_{chunkLoader;collisionEnabled=!0;candidatePosition=new U;occupiedBlockRange={minX:0,maxX:0,minY:0,maxY:0,minZ:0,maxZ:0};constructor(e,t,n,r){super(e,t,n),this.chunkLoader=r}setCollisionEnabled(e){this.collisionEnabled=e}isCollisionEnabled(){return this.collisionEnabled}getDirection(){let e=0,t=0,n=0;this.inputManager.isPressed("UP")&&(t+=1),this.inputManager.isPressed("DOWN")&&(t-=1),this.inputManager.isPressed("FORWARD")&&(n+=1),this.inputManager.isPressed("BACKWARD")&&(n-=1),this.inputManager.isPressed("LEFT")&&(e-=1),this.inputManager.isPressed("RIGHT")&&(e+=1);const r=new U;this.camera.getWorldDirection(r),r.y=0,r.normalize();const o=new U;o.crossVectors(r,new U(0,1,0)).normalize();const a=new U;return a.addScaledVector(r,n),a.addScaledVector(o,e),a.lengthSq()>0&&a.normalize(),{dx:a.x,dy:t,dz:a.z}}getPosition(){return this.player.position}occupiesBlock(e,t,n){const r=this.getOccupiedBlockRange(this.player.position);return e>=r.minX&&e<=r.maxX&&t>=r.minY&&t<=r.maxY&&n>=r.minZ&&n<=r.maxZ}updatePlayer(e){const t=Math.min(e,Zr.maxDeltaTime),{dx:n,dy:r,dz:o}=this.getDirection(),a=this.inputManager.isPressed("SPRINT")?1.5:1,s=new U(n*this.player.speed*a,r*this.player.speed*a,o*this.player.speed*a);this.collisionEnabled?this.moveWithCollisions(s,20,t):this.player.move(s,20,t),this.camera.position.copy(this.player.position)}moveWithCollisions(e,t,n){this.player.velocity.lerp(e,Math.min(1,t*n)),this.moveAlongAxis("x",this.player.velocity.x*n),this.moveAlongAxis("y",this.player.velocity.y*n),this.moveAlongAxis("z",this.player.velocity.z*n)}moveAlongAxis(e,t){if(t===0)return;const n=this.candidatePosition.copy(this.player.position);if(n[e]+=t,this.collidesAt(n)){this.player.velocity[e]=0;return}this.player.position[e]=n[e]}collidesAt(e){const t=this.getOccupiedBlockRange(e);if(t.minY<kt.WORLD_BOTTOM_Y)return!0;for(let n=t.minX;n<=t.maxX;n+=1)for(let r=t.minY;r<=t.maxY;r+=1)for(let o=t.minZ;o<=t.maxZ;o+=1)if(this.chunkLoader.isVoxelSolidWorld(n,r,o))return!0;return!1}getOccupiedBlockRange(e){const t=Zr.padding,n=this.player.width/2,r=this.occupiedBlockRange;return r.minX=Math.floor(e.x-n+t),r.maxX=Math.floor(e.x+n-t),r.minY=Math.floor(e.y-this.player.height+t),r.maxY=Math.floor(e.y+Zr.headClearance),r.minZ=Math.floor(e.z-n+t),r.maxZ=Math.floor(e.z+n-t),r}}class Y_{inputManager;playerController;constructor(e,t){this.inputManager=e,this.playerController=t}animate(e,t,n,r){}}class dt{constructor(e){this.yIndex=e,this.yIndex=e,this.size=Fe.size,this.voxels=new Uint16Array(this.size*dt.height*this.size),this.rotations=new Uint8Array(this.size*dt.height*this.size),this.dirty=!0}yIndex;static height=16;size;voxels;rotations;dirty;index(e,t,n){return e+this.size*(n+this.size*t)}getVoxelId(e,t,n){return this.voxels[this.index(e,t,n)]}getVoxelRotation(e,t,n){return this.rotations[this.index(e,t,n)]??0}setVoxel(e,t,n,r){const o=this.index(e,t,n);this.voxels[o]=r,this.rotations[o]=0,this.dirty=!0}setVoxelRotation(e,t,n,r){this.rotations[this.index(e,t,n)]=K_(r),this.dirty=!0}markDirty(){this.dirty=!0}}function K_(i){return(i%4+4)%4}class Fe{constructor(e,t){this.chunkX=e,this.chunkZ=t,this.chunkX=e,this.chunkZ=t,this.container=new zi,this.container.position.set(this.getWorldX(),0,this.getWorldZ()),this.isDataGenerated=!1,this.isModified=!1,this.subchunks=[],this.subchunkCount=Fe.height/dt.height;for(let n=0;n<this.subchunkCount;n++)this.subchunks[n]=new dt(n)}chunkX;chunkZ;static size=16;static height=128;container;isDataGenerated;isModified;subchunks;subchunkCount;static worldToChunkCoords(e,t){const n=Math.floor(e/Fe.size),r=Math.floor(t/Fe.size);return{chunkX:n,chunkZ:r}}getSubchunk(e){const t=Math.floor(e/dt.height);return this.subchunks[t]}getWorldX(){return this.chunkX*Fe.size}getWorldZ(){return this.chunkZ*Fe.size}getKey(){return`${this.chunkX},${this.chunkZ}`}}const rn=0,j_=1,Z_=2,J_=3,Wt=4,pl=12,ml=310,Q_=322,eb={id:1,transparent:!1,textures:{down:"minecraft:block/dirt",up:"minecraft:block/dirt",north:"minecraft:block/dirt",south:"minecraft:block/dirt",west:"minecraft:block/dirt",east:"minecraft:block/dirt",particle:"minecraft:block/dirt"}},tb={id:2,transparent:!1,textures:{down:"minecraft:block/stone",up:"minecraft:block/stone",north:"minecraft:block/stone",south:"minecraft:block/stone",west:"minecraft:block/stone",east:"minecraft:block/stone",particle:"minecraft:block/stone"}},nb={id:3,transparent:!1,textures:{down:"block/dirt",up:"block/grass_block_top",north:"block/grass_block_side",south:"block/grass_block_side",west:"block/grass_block_side",east:"block/grass_block_side",particle:"block/dirt"}},ib={id:4,transparent:!0,translucent:!0,textures:{down:"minecraft:block/water_still",up:"minecraft:block/water_still",north:"minecraft:block/water_still",south:"minecraft:block/water_still",west:"minecraft:block/water_still",east:"minecraft:block/water_still",particle:"minecraft:block/water_still"}},rb={id:5,transparent:!1,textures:{down:"minecraft:block/ancient_debris_top",up:"minecraft:block/ancient_debris_top",north:"minecraft:block/ancient_debris_side",south:"minecraft:block/ancient_debris_side",west:"minecraft:block/ancient_debris_side",east:"minecraft:block/ancient_debris_side",particle:"minecraft:block/ancient_debris_side"}},ob={id:6,transparent:!1,textures:{down:"minecraft:block/andesite",up:"minecraft:block/andesite",north:"minecraft:block/andesite",south:"minecraft:block/andesite",west:"minecraft:block/andesite",east:"minecraft:block/andesite",particle:"minecraft:block/andesite"}},ab={id:7,transparent:!0,textures:{down:"minecraft:block/azalea_leaves",up:"minecraft:block/azalea_leaves",north:"minecraft:block/azalea_leaves",south:"minecraft:block/azalea_leaves",west:"minecraft:block/azalea_leaves",east:"minecraft:block/azalea_leaves",particle:"minecraft:block/azalea_leaves"}},sb={id:8,transparent:!1,textures:{down:"minecraft:block/bamboo_block_top",up:"minecraft:block/bamboo_block_top",north:"minecraft:block/bamboo_block",south:"minecraft:block/bamboo_block",west:"minecraft:block/bamboo_block",east:"minecraft:block/bamboo_block",particle:"minecraft:block/bamboo_block"}},cb={id:9,transparent:!1,textures:{down:"minecraft:block/bamboo_mosaic",up:"minecraft:block/bamboo_mosaic",north:"minecraft:block/bamboo_mosaic",south:"minecraft:block/bamboo_mosaic",west:"minecraft:block/bamboo_mosaic",east:"minecraft:block/bamboo_mosaic",particle:"minecraft:block/bamboo_mosaic"}},lb={id:10,transparent:!1,textures:{down:"minecraft:block/bamboo_planks",up:"minecraft:block/bamboo_planks",north:"minecraft:block/bamboo_planks",south:"minecraft:block/bamboo_planks",west:"minecraft:block/bamboo_planks",east:"minecraft:block/bamboo_planks",particle:"minecraft:block/bamboo_planks"}},db={id:11,transparent:!1,textures:{down:"minecraft:block/basalt_top",up:"minecraft:block/basalt_top",north:"minecraft:block/basalt_side",south:"minecraft:block/basalt_side",west:"minecraft:block/basalt_side",east:"minecraft:block/basalt_side",particle:"minecraft:block/basalt_side"}},ub={id:12,transparent:!1,textures:{down:"minecraft:block/bedrock",up:"minecraft:block/bedrock",north:"minecraft:block/bedrock",south:"minecraft:block/bedrock",west:"minecraft:block/bedrock",east:"minecraft:block/bedrock",particle:"minecraft:block/bedrock"}},hb={id:13,transparent:!1,textures:{down:"minecraft:block/birch_log_top",up:"minecraft:block/birch_log_top",north:"minecraft:block/birch_log",south:"minecraft:block/birch_log",west:"minecraft:block/birch_log",east:"minecraft:block/birch_log",particle:"minecraft:block/birch_log"}},fb={id:14,transparent:!1,textures:{down:"minecraft:block/birch_log_top",up:"minecraft:block/birch_log_top",north:"minecraft:block/birch_log",south:"minecraft:block/birch_log",west:"minecraft:block/birch_log",east:"minecraft:block/birch_log",particle:"minecraft:block/birch_log"}},pb={id:15,transparent:!1,textures:{down:"minecraft:block/birch_planks",up:"minecraft:block/birch_planks",north:"minecraft:block/birch_planks",south:"minecraft:block/birch_planks",west:"minecraft:block/birch_planks",east:"minecraft:block/birch_planks",particle:"minecraft:block/birch_planks"}},mb={id:16,transparent:!1,textures:{down:"minecraft:block/birch_log",up:"minecraft:block/birch_log",north:"minecraft:block/birch_log",south:"minecraft:block/birch_log",west:"minecraft:block/birch_log",east:"minecraft:block/birch_log",particle:"minecraft:block/birch_log"}},_b={id:17,transparent:!1,textures:{down:"minecraft:block/blackstone_top",up:"minecraft:block/blackstone_top",north:"minecraft:block/blackstone",south:"minecraft:block/blackstone",west:"minecraft:block/blackstone",east:"minecraft:block/blackstone",particle:"minecraft:block/blackstone"}},bb={id:18,transparent:!1,textures:{down:"minecraft:block/black_concrete",up:"minecraft:block/black_concrete",north:"minecraft:block/black_concrete",south:"minecraft:block/black_concrete",west:"minecraft:block/black_concrete",east:"minecraft:block/black_concrete",particle:"minecraft:block/black_concrete"}},gb={id:19,transparent:!1,textures:{down:"minecraft:block/black_concrete_powder",up:"minecraft:block/black_concrete_powder",north:"minecraft:block/black_concrete_powder",south:"minecraft:block/black_concrete_powder",west:"minecraft:block/black_concrete_powder",east:"minecraft:block/black_concrete_powder",particle:"minecraft:block/black_concrete_powder"}},kb={id:20,transparent:!0,translucent:!0,textures:{down:"minecraft:block/black_stained_glass",up:"minecraft:block/black_stained_glass",north:"minecraft:block/black_stained_glass",south:"minecraft:block/black_stained_glass",west:"minecraft:block/black_stained_glass",east:"minecraft:block/black_stained_glass",particle:"minecraft:block/black_stained_glass"}},xb={id:21,transparent:!1,textures:{down:"minecraft:block/black_terracotta",up:"minecraft:block/black_terracotta",north:"minecraft:block/black_terracotta",south:"minecraft:block/black_terracotta",west:"minecraft:block/black_terracotta",east:"minecraft:block/black_terracotta",particle:"minecraft:block/black_terracotta"}},vb={id:22,transparent:!1,textures:{down:"minecraft:block/black_wool",up:"minecraft:block/black_wool",north:"minecraft:block/black_wool",south:"minecraft:block/black_wool",west:"minecraft:block/black_wool",east:"minecraft:block/black_wool",particle:"minecraft:block/black_wool"}},wb={id:23,transparent:!1,textures:{down:"minecraft:block/blast_furnace_top",up:"minecraft:block/blast_furnace_top",north:"minecraft:block/blast_furnace_front",south:"minecraft:block/blast_furnace_side",west:"minecraft:block/blast_furnace_side",east:"minecraft:block/blast_furnace_side",particle:"minecraft:block/blast_furnace_front"}},Sb={id:24,transparent:!1,textures:{down:"minecraft:block/blast_furnace_top",up:"minecraft:block/blast_furnace_top",north:"minecraft:block/blast_furnace_front_on",south:"minecraft:block/blast_furnace_side",west:"minecraft:block/blast_furnace_side",east:"minecraft:block/blast_furnace_side",particle:"minecraft:block/blast_furnace_front_on"}},Mb={id:25,transparent:!1,textures:{down:"minecraft:block/blue_concrete",up:"minecraft:block/blue_concrete",north:"minecraft:block/blue_concrete",south:"minecraft:block/blue_concrete",west:"minecraft:block/blue_concrete",east:"minecraft:block/blue_concrete",particle:"minecraft:block/blue_concrete"}},yb={id:26,transparent:!1,textures:{down:"minecraft:block/blue_concrete_powder",up:"minecraft:block/blue_concrete_powder",north:"minecraft:block/blue_concrete_powder",south:"minecraft:block/blue_concrete_powder",west:"minecraft:block/blue_concrete_powder",east:"minecraft:block/blue_concrete_powder",particle:"minecraft:block/blue_concrete_powder"}},Eb={id:27,transparent:!1,textures:{down:"minecraft:block/blue_ice",up:"minecraft:block/blue_ice",north:"minecraft:block/blue_ice",south:"minecraft:block/blue_ice",west:"minecraft:block/blue_ice",east:"minecraft:block/blue_ice",particle:"minecraft:block/blue_ice"}},Ab={id:28,transparent:!0,translucent:!0,textures:{down:"minecraft:block/blue_stained_glass",up:"minecraft:block/blue_stained_glass",north:"minecraft:block/blue_stained_glass",south:"minecraft:block/blue_stained_glass",west:"minecraft:block/blue_stained_glass",east:"minecraft:block/blue_stained_glass",particle:"minecraft:block/blue_stained_glass"}},Tb={id:29,transparent:!1,textures:{down:"minecraft:block/blue_terracotta",up:"minecraft:block/blue_terracotta",north:"minecraft:block/blue_terracotta",south:"minecraft:block/blue_terracotta",west:"minecraft:block/blue_terracotta",east:"minecraft:block/blue_terracotta",particle:"minecraft:block/blue_terracotta"}},Cb={id:30,transparent:!1,textures:{down:"minecraft:block/blue_wool",up:"minecraft:block/blue_wool",north:"minecraft:block/blue_wool",south:"minecraft:block/blue_wool",west:"minecraft:block/blue_wool",east:"minecraft:block/blue_wool",particle:"minecraft:block/blue_wool"}},Rb={id:31,transparent:!1,textures:{down:"minecraft:block/bone_block_top",up:"minecraft:block/bone_block_top",north:"minecraft:block/bone_block_side",south:"minecraft:block/bone_block_side",west:"minecraft:block/bone_block_side",east:"minecraft:block/bone_block_side",particle:"minecraft:block/bone_block_side"}},Pb={id:32,transparent:!1,textures:{down:"minecraft:block/oak_planks",up:"minecraft:block/oak_planks",north:"minecraft:block/bookshelf",south:"minecraft:block/bookshelf",west:"minecraft:block/bookshelf",east:"minecraft:block/bookshelf",particle:"minecraft:block/bookshelf"}},Lb={id:33,transparent:!1,textures:{down:"minecraft:block/brain_coral_block",up:"minecraft:block/brain_coral_block",north:"minecraft:block/brain_coral_block",south:"minecraft:block/brain_coral_block",west:"minecraft:block/brain_coral_block",east:"minecraft:block/brain_coral_block",particle:"minecraft:block/brain_coral_block"}},Db={id:34,transparent:!1,textures:{down:"minecraft:block/bricks",up:"minecraft:block/bricks",north:"minecraft:block/bricks",south:"minecraft:block/bricks",west:"minecraft:block/bricks",east:"minecraft:block/bricks",particle:"minecraft:block/bricks"}},Ib={id:35,transparent:!1,textures:{down:"minecraft:block/brown_concrete",up:"minecraft:block/brown_concrete",north:"minecraft:block/brown_concrete",south:"minecraft:block/brown_concrete",west:"minecraft:block/brown_concrete",east:"minecraft:block/brown_concrete",particle:"minecraft:block/brown_concrete"}},Ub={id:36,transparent:!1,textures:{down:"minecraft:block/brown_concrete_powder",up:"minecraft:block/brown_concrete_powder",north:"minecraft:block/brown_concrete_powder",south:"minecraft:block/brown_concrete_powder",west:"minecraft:block/brown_concrete_powder",east:"minecraft:block/brown_concrete_powder",particle:"minecraft:block/brown_concrete_powder"}},Nb={id:37,transparent:!1,textures:{down:"minecraft:block/brown_mushroom_block",up:"minecraft:block/brown_mushroom_block",north:"minecraft:block/brown_mushroom_block",south:"minecraft:block/brown_mushroom_block",west:"minecraft:block/brown_mushroom_block",east:"minecraft:block/brown_mushroom_block",particle:"minecraft:block/brown_mushroom_block"}},Fb={id:38,transparent:!0,translucent:!0,textures:{down:"minecraft:block/brown_stained_glass",up:"minecraft:block/brown_stained_glass",north:"minecraft:block/brown_stained_glass",south:"minecraft:block/brown_stained_glass",west:"minecraft:block/brown_stained_glass",east:"minecraft:block/brown_stained_glass",particle:"minecraft:block/brown_stained_glass"}},Ob={id:39,transparent:!1,textures:{down:"minecraft:block/brown_terracotta",up:"minecraft:block/brown_terracotta",north:"minecraft:block/brown_terracotta",south:"minecraft:block/brown_terracotta",west:"minecraft:block/brown_terracotta",east:"minecraft:block/brown_terracotta",particle:"minecraft:block/brown_terracotta"}},Bb={id:40,transparent:!1,textures:{down:"minecraft:block/brown_wool",up:"minecraft:block/brown_wool",north:"minecraft:block/brown_wool",south:"minecraft:block/brown_wool",west:"minecraft:block/brown_wool",east:"minecraft:block/brown_wool",particle:"minecraft:block/brown_wool"}},zb={id:41,transparent:!1,textures:{down:"minecraft:block/bubble_coral_block",up:"minecraft:block/bubble_coral_block",north:"minecraft:block/bubble_coral_block",south:"minecraft:block/bubble_coral_block",west:"minecraft:block/bubble_coral_block",east:"minecraft:block/bubble_coral_block",particle:"minecraft:block/bubble_coral_block"}},Vb={id:42,transparent:!1,textures:{down:"minecraft:block/budding_amethyst",up:"minecraft:block/budding_amethyst",north:"minecraft:block/budding_amethyst",south:"minecraft:block/budding_amethyst",west:"minecraft:block/budding_amethyst",east:"minecraft:block/budding_amethyst",particle:"minecraft:block/budding_amethyst"}},Hb={id:43,transparent:!1,textures:{down:"minecraft:block/calcite",up:"minecraft:block/calcite",north:"minecraft:block/calcite",south:"minecraft:block/calcite",west:"minecraft:block/calcite",east:"minecraft:block/calcite",particle:"minecraft:block/calcite"}},Gb={id:44,transparent:!1,textures:{down:"minecraft:block/dark_oak_planks",up:"minecraft:block/cartography_table_top",north:"minecraft:block/cartography_table_side3",south:"minecraft:block/cartography_table_side1",west:"minecraft:block/cartography_table_side2",east:"minecraft:block/cartography_table_side3",particle:"minecraft:block/cartography_table_side3"}},Wb={id:45,transparent:!1,textures:{down:"minecraft:block/pumpkin_top",up:"minecraft:block/pumpkin_top",north:"minecraft:block/carved_pumpkin",south:"minecraft:block/pumpkin_side",west:"minecraft:block/pumpkin_side",east:"minecraft:block/pumpkin_side",particle:"minecraft:block/carved_pumpkin"}},Xb={id:46,transparent:!1,textures:{down:"minecraft:block/cherry_log_top",up:"minecraft:block/cherry_log_top",north:"minecraft:block/cherry_log",south:"minecraft:block/cherry_log",west:"minecraft:block/cherry_log",east:"minecraft:block/cherry_log",particle:"minecraft:block/cherry_log"}},$b={id:47,transparent:!1,textures:{down:"minecraft:block/cherry_planks",up:"minecraft:block/cherry_planks",north:"minecraft:block/cherry_planks",south:"minecraft:block/cherry_planks",west:"minecraft:block/cherry_planks",east:"minecraft:block/cherry_planks",particle:"minecraft:block/cherry_planks"}},qb={id:48,transparent:!1,textures:{down:"minecraft:block/cherry_log",up:"minecraft:block/cherry_log",north:"minecraft:block/cherry_log",south:"minecraft:block/cherry_log",west:"minecraft:block/cherry_log",east:"minecraft:block/cherry_log",particle:"minecraft:block/cherry_log"}},Yb={id:49,transparent:!1,textures:{north:"block/chiseled_bookshelf_empty",east:"block/chiseled_bookshelf_side",south:"block/chiseled_bookshelf_side",west:"block/chiseled_bookshelf_side",up:"block/chiseled_bookshelf_top",down:"block/chiseled_bookshelf_top",particle:"block/chiseled_bookshelf_top"}},Kb={id:50,transparent:!1,textures:{down:"minecraft:block/chiseled_copper",up:"minecraft:block/chiseled_copper",north:"minecraft:block/chiseled_copper",south:"minecraft:block/chiseled_copper",west:"minecraft:block/chiseled_copper",east:"minecraft:block/chiseled_copper",particle:"minecraft:block/chiseled_copper"}},jb={id:51,transparent:!1,textures:{down:"minecraft:block/chiseled_deepslate",up:"minecraft:block/chiseled_deepslate",north:"minecraft:block/chiseled_deepslate",south:"minecraft:block/chiseled_deepslate",west:"minecraft:block/chiseled_deepslate",east:"minecraft:block/chiseled_deepslate",particle:"minecraft:block/chiseled_deepslate"}},Zb={id:52,transparent:!1,textures:{down:"minecraft:block/chiseled_nether_bricks",up:"minecraft:block/chiseled_nether_bricks",north:"minecraft:block/chiseled_nether_bricks",south:"minecraft:block/chiseled_nether_bricks",west:"minecraft:block/chiseled_nether_bricks",east:"minecraft:block/chiseled_nether_bricks",particle:"minecraft:block/chiseled_nether_bricks"}},Jb={id:53,transparent:!1,textures:{down:"minecraft:block/chiseled_polished_blackstone",up:"minecraft:block/chiseled_polished_blackstone",north:"minecraft:block/chiseled_polished_blackstone",south:"minecraft:block/chiseled_polished_blackstone",west:"minecraft:block/chiseled_polished_blackstone",east:"minecraft:block/chiseled_polished_blackstone",particle:"minecraft:block/chiseled_polished_blackstone"}},Qb={id:54,transparent:!1,textures:{down:"minecraft:block/chiseled_quartz_block_top",up:"minecraft:block/chiseled_quartz_block_top",north:"minecraft:block/chiseled_quartz_block",south:"minecraft:block/chiseled_quartz_block",west:"minecraft:block/chiseled_quartz_block",east:"minecraft:block/chiseled_quartz_block",particle:"minecraft:block/chiseled_quartz_block"}},eg={id:55,transparent:!1,textures:{down:"minecraft:block/red_sandstone_top",up:"minecraft:block/red_sandstone_top",north:"minecraft:block/chiseled_red_sandstone",south:"minecraft:block/chiseled_red_sandstone",west:"minecraft:block/chiseled_red_sandstone",east:"minecraft:block/chiseled_red_sandstone",particle:"minecraft:block/chiseled_red_sandstone"}},tg={id:56,transparent:!1,textures:{down:"minecraft:block/chiseled_resin_bricks",up:"minecraft:block/chiseled_resin_bricks",north:"minecraft:block/chiseled_resin_bricks",south:"minecraft:block/chiseled_resin_bricks",west:"minecraft:block/chiseled_resin_bricks",east:"minecraft:block/chiseled_resin_bricks",particle:"minecraft:block/chiseled_resin_bricks"}},ng={id:57,transparent:!1,textures:{down:"minecraft:block/sandstone_top",up:"minecraft:block/sandstone_top",north:"minecraft:block/chiseled_sandstone",south:"minecraft:block/chiseled_sandstone",west:"minecraft:block/chiseled_sandstone",east:"minecraft:block/chiseled_sandstone",particle:"minecraft:block/chiseled_sandstone"}},ig={id:58,transparent:!1,textures:{down:"minecraft:block/chiseled_stone_bricks",up:"minecraft:block/chiseled_stone_bricks",north:"minecraft:block/chiseled_stone_bricks",south:"minecraft:block/chiseled_stone_bricks",west:"minecraft:block/chiseled_stone_bricks",east:"minecraft:block/chiseled_stone_bricks",particle:"minecraft:block/chiseled_stone_bricks"}},rg={id:59,transparent:!1,textures:{down:"minecraft:block/chiseled_tuff_top",up:"minecraft:block/chiseled_tuff_top",north:"minecraft:block/chiseled_tuff",south:"minecraft:block/chiseled_tuff",west:"minecraft:block/chiseled_tuff",east:"minecraft:block/chiseled_tuff",particle:"minecraft:block/chiseled_tuff"}},og={id:60,transparent:!1,textures:{down:"minecraft:block/chiseled_tuff_bricks_top",up:"minecraft:block/chiseled_tuff_bricks_top",north:"minecraft:block/chiseled_tuff_bricks",south:"minecraft:block/chiseled_tuff_bricks",west:"minecraft:block/chiseled_tuff_bricks",east:"minecraft:block/chiseled_tuff_bricks",particle:"minecraft:block/chiseled_tuff_bricks"}},ag={id:61,transparent:!1,textures:{down:"minecraft:block/clay",up:"minecraft:block/clay",north:"minecraft:block/clay",south:"minecraft:block/clay",west:"minecraft:block/clay",east:"minecraft:block/clay",particle:"minecraft:block/clay"}},sg={id:62,transparent:!1,textures:{down:"minecraft:block/coal_block",up:"minecraft:block/coal_block",north:"minecraft:block/coal_block",south:"minecraft:block/coal_block",west:"minecraft:block/coal_block",east:"minecraft:block/coal_block",particle:"minecraft:block/coal_block"}},cg={id:63,transparent:!1,textures:{down:"minecraft:block/coal_ore",up:"minecraft:block/coal_ore",north:"minecraft:block/coal_ore",south:"minecraft:block/coal_ore",west:"minecraft:block/coal_ore",east:"minecraft:block/coal_ore",particle:"minecraft:block/coal_ore"}},lg={id:64,transparent:!1,textures:{down:"minecraft:block/coarse_dirt",up:"minecraft:block/coarse_dirt",north:"minecraft:block/coarse_dirt",south:"minecraft:block/coarse_dirt",west:"minecraft:block/coarse_dirt",east:"minecraft:block/coarse_dirt",particle:"minecraft:block/coarse_dirt"}},dg={id:65,transparent:!1,textures:{down:"minecraft:block/cobbled_deepslate",up:"minecraft:block/cobbled_deepslate",north:"minecraft:block/cobbled_deepslate",south:"minecraft:block/cobbled_deepslate",west:"minecraft:block/cobbled_deepslate",east:"minecraft:block/cobbled_deepslate",particle:"minecraft:block/cobbled_deepslate"}},ug={id:66,transparent:!1,textures:{down:"minecraft:block/cobblestone",up:"minecraft:block/cobblestone",north:"minecraft:block/cobblestone",south:"minecraft:block/cobblestone",west:"minecraft:block/cobblestone",east:"minecraft:block/cobblestone",particle:"minecraft:block/cobblestone"}},hg={id:67,transparent:!1,textures:{down:"minecraft:block/copper_block",up:"minecraft:block/copper_block",north:"minecraft:block/copper_block",south:"minecraft:block/copper_block",west:"minecraft:block/copper_block",east:"minecraft:block/copper_block",particle:"minecraft:block/copper_block"}},fg={id:68,transparent:!1,textures:{down:"minecraft:block/copper_bulb",up:"minecraft:block/copper_bulb",north:"minecraft:block/copper_bulb",south:"minecraft:block/copper_bulb",west:"minecraft:block/copper_bulb",east:"minecraft:block/copper_bulb",particle:"minecraft:block/copper_bulb"}},pg={id:69,transparent:!1,textures:{down:"minecraft:block/copper_bulb_lit",up:"minecraft:block/copper_bulb_lit",north:"minecraft:block/copper_bulb_lit",south:"minecraft:block/copper_bulb_lit",west:"minecraft:block/copper_bulb_lit",east:"minecraft:block/copper_bulb_lit",particle:"minecraft:block/copper_bulb_lit"}},mg={id:70,transparent:!1,textures:{down:"minecraft:block/copper_bulb_lit_powered",up:"minecraft:block/copper_bulb_lit_powered",north:"minecraft:block/copper_bulb_lit_powered",south:"minecraft:block/copper_bulb_lit_powered",west:"minecraft:block/copper_bulb_lit_powered",east:"minecraft:block/copper_bulb_lit_powered",particle:"minecraft:block/copper_bulb_lit_powered"}},_g={id:71,transparent:!1,textures:{down:"minecraft:block/copper_bulb_powered",up:"minecraft:block/copper_bulb_powered",north:"minecraft:block/copper_bulb_powered",south:"minecraft:block/copper_bulb_powered",west:"minecraft:block/copper_bulb_powered",east:"minecraft:block/copper_bulb_powered",particle:"minecraft:block/copper_bulb_powered"}},bg={id:72,transparent:!1,textures:{down:"minecraft:block/copper_grate",up:"minecraft:block/copper_grate",north:"minecraft:block/copper_grate",south:"minecraft:block/copper_grate",west:"minecraft:block/copper_grate",east:"minecraft:block/copper_grate",particle:"minecraft:block/copper_grate"}},gg={id:73,transparent:!1,textures:{down:"minecraft:block/copper_ore",up:"minecraft:block/copper_ore",north:"minecraft:block/copper_ore",south:"minecraft:block/copper_ore",west:"minecraft:block/copper_ore",east:"minecraft:block/copper_ore",particle:"minecraft:block/copper_ore"}},kg={id:74,transparent:!1,textures:{down:"minecraft:block/cracked_deepslate_bricks",up:"minecraft:block/cracked_deepslate_bricks",north:"minecraft:block/cracked_deepslate_bricks",south:"minecraft:block/cracked_deepslate_bricks",west:"minecraft:block/cracked_deepslate_bricks",east:"minecraft:block/cracked_deepslate_bricks",particle:"minecraft:block/cracked_deepslate_bricks"}},xg={id:75,transparent:!1,textures:{down:"minecraft:block/cracked_deepslate_tiles",up:"minecraft:block/cracked_deepslate_tiles",north:"minecraft:block/cracked_deepslate_tiles",south:"minecraft:block/cracked_deepslate_tiles",west:"minecraft:block/cracked_deepslate_tiles",east:"minecraft:block/cracked_deepslate_tiles",particle:"minecraft:block/cracked_deepslate_tiles"}},vg={id:76,transparent:!1,textures:{down:"minecraft:block/cracked_nether_bricks",up:"minecraft:block/cracked_nether_bricks",north:"minecraft:block/cracked_nether_bricks",south:"minecraft:block/cracked_nether_bricks",west:"minecraft:block/cracked_nether_bricks",east:"minecraft:block/cracked_nether_bricks",particle:"minecraft:block/cracked_nether_bricks"}},wg={id:77,transparent:!1,textures:{down:"minecraft:block/cracked_polished_blackstone_bricks",up:"minecraft:block/cracked_polished_blackstone_bricks",north:"minecraft:block/cracked_polished_blackstone_bricks",south:"minecraft:block/cracked_polished_blackstone_bricks",west:"minecraft:block/cracked_polished_blackstone_bricks",east:"minecraft:block/cracked_polished_blackstone_bricks",particle:"minecraft:block/cracked_polished_blackstone_bricks"}},Sg={id:78,transparent:!1,textures:{down:"minecraft:block/cracked_stone_bricks",up:"minecraft:block/cracked_stone_bricks",north:"minecraft:block/cracked_stone_bricks",south:"minecraft:block/cracked_stone_bricks",west:"minecraft:block/cracked_stone_bricks",east:"minecraft:block/cracked_stone_bricks",particle:"minecraft:block/cracked_stone_bricks"}},Mg={id:79,transparent:!1,textures:{down:"block/crafter_bottom",up:"block/crafter_top",north:"block/crafter_north",south:"block/crafter_south",west:"block/crafter_west",east:"block/crafter_east",particle:"block/crafter_north"}},yg={id:80,transparent:!1,textures:{down:"minecraft:block/oak_planks",up:"minecraft:block/crafting_table_top",north:"minecraft:block/crafting_table_front",south:"minecraft:block/crafting_table_side",west:"minecraft:block/crafting_table_front",east:"minecraft:block/crafting_table_side",particle:"minecraft:block/crafting_table_front"}},Eg={id:81,transparent:!1,textures:{down:"minecraft:block/creaking_heart_top",up:"minecraft:block/creaking_heart_top",north:"minecraft:block/creaking_heart",south:"minecraft:block/creaking_heart",west:"minecraft:block/creaking_heart",east:"minecraft:block/creaking_heart",particle:"minecraft:block/creaking_heart"}},Ag={id:82,transparent:!1,textures:{down:"minecraft:block/creaking_heart_top_awake",up:"minecraft:block/creaking_heart_top_awake",north:"minecraft:block/creaking_heart_awake",south:"minecraft:block/creaking_heart_awake",west:"minecraft:block/creaking_heart_awake",east:"minecraft:block/creaking_heart_awake",particle:"minecraft:block/creaking_heart_awake"}},Tg={id:83,transparent:!1,textures:{down:"minecraft:block/creaking_heart_top_awake",up:"minecraft:block/creaking_heart_top_awake",north:"minecraft:block/creaking_heart_awake",south:"minecraft:block/creaking_heart_awake",west:"minecraft:block/creaking_heart_awake",east:"minecraft:block/creaking_heart_awake",particle:"minecraft:block/creaking_heart_awake"}},Cg={id:84,transparent:!1,textures:{down:"minecraft:block/creaking_heart_top_dormant",up:"minecraft:block/creaking_heart_top_dormant",north:"minecraft:block/creaking_heart_dormant",south:"minecraft:block/creaking_heart_dormant",west:"minecraft:block/creaking_heart_dormant",east:"minecraft:block/creaking_heart_dormant",particle:"minecraft:block/creaking_heart_dormant"}},Rg={id:85,transparent:!1,textures:{down:"minecraft:block/creaking_heart_top_dormant",up:"minecraft:block/creaking_heart_top_dormant",north:"minecraft:block/creaking_heart_dormant",south:"minecraft:block/creaking_heart_dormant",west:"minecraft:block/creaking_heart_dormant",east:"minecraft:block/creaking_heart_dormant",particle:"minecraft:block/creaking_heart_dormant"}},Pg={id:86,transparent:!1,textures:{down:"minecraft:block/creaking_heart_top",up:"minecraft:block/creaking_heart_top",north:"minecraft:block/creaking_heart",south:"minecraft:block/creaking_heart",west:"minecraft:block/creaking_heart",east:"minecraft:block/creaking_heart",particle:"minecraft:block/creaking_heart"}},Lg={id:87,transparent:!1,textures:{down:"minecraft:block/crimson_stem",up:"minecraft:block/crimson_stem",north:"minecraft:block/crimson_stem",south:"minecraft:block/crimson_stem",west:"minecraft:block/crimson_stem",east:"minecraft:block/crimson_stem",particle:"minecraft:block/crimson_stem"}},Dg={id:88,transparent:!1,textures:{down:"minecraft:block/crimson_planks",up:"minecraft:block/crimson_planks",north:"minecraft:block/crimson_planks",south:"minecraft:block/crimson_planks",west:"minecraft:block/crimson_planks",east:"minecraft:block/crimson_planks",particle:"minecraft:block/crimson_planks"}},Ig={id:89,transparent:!1,textures:{down:"minecraft:block/crimson_stem_top",up:"minecraft:block/crimson_stem_top",north:"minecraft:block/crimson_stem",south:"minecraft:block/crimson_stem",west:"minecraft:block/crimson_stem",east:"minecraft:block/crimson_stem",particle:"minecraft:block/crimson_stem"}},Ug={id:90,transparent:!1,textures:{down:"minecraft:block/crying_obsidian",up:"minecraft:block/crying_obsidian",north:"minecraft:block/crying_obsidian",south:"minecraft:block/crying_obsidian",west:"minecraft:block/crying_obsidian",east:"minecraft:block/crying_obsidian",particle:"minecraft:block/crying_obsidian"}},Ng={id:91,transparent:!1,textures:{down:"minecraft:block/cut_copper",up:"minecraft:block/cut_copper",north:"minecraft:block/cut_copper",south:"minecraft:block/cut_copper",west:"minecraft:block/cut_copper",east:"minecraft:block/cut_copper",particle:"minecraft:block/cut_copper"}},Fg={id:92,transparent:!1,textures:{down:"minecraft:block/red_sandstone_top",up:"minecraft:block/red_sandstone_top",north:"minecraft:block/cut_red_sandstone",south:"minecraft:block/cut_red_sandstone",west:"minecraft:block/cut_red_sandstone",east:"minecraft:block/cut_red_sandstone",particle:"minecraft:block/cut_red_sandstone"}},Og={id:93,transparent:!1,textures:{down:"minecraft:block/sandstone_top",up:"minecraft:block/sandstone_top",north:"minecraft:block/cut_sandstone",south:"minecraft:block/cut_sandstone",west:"minecraft:block/cut_sandstone",east:"minecraft:block/cut_sandstone",particle:"minecraft:block/cut_sandstone"}},Bg={id:94,transparent:!1,textures:{down:"minecraft:block/cyan_concrete",up:"minecraft:block/cyan_concrete",north:"minecraft:block/cyan_concrete",south:"minecraft:block/cyan_concrete",west:"minecraft:block/cyan_concrete",east:"minecraft:block/cyan_concrete",particle:"minecraft:block/cyan_concrete"}},zg={id:95,transparent:!1,textures:{down:"minecraft:block/cyan_concrete_powder",up:"minecraft:block/cyan_concrete_powder",north:"minecraft:block/cyan_concrete_powder",south:"minecraft:block/cyan_concrete_powder",west:"minecraft:block/cyan_concrete_powder",east:"minecraft:block/cyan_concrete_powder",particle:"minecraft:block/cyan_concrete_powder"}},Vg={id:96,transparent:!0,translucent:!0,textures:{down:"minecraft:block/cyan_stained_glass",up:"minecraft:block/cyan_stained_glass",north:"minecraft:block/cyan_stained_glass",south:"minecraft:block/cyan_stained_glass",west:"minecraft:block/cyan_stained_glass",east:"minecraft:block/cyan_stained_glass",particle:"minecraft:block/cyan_stained_glass"}},Hg={id:97,transparent:!1,textures:{down:"minecraft:block/cyan_terracotta",up:"minecraft:block/cyan_terracotta",north:"minecraft:block/cyan_terracotta",south:"minecraft:block/cyan_terracotta",west:"minecraft:block/cyan_terracotta",east:"minecraft:block/cyan_terracotta",particle:"minecraft:block/cyan_terracotta"}},Gg={id:98,transparent:!1,textures:{down:"minecraft:block/cyan_wool",up:"minecraft:block/cyan_wool",north:"minecraft:block/cyan_wool",south:"minecraft:block/cyan_wool",west:"minecraft:block/cyan_wool",east:"minecraft:block/cyan_wool",particle:"minecraft:block/cyan_wool"}},Wg={id:99,transparent:!1,textures:{down:"minecraft:block/dark_oak_log_top",up:"minecraft:block/dark_oak_log_top",north:"minecraft:block/dark_oak_log",south:"minecraft:block/dark_oak_log",west:"minecraft:block/dark_oak_log",east:"minecraft:block/dark_oak_log",particle:"minecraft:block/dark_oak_log"}},Xg={id:100,transparent:!1,textures:{down:"minecraft:block/dark_oak_log_top",up:"minecraft:block/dark_oak_log_top",north:"minecraft:block/dark_oak_log",south:"minecraft:block/dark_oak_log",west:"minecraft:block/dark_oak_log",east:"minecraft:block/dark_oak_log",particle:"minecraft:block/dark_oak_log"}},$g={id:101,transparent:!1,textures:{down:"minecraft:block/dark_oak_planks",up:"minecraft:block/dark_oak_planks",north:"minecraft:block/dark_oak_planks",south:"minecraft:block/dark_oak_planks",west:"minecraft:block/dark_oak_planks",east:"minecraft:block/dark_oak_planks",particle:"minecraft:block/dark_oak_planks"}},qg={id:102,transparent:!1,textures:{down:"minecraft:block/dark_oak_log",up:"minecraft:block/dark_oak_log",north:"minecraft:block/dark_oak_log",south:"minecraft:block/dark_oak_log",west:"minecraft:block/dark_oak_log",east:"minecraft:block/dark_oak_log",particle:"minecraft:block/dark_oak_log"}},Yg={id:103,transparent:!1,textures:{down:"minecraft:block/dark_prismarine",up:"minecraft:block/dark_prismarine",north:"minecraft:block/dark_prismarine",south:"minecraft:block/dark_prismarine",west:"minecraft:block/dark_prismarine",east:"minecraft:block/dark_prismarine",particle:"minecraft:block/dark_prismarine"}},Kg={id:104,transparent:!1,textures:{down:"minecraft:block/dead_brain_coral_block",up:"minecraft:block/dead_brain_coral_block",north:"minecraft:block/dead_brain_coral_block",south:"minecraft:block/dead_brain_coral_block",west:"minecraft:block/dead_brain_coral_block",east:"minecraft:block/dead_brain_coral_block",particle:"minecraft:block/dead_brain_coral_block"}},jg={id:105,transparent:!1,textures:{down:"minecraft:block/dead_bubble_coral_block",up:"minecraft:block/dead_bubble_coral_block",north:"minecraft:block/dead_bubble_coral_block",south:"minecraft:block/dead_bubble_coral_block",west:"minecraft:block/dead_bubble_coral_block",east:"minecraft:block/dead_bubble_coral_block",particle:"minecraft:block/dead_bubble_coral_block"}},Zg={id:106,transparent:!1,textures:{down:"minecraft:block/dead_fire_coral_block",up:"minecraft:block/dead_fire_coral_block",north:"minecraft:block/dead_fire_coral_block",south:"minecraft:block/dead_fire_coral_block",west:"minecraft:block/dead_fire_coral_block",east:"minecraft:block/dead_fire_coral_block",particle:"minecraft:block/dead_fire_coral_block"}},Jg={id:107,transparent:!1,textures:{down:"minecraft:block/dead_horn_coral_block",up:"minecraft:block/dead_horn_coral_block",north:"minecraft:block/dead_horn_coral_block",south:"minecraft:block/dead_horn_coral_block",west:"minecraft:block/dead_horn_coral_block",east:"minecraft:block/dead_horn_coral_block",particle:"minecraft:block/dead_horn_coral_block"}},Qg={id:108,transparent:!1,textures:{down:"minecraft:block/dead_tube_coral_block",up:"minecraft:block/dead_tube_coral_block",north:"minecraft:block/dead_tube_coral_block",south:"minecraft:block/dead_tube_coral_block",west:"minecraft:block/dead_tube_coral_block",east:"minecraft:block/dead_tube_coral_block",particle:"minecraft:block/dead_tube_coral_block"}},ek={id:109,transparent:!1,textures:{down:"minecraft:block/deepslate_top",up:"minecraft:block/deepslate_top",north:"minecraft:block/deepslate",south:"minecraft:block/deepslate",west:"minecraft:block/deepslate",east:"minecraft:block/deepslate",particle:"minecraft:block/deepslate"}},tk={id:110,transparent:!1,textures:{down:"minecraft:block/deepslate_bricks",up:"minecraft:block/deepslate_bricks",north:"minecraft:block/deepslate_bricks",south:"minecraft:block/deepslate_bricks",west:"minecraft:block/deepslate_bricks",east:"minecraft:block/deepslate_bricks",particle:"minecraft:block/deepslate_bricks"}},nk={id:111,transparent:!1,textures:{down:"minecraft:block/deepslate_coal_ore",up:"minecraft:block/deepslate_coal_ore",north:"minecraft:block/deepslate_coal_ore",south:"minecraft:block/deepslate_coal_ore",west:"minecraft:block/deepslate_coal_ore",east:"minecraft:block/deepslate_coal_ore",particle:"minecraft:block/deepslate_coal_ore"}},ik={id:112,transparent:!1,textures:{down:"minecraft:block/deepslate_copper_ore",up:"minecraft:block/deepslate_copper_ore",north:"minecraft:block/deepslate_copper_ore",south:"minecraft:block/deepslate_copper_ore",west:"minecraft:block/deepslate_copper_ore",east:"minecraft:block/deepslate_copper_ore",particle:"minecraft:block/deepslate_copper_ore"}},rk={id:113,transparent:!1,textures:{down:"minecraft:block/deepslate_diamond_ore",up:"minecraft:block/deepslate_diamond_ore",north:"minecraft:block/deepslate_diamond_ore",south:"minecraft:block/deepslate_diamond_ore",west:"minecraft:block/deepslate_diamond_ore",east:"minecraft:block/deepslate_diamond_ore",particle:"minecraft:block/deepslate_diamond_ore"}},ok={id:114,transparent:!1,textures:{down:"minecraft:block/deepslate_emerald_ore",up:"minecraft:block/deepslate_emerald_ore",north:"minecraft:block/deepslate_emerald_ore",south:"minecraft:block/deepslate_emerald_ore",west:"minecraft:block/deepslate_emerald_ore",east:"minecraft:block/deepslate_emerald_ore",particle:"minecraft:block/deepslate_emerald_ore"}},ak={id:115,transparent:!1,textures:{down:"minecraft:block/deepslate_gold_ore",up:"minecraft:block/deepslate_gold_ore",north:"minecraft:block/deepslate_gold_ore",south:"minecraft:block/deepslate_gold_ore",west:"minecraft:block/deepslate_gold_ore",east:"minecraft:block/deepslate_gold_ore",particle:"minecraft:block/deepslate_gold_ore"}},sk={id:116,transparent:!1,textures:{down:"minecraft:block/deepslate_iron_ore",up:"minecraft:block/deepslate_iron_ore",north:"minecraft:block/deepslate_iron_ore",south:"minecraft:block/deepslate_iron_ore",west:"minecraft:block/deepslate_iron_ore",east:"minecraft:block/deepslate_iron_ore",particle:"minecraft:block/deepslate_iron_ore"}},ck={id:117,transparent:!1,textures:{down:"minecraft:block/deepslate_lapis_ore",up:"minecraft:block/deepslate_lapis_ore",north:"minecraft:block/deepslate_lapis_ore",south:"minecraft:block/deepslate_lapis_ore",west:"minecraft:block/deepslate_lapis_ore",east:"minecraft:block/deepslate_lapis_ore",particle:"minecraft:block/deepslate_lapis_ore"}},lk={id:118,transparent:!1,textures:{down:"minecraft:block/deepslate_redstone_ore",up:"minecraft:block/deepslate_redstone_ore",north:"minecraft:block/deepslate_redstone_ore",south:"minecraft:block/deepslate_redstone_ore",west:"minecraft:block/deepslate_redstone_ore",east:"minecraft:block/deepslate_redstone_ore",particle:"minecraft:block/deepslate_redstone_ore"}},dk={id:119,transparent:!1,textures:{down:"minecraft:block/deepslate_tiles",up:"minecraft:block/deepslate_tiles",north:"minecraft:block/deepslate_tiles",south:"minecraft:block/deepslate_tiles",west:"minecraft:block/deepslate_tiles",east:"minecraft:block/deepslate_tiles",particle:"minecraft:block/deepslate_tiles"}},uk={id:120,transparent:!1,textures:{down:"minecraft:block/diamond_block",up:"minecraft:block/diamond_block",north:"minecraft:block/diamond_block",south:"minecraft:block/diamond_block",west:"minecraft:block/diamond_block",east:"minecraft:block/diamond_block",particle:"minecraft:block/diamond_block"}},hk={id:121,transparent:!1,textures:{down:"minecraft:block/diamond_ore",up:"minecraft:block/diamond_ore",north:"minecraft:block/diamond_ore",south:"minecraft:block/diamond_ore",west:"minecraft:block/diamond_ore",east:"minecraft:block/diamond_ore",particle:"minecraft:block/diamond_ore"}},fk={id:122,transparent:!1,textures:{down:"minecraft:block/diorite",up:"minecraft:block/diorite",north:"minecraft:block/diorite",south:"minecraft:block/diorite",west:"minecraft:block/diorite",east:"minecraft:block/diorite",particle:"minecraft:block/diorite"}},pk={id:123,transparent:!1,textures:{down:"minecraft:block/acacia_log_top",up:"minecraft:block/acacia_log_top",north:"minecraft:block/acacia_log",south:"minecraft:block/acacia_log",west:"minecraft:block/acacia_log",east:"minecraft:block/acacia_log",particle:"minecraft:block/acacia_log"}},mk={id:124,transparent:!1,textures:{down:"minecraft:block/furnace_top",up:"minecraft:block/furnace_top",north:"minecraft:block/dispenser_front",south:"minecraft:block/furnace_side",west:"minecraft:block/furnace_side",east:"minecraft:block/furnace_side",particle:"minecraft:block/dispenser_front"}},_k={id:125,transparent:!1,textures:{down:"block/dried_kelp_bottom",up:"block/dried_kelp_top",north:"block/dried_kelp_side",south:"block/dried_kelp_side",west:"block/dried_kelp_side",east:"block/dried_kelp_side",particle:"block/dried_kelp_side"}},bk={id:126,transparent:!1,textures:{down:"minecraft:block/dripstone_block",up:"minecraft:block/dripstone_block",north:"minecraft:block/dripstone_block",south:"minecraft:block/dripstone_block",west:"minecraft:block/dripstone_block",east:"minecraft:block/dripstone_block",particle:"minecraft:block/dripstone_block"}},gk={id:127,transparent:!1,textures:{down:"minecraft:block/furnace_top",up:"minecraft:block/furnace_top",north:"minecraft:block/dropper_front",south:"minecraft:block/furnace_side",west:"minecraft:block/furnace_side",east:"minecraft:block/furnace_side",particle:"minecraft:block/dropper_front"}},kk={id:128,transparent:!1,textures:{down:"minecraft:block/emerald_block",up:"minecraft:block/emerald_block",north:"minecraft:block/emerald_block",south:"minecraft:block/emerald_block",west:"minecraft:block/emerald_block",east:"minecraft:block/emerald_block",particle:"minecraft:block/emerald_block"}},xk={id:129,transparent:!1,textures:{down:"minecraft:block/emerald_ore",up:"minecraft:block/emerald_ore",north:"minecraft:block/emerald_ore",south:"minecraft:block/emerald_ore",west:"minecraft:block/emerald_ore",east:"minecraft:block/emerald_ore",particle:"minecraft:block/emerald_ore"}},vk={id:130,transparent:!1,textures:{down:"minecraft:block/end_stone",up:"minecraft:block/end_stone",north:"minecraft:block/end_stone",south:"minecraft:block/end_stone",west:"minecraft:block/end_stone",east:"minecraft:block/end_stone",particle:"minecraft:block/end_stone"}},wk={id:131,transparent:!1,textures:{down:"minecraft:block/end_stone_bricks",up:"minecraft:block/end_stone_bricks",north:"minecraft:block/end_stone_bricks",south:"minecraft:block/end_stone_bricks",west:"minecraft:block/end_stone_bricks",east:"minecraft:block/end_stone_bricks",particle:"minecraft:block/end_stone_bricks"}},Sk={id:132,transparent:!1,textures:{down:"minecraft:block/exposed_chiseled_copper",up:"minecraft:block/exposed_chiseled_copper",north:"minecraft:block/exposed_chiseled_copper",south:"minecraft:block/exposed_chiseled_copper",west:"minecraft:block/exposed_chiseled_copper",east:"minecraft:block/exposed_chiseled_copper",particle:"minecraft:block/exposed_chiseled_copper"}},Mk={id:133,transparent:!1,textures:{down:"minecraft:block/exposed_copper",up:"minecraft:block/exposed_copper",north:"minecraft:block/exposed_copper",south:"minecraft:block/exposed_copper",west:"minecraft:block/exposed_copper",east:"minecraft:block/exposed_copper",particle:"minecraft:block/exposed_copper"}},yk={id:134,transparent:!1,textures:{down:"minecraft:block/exposed_copper_bulb",up:"minecraft:block/exposed_copper_bulb",north:"minecraft:block/exposed_copper_bulb",south:"minecraft:block/exposed_copper_bulb",west:"minecraft:block/exposed_copper_bulb",east:"minecraft:block/exposed_copper_bulb",particle:"minecraft:block/exposed_copper_bulb"}},Ek={id:135,transparent:!1,textures:{down:"minecraft:block/exposed_copper_bulb_lit",up:"minecraft:block/exposed_copper_bulb_lit",north:"minecraft:block/exposed_copper_bulb_lit",south:"minecraft:block/exposed_copper_bulb_lit",west:"minecraft:block/exposed_copper_bulb_lit",east:"minecraft:block/exposed_copper_bulb_lit",particle:"minecraft:block/exposed_copper_bulb_lit"}},Ak={id:136,transparent:!1,textures:{down:"minecraft:block/exposed_copper_bulb_lit_powered",up:"minecraft:block/exposed_copper_bulb_lit_powered",north:"minecraft:block/exposed_copper_bulb_lit_powered",south:"minecraft:block/exposed_copper_bulb_lit_powered",west:"minecraft:block/exposed_copper_bulb_lit_powered",east:"minecraft:block/exposed_copper_bulb_lit_powered",particle:"minecraft:block/exposed_copper_bulb_lit_powered"}},Tk={id:137,transparent:!1,textures:{down:"minecraft:block/exposed_copper_bulb_powered",up:"minecraft:block/exposed_copper_bulb_powered",north:"minecraft:block/exposed_copper_bulb_powered",south:"minecraft:block/exposed_copper_bulb_powered",west:"minecraft:block/exposed_copper_bulb_powered",east:"minecraft:block/exposed_copper_bulb_powered",particle:"minecraft:block/exposed_copper_bulb_powered"}},Ck={id:138,transparent:!1,textures:{down:"minecraft:block/exposed_copper_grate",up:"minecraft:block/exposed_copper_grate",north:"minecraft:block/exposed_copper_grate",south:"minecraft:block/exposed_copper_grate",west:"minecraft:block/exposed_copper_grate",east:"minecraft:block/exposed_copper_grate",particle:"minecraft:block/exposed_copper_grate"}},Rk={id:139,transparent:!1,textures:{down:"minecraft:block/exposed_cut_copper",up:"minecraft:block/exposed_cut_copper",north:"minecraft:block/exposed_cut_copper",south:"minecraft:block/exposed_cut_copper",west:"minecraft:block/exposed_cut_copper",east:"minecraft:block/exposed_cut_copper",particle:"minecraft:block/exposed_cut_copper"}},Pk={id:140,transparent:!1,textures:{down:"minecraft:block/fire_coral_block",up:"minecraft:block/fire_coral_block",north:"minecraft:block/fire_coral_block",south:"minecraft:block/fire_coral_block",west:"minecraft:block/fire_coral_block",east:"minecraft:block/fire_coral_block",particle:"minecraft:block/fire_coral_block"}},Lk={id:141,transparent:!1,textures:{down:"minecraft:block/birch_planks",up:"minecraft:block/fletching_table_top",north:"minecraft:block/fletching_table_front",south:"minecraft:block/fletching_table_front",west:"minecraft:block/fletching_table_side",east:"minecraft:block/fletching_table_side",particle:"minecraft:block/fletching_table_front"}},Dk={id:142,transparent:!0,textures:{down:"minecraft:block/acacia_leaves",up:"minecraft:block/acacia_leaves",north:"minecraft:block/acacia_leaves",south:"minecraft:block/acacia_leaves",west:"minecraft:block/acacia_leaves",east:"minecraft:block/acacia_leaves",particle:"minecraft:block/acacia_leaves"}},Ik={id:143,transparent:!0,textures:{down:"minecraft:block/flowering_azalea_leaves",up:"minecraft:block/flowering_azalea_leaves",north:"minecraft:block/flowering_azalea_leaves",south:"minecraft:block/flowering_azalea_leaves",west:"minecraft:block/flowering_azalea_leaves",east:"minecraft:block/flowering_azalea_leaves",particle:"minecraft:block/flowering_azalea_leaves"}},Uk={id:144,transparent:!0,textures:{down:"minecraft:block/birch_leaves",up:"minecraft:block/birch_leaves",north:"minecraft:block/birch_leaves",south:"minecraft:block/birch_leaves",west:"minecraft:block/birch_leaves",east:"minecraft:block/birch_leaves",particle:"minecraft:block/birch_leaves"}},Nk={id:145,transparent:!0,textures:{down:"minecraft:block/cherry_leaves",up:"minecraft:block/cherry_leaves",north:"minecraft:block/cherry_leaves",south:"minecraft:block/cherry_leaves",west:"minecraft:block/cherry_leaves",east:"minecraft:block/cherry_leaves",particle:"minecraft:block/cherry_leaves"}},Fk={id:146,transparent:!0,textures:{down:"minecraft:block/dark_oak_leaves",up:"minecraft:block/dark_oak_leaves",north:"minecraft:block/dark_oak_leaves",south:"minecraft:block/dark_oak_leaves",west:"minecraft:block/dark_oak_leaves",east:"minecraft:block/dark_oak_leaves",particle:"minecraft:block/dark_oak_leaves"}},Ok={id:147,transparent:!0,textures:{down:"minecraft:block/jungle_leaves",up:"minecraft:block/jungle_leaves",north:"minecraft:block/jungle_leaves",south:"minecraft:block/jungle_leaves",west:"minecraft:block/jungle_leaves",east:"minecraft:block/jungle_leaves",particle:"minecraft:block/jungle_leaves"}},Bk={id:148,transparent:!0,textures:{down:"minecraft:block/mangrove_leaves",up:"minecraft:block/mangrove_leaves",north:"minecraft:block/mangrove_leaves",south:"minecraft:block/mangrove_leaves",west:"minecraft:block/mangrove_leaves",east:"minecraft:block/mangrove_leaves",particle:"minecraft:block/mangrove_leaves"}},zk={id:149,transparent:!0,textures:{down:"minecraft:block/oak_leaves",up:"minecraft:block/oak_leaves",north:"minecraft:block/oak_leaves",south:"minecraft:block/oak_leaves",west:"minecraft:block/oak_leaves",east:"minecraft:block/oak_leaves",particle:"minecraft:block/oak_leaves"}},Vk={id:150,transparent:!0,textures:{down:"minecraft:block/pale_oak_leaves",up:"minecraft:block/pale_oak_leaves",north:"minecraft:block/pale_oak_leaves",south:"minecraft:block/pale_oak_leaves",west:"minecraft:block/pale_oak_leaves",east:"minecraft:block/pale_oak_leaves",particle:"minecraft:block/pale_oak_leaves"}},Hk={id:151,transparent:!0,textures:{down:"minecraft:block/spruce_leaves",up:"minecraft:block/spruce_leaves",north:"minecraft:block/spruce_leaves",south:"minecraft:block/spruce_leaves",west:"minecraft:block/spruce_leaves",east:"minecraft:block/spruce_leaves",particle:"minecraft:block/spruce_leaves"}},Gk={id:152,transparent:!1,textures:{down:"minecraft:block/frosted_ice_0",up:"minecraft:block/frosted_ice_0",north:"minecraft:block/frosted_ice_0",south:"minecraft:block/frosted_ice_0",west:"minecraft:block/frosted_ice_0",east:"minecraft:block/frosted_ice_0",particle:"minecraft:block/frosted_ice_0"}},Wk={id:153,transparent:!1,textures:{down:"minecraft:block/frosted_ice_1",up:"minecraft:block/frosted_ice_1",north:"minecraft:block/frosted_ice_1",south:"minecraft:block/frosted_ice_1",west:"minecraft:block/frosted_ice_1",east:"minecraft:block/frosted_ice_1",particle:"minecraft:block/frosted_ice_1"}},Xk={id:154,transparent:!1,textures:{down:"minecraft:block/frosted_ice_2",up:"minecraft:block/frosted_ice_2",north:"minecraft:block/frosted_ice_2",south:"minecraft:block/frosted_ice_2",west:"minecraft:block/frosted_ice_2",east:"minecraft:block/frosted_ice_2",particle:"minecraft:block/frosted_ice_2"}},$k={id:155,transparent:!1,textures:{down:"minecraft:block/frosted_ice_3",up:"minecraft:block/frosted_ice_3",north:"minecraft:block/frosted_ice_3",south:"minecraft:block/frosted_ice_3",west:"minecraft:block/frosted_ice_3",east:"minecraft:block/frosted_ice_3",particle:"minecraft:block/frosted_ice_3"}},qk={id:156,transparent:!1,textures:{down:"minecraft:block/furnace_top",up:"minecraft:block/furnace_top",north:"minecraft:block/furnace_front",south:"minecraft:block/furnace_side",west:"minecraft:block/furnace_side",east:"minecraft:block/furnace_side",particle:"minecraft:block/furnace_front"}},Yk={id:157,transparent:!1,textures:{down:"minecraft:block/furnace_top",up:"minecraft:block/furnace_top",north:"minecraft:block/furnace_front_on",south:"minecraft:block/furnace_side",west:"minecraft:block/furnace_side",east:"minecraft:block/furnace_side",particle:"minecraft:block/furnace_front_on"}},Kk={id:158,transparent:!1,textures:{down:"minecraft:block/gilded_blackstone",up:"minecraft:block/gilded_blackstone",north:"minecraft:block/gilded_blackstone",south:"minecraft:block/gilded_blackstone",west:"minecraft:block/gilded_blackstone",east:"minecraft:block/gilded_blackstone",particle:"minecraft:block/gilded_blackstone"}},jk={id:159,transparent:!0,translucent:!0,textures:{down:"minecraft:block/glass",up:"minecraft:block/glass",north:"minecraft:block/glass",south:"minecraft:block/glass",west:"minecraft:block/glass",east:"minecraft:block/glass",particle:"minecraft:block/glass"}},Zk={id:160,transparent:!1,textures:{down:"minecraft:block/glowstone",up:"minecraft:block/glowstone",north:"minecraft:block/glowstone",south:"minecraft:block/glowstone",west:"minecraft:block/glowstone",east:"minecraft:block/glowstone",particle:"minecraft:block/glowstone"}},Jk={id:161,transparent:!1,textures:{down:"minecraft:block/gold_block",up:"minecraft:block/gold_block",north:"minecraft:block/gold_block",south:"minecraft:block/gold_block",west:"minecraft:block/gold_block",east:"minecraft:block/gold_block",particle:"minecraft:block/gold_block"}},Qk={id:162,transparent:!1,textures:{down:"minecraft:block/gold_ore",up:"minecraft:block/gold_ore",north:"minecraft:block/gold_ore",south:"minecraft:block/gold_ore",west:"minecraft:block/gold_ore",east:"minecraft:block/gold_ore",particle:"minecraft:block/gold_ore"}},ex={id:163,transparent:!1,textures:{down:"minecraft:block/granite",up:"minecraft:block/granite",north:"minecraft:block/granite",south:"minecraft:block/granite",west:"minecraft:block/granite",east:"minecraft:block/granite",particle:"minecraft:block/granite"}},tx={id:164,transparent:!1,textures:{down:"minecraft:block/acacia_log",up:"minecraft:block/acacia_log",north:"minecraft:block/acacia_log",south:"minecraft:block/acacia_log",west:"minecraft:block/acacia_log",east:"minecraft:block/acacia_log",particle:"minecraft:block/acacia_log"}},nx={id:165,transparent:!1,textures:{down:"minecraft:block/gravel",up:"minecraft:block/gravel",north:"minecraft:block/gravel",south:"minecraft:block/gravel",west:"minecraft:block/gravel",east:"minecraft:block/gravel",particle:"minecraft:block/gravel"}},ix={id:166,transparent:!1,textures:{down:"minecraft:block/gray_concrete",up:"minecraft:block/gray_concrete",north:"minecraft:block/gray_concrete",south:"minecraft:block/gray_concrete",west:"minecraft:block/gray_concrete",east:"minecraft:block/gray_concrete",particle:"minecraft:block/gray_concrete"}},rx={id:167,transparent:!1,textures:{down:"minecraft:block/gray_concrete_powder",up:"minecraft:block/gray_concrete_powder",north:"minecraft:block/gray_concrete_powder",south:"minecraft:block/gray_concrete_powder",west:"minecraft:block/gray_concrete_powder",east:"minecraft:block/gray_concrete_powder",particle:"minecraft:block/gray_concrete_powder"}},ox={id:168,transparent:!0,translucent:!0,textures:{down:"minecraft:block/gray_stained_glass",up:"minecraft:block/gray_stained_glass",north:"minecraft:block/gray_stained_glass",south:"minecraft:block/gray_stained_glass",west:"minecraft:block/gray_stained_glass",east:"minecraft:block/gray_stained_glass",particle:"minecraft:block/gray_stained_glass"}},ax={id:169,transparent:!1,textures:{down:"minecraft:block/gray_terracotta",up:"minecraft:block/gray_terracotta",north:"minecraft:block/gray_terracotta",south:"minecraft:block/gray_terracotta",west:"minecraft:block/gray_terracotta",east:"minecraft:block/gray_terracotta",particle:"minecraft:block/gray_terracotta"}},sx={id:170,transparent:!1,textures:{down:"minecraft:block/gray_wool",up:"minecraft:block/gray_wool",north:"minecraft:block/gray_wool",south:"minecraft:block/gray_wool",west:"minecraft:block/gray_wool",east:"minecraft:block/gray_wool",particle:"minecraft:block/gray_wool"}},cx={id:171,transparent:!1,textures:{down:"minecraft:block/green_concrete",up:"minecraft:block/green_concrete",north:"minecraft:block/green_concrete",south:"minecraft:block/green_concrete",west:"minecraft:block/green_concrete",east:"minecraft:block/green_concrete",particle:"minecraft:block/green_concrete"}},lx={id:172,transparent:!1,textures:{down:"minecraft:block/green_concrete_powder",up:"minecraft:block/green_concrete_powder",north:"minecraft:block/green_concrete_powder",south:"minecraft:block/green_concrete_powder",west:"minecraft:block/green_concrete_powder",east:"minecraft:block/green_concrete_powder",particle:"minecraft:block/green_concrete_powder"}},dx={id:173,transparent:!0,translucent:!0,textures:{down:"minecraft:block/green_stained_glass",up:"minecraft:block/green_stained_glass",north:"minecraft:block/green_stained_glass",south:"minecraft:block/green_stained_glass",west:"minecraft:block/green_stained_glass",east:"minecraft:block/green_stained_glass",particle:"minecraft:block/green_stained_glass"}},ux={id:174,transparent:!1,textures:{down:"minecraft:block/green_terracotta",up:"minecraft:block/green_terracotta",north:"minecraft:block/green_terracotta",south:"minecraft:block/green_terracotta",west:"minecraft:block/green_terracotta",east:"minecraft:block/green_terracotta",particle:"minecraft:block/green_terracotta"}},hx={id:175,transparent:!1,textures:{down:"minecraft:block/green_wool",up:"minecraft:block/green_wool",north:"minecraft:block/green_wool",south:"minecraft:block/green_wool",west:"minecraft:block/green_wool",east:"minecraft:block/green_wool",particle:"minecraft:block/green_wool"}},fx={id:176,transparent:!1,textures:{down:"minecraft:block/hay_block_top",up:"minecraft:block/hay_block_top",north:"minecraft:block/hay_block_side",south:"minecraft:block/hay_block_side",west:"minecraft:block/hay_block_side",east:"minecraft:block/hay_block_side",particle:"minecraft:block/hay_block_side"}},px={id:177,transparent:!1,textures:{down:"minecraft:block/hay_block_top",up:"minecraft:block/hay_block_top",north:"minecraft:block/hay_block_side",south:"minecraft:block/hay_block_side",west:"minecraft:block/hay_block_side",east:"minecraft:block/hay_block_side",particle:"minecraft:block/hay_block_side"}},mx={id:178,transparent:!1,textures:{down:"minecraft:block/honeycomb_block",up:"minecraft:block/honeycomb_block",north:"minecraft:block/honeycomb_block",south:"minecraft:block/honeycomb_block",west:"minecraft:block/honeycomb_block",east:"minecraft:block/honeycomb_block",particle:"minecraft:block/honeycomb_block"}},_x={id:179,transparent:!1,textures:{down:"block/honey_block_bottom",up:"block/honey_block_bottom",north:"block/honey_block_bottom",south:"block/honey_block_bottom",west:"block/honey_block_bottom",east:"block/honey_block_bottom",particle:"block/honey_block_top"}},bx={id:180,transparent:!1,textures:{down:"minecraft:block/horn_coral_block",up:"minecraft:block/horn_coral_block",north:"minecraft:block/horn_coral_block",south:"minecraft:block/horn_coral_block",west:"minecraft:block/horn_coral_block",east:"minecraft:block/horn_coral_block",particle:"minecraft:block/horn_coral_block"}},gx={id:181,transparent:!0,textures:{down:"minecraft:block/ice",up:"minecraft:block/ice",north:"minecraft:block/ice",south:"minecraft:block/ice",west:"minecraft:block/ice",east:"minecraft:block/ice",particle:"minecraft:block/ice"}},kx={id:182,transparent:!1,textures:{down:"minecraft:block/iron_block",up:"minecraft:block/iron_block",north:"minecraft:block/iron_block",south:"minecraft:block/iron_block",west:"minecraft:block/iron_block",east:"minecraft:block/iron_block",particle:"minecraft:block/iron_block"}},xx={id:183,transparent:!1,textures:{down:"minecraft:block/iron_ore",up:"minecraft:block/iron_ore",north:"minecraft:block/iron_ore",south:"minecraft:block/iron_ore",west:"minecraft:block/iron_ore",east:"minecraft:block/iron_ore",particle:"minecraft:block/iron_ore"}},vx={id:184,transparent:!1,textures:{down:"minecraft:block/pumpkin_top",up:"minecraft:block/pumpkin_top",north:"minecraft:block/jack_o_lantern",south:"minecraft:block/pumpkin_side",west:"minecraft:block/pumpkin_side",east:"minecraft:block/pumpkin_side",particle:"minecraft:block/jack_o_lantern"}},wx={id:185,transparent:!1,textures:{down:"minecraft:block/jigsaw_side",up:"minecraft:block/jigsaw_lock",north:"minecraft:block/jigsaw_top",south:"minecraft:block/jigsaw_bottom",west:"minecraft:block/jigsaw_side",east:"minecraft:block/jigsaw_side",particle:"minecraft:block/jigsaw_top"}},Sx={id:186,transparent:!1,textures:{down:"minecraft:block/jukebox_side",up:"minecraft:block/jukebox_top",north:"minecraft:block/jukebox_side",south:"minecraft:block/jukebox_side",west:"minecraft:block/jukebox_side",east:"minecraft:block/jukebox_side",particle:"minecraft:block/jukebox_side"}},Mx={id:187,transparent:!1,textures:{down:"minecraft:block/jungle_log_top",up:"minecraft:block/jungle_log_top",north:"minecraft:block/jungle_log",south:"minecraft:block/jungle_log",west:"minecraft:block/jungle_log",east:"minecraft:block/jungle_log",particle:"minecraft:block/jungle_log"}},yx={id:188,transparent:!1,textures:{down:"minecraft:block/jungle_log_top",up:"minecraft:block/jungle_log_top",north:"minecraft:block/jungle_log",south:"minecraft:block/jungle_log",west:"minecraft:block/jungle_log",east:"minecraft:block/jungle_log",particle:"minecraft:block/jungle_log"}},Ex={id:189,transparent:!1,textures:{down:"minecraft:block/jungle_planks",up:"minecraft:block/jungle_planks",north:"minecraft:block/jungle_planks",south:"minecraft:block/jungle_planks",west:"minecraft:block/jungle_planks",east:"minecraft:block/jungle_planks",particle:"minecraft:block/jungle_planks"}},Ax={id:190,transparent:!1,textures:{down:"minecraft:block/jungle_log",up:"minecraft:block/jungle_log",north:"minecraft:block/jungle_log",south:"minecraft:block/jungle_log",west:"minecraft:block/jungle_log",east:"minecraft:block/jungle_log",particle:"minecraft:block/jungle_log"}},Tx={id:191,transparent:!1,textures:{down:"minecraft:block/lapis_block",up:"minecraft:block/lapis_block",north:"minecraft:block/lapis_block",south:"minecraft:block/lapis_block",west:"minecraft:block/lapis_block",east:"minecraft:block/lapis_block",particle:"minecraft:block/lapis_block"}},Cx={id:192,transparent:!1,textures:{down:"minecraft:block/lapis_ore",up:"minecraft:block/lapis_ore",north:"minecraft:block/lapis_ore",south:"minecraft:block/lapis_ore",west:"minecraft:block/lapis_ore",east:"minecraft:block/lapis_ore",particle:"minecraft:block/lapis_ore"}},Rx={id:193,transparent:!1,textures:{down:"minecraft:block/light_blue_concrete",up:"minecraft:block/light_blue_concrete",north:"minecraft:block/light_blue_concrete",south:"minecraft:block/light_blue_concrete",west:"minecraft:block/light_blue_concrete",east:"minecraft:block/light_blue_concrete",particle:"minecraft:block/light_blue_concrete"}},Px={id:194,transparent:!1,textures:{down:"minecraft:block/light_blue_concrete_powder",up:"minecraft:block/light_blue_concrete_powder",north:"minecraft:block/light_blue_concrete_powder",south:"minecraft:block/light_blue_concrete_powder",west:"minecraft:block/light_blue_concrete_powder",east:"minecraft:block/light_blue_concrete_powder",particle:"minecraft:block/light_blue_concrete_powder"}},Lx={id:195,transparent:!0,translucent:!0,textures:{down:"minecraft:block/light_blue_stained_glass",up:"minecraft:block/light_blue_stained_glass",north:"minecraft:block/light_blue_stained_glass",south:"minecraft:block/light_blue_stained_glass",west:"minecraft:block/light_blue_stained_glass",east:"minecraft:block/light_blue_stained_glass",particle:"minecraft:block/light_blue_stained_glass"}},Dx={id:196,transparent:!1,textures:{down:"minecraft:block/light_blue_terracotta",up:"minecraft:block/light_blue_terracotta",north:"minecraft:block/light_blue_terracotta",south:"minecraft:block/light_blue_terracotta",west:"minecraft:block/light_blue_terracotta",east:"minecraft:block/light_blue_terracotta",particle:"minecraft:block/light_blue_terracotta"}},Ix={id:197,transparent:!1,textures:{down:"minecraft:block/light_blue_wool",up:"minecraft:block/light_blue_wool",north:"minecraft:block/light_blue_wool",south:"minecraft:block/light_blue_wool",west:"minecraft:block/light_blue_wool",east:"minecraft:block/light_blue_wool",particle:"minecraft:block/light_blue_wool"}},Ux={id:198,transparent:!1,textures:{down:"minecraft:block/light_gray_concrete",up:"minecraft:block/light_gray_concrete",north:"minecraft:block/light_gray_concrete",south:"minecraft:block/light_gray_concrete",west:"minecraft:block/light_gray_concrete",east:"minecraft:block/light_gray_concrete",particle:"minecraft:block/light_gray_concrete"}},Nx={id:199,transparent:!1,textures:{down:"minecraft:block/light_gray_concrete_powder",up:"minecraft:block/light_gray_concrete_powder",north:"minecraft:block/light_gray_concrete_powder",south:"minecraft:block/light_gray_concrete_powder",west:"minecraft:block/light_gray_concrete_powder",east:"minecraft:block/light_gray_concrete_powder",particle:"minecraft:block/light_gray_concrete_powder"}},Fx={id:200,transparent:!0,translucent:!0,textures:{down:"minecraft:block/light_gray_stained_glass",up:"minecraft:block/light_gray_stained_glass",north:"minecraft:block/light_gray_stained_glass",south:"minecraft:block/light_gray_stained_glass",west:"minecraft:block/light_gray_stained_glass",east:"minecraft:block/light_gray_stained_glass",particle:"minecraft:block/light_gray_stained_glass"}},Ox={id:201,transparent:!1,textures:{down:"minecraft:block/light_gray_terracotta",up:"minecraft:block/light_gray_terracotta",north:"minecraft:block/light_gray_terracotta",south:"minecraft:block/light_gray_terracotta",west:"minecraft:block/light_gray_terracotta",east:"minecraft:block/light_gray_terracotta",particle:"minecraft:block/light_gray_terracotta"}},Bx={id:202,transparent:!1,textures:{down:"minecraft:block/light_gray_wool",up:"minecraft:block/light_gray_wool",north:"minecraft:block/light_gray_wool",south:"minecraft:block/light_gray_wool",west:"minecraft:block/light_gray_wool",east:"minecraft:block/light_gray_wool",particle:"minecraft:block/light_gray_wool"}},zx={id:203,transparent:!1,textures:{down:"minecraft:block/lime_concrete",up:"minecraft:block/lime_concrete",north:"minecraft:block/lime_concrete",south:"minecraft:block/lime_concrete",west:"minecraft:block/lime_concrete",east:"minecraft:block/lime_concrete",particle:"minecraft:block/lime_concrete"}},Vx={id:204,transparent:!1,textures:{down:"minecraft:block/lime_concrete_powder",up:"minecraft:block/lime_concrete_powder",north:"minecraft:block/lime_concrete_powder",south:"minecraft:block/lime_concrete_powder",west:"minecraft:block/lime_concrete_powder",east:"minecraft:block/lime_concrete_powder",particle:"minecraft:block/lime_concrete_powder"}},Hx={id:205,transparent:!0,translucent:!0,textures:{down:"minecraft:block/lime_stained_glass",up:"minecraft:block/lime_stained_glass",north:"minecraft:block/lime_stained_glass",south:"minecraft:block/lime_stained_glass",west:"minecraft:block/lime_stained_glass",east:"minecraft:block/lime_stained_glass",particle:"minecraft:block/lime_stained_glass"}},Gx={id:206,transparent:!1,textures:{down:"minecraft:block/lime_terracotta",up:"minecraft:block/lime_terracotta",north:"minecraft:block/lime_terracotta",south:"minecraft:block/lime_terracotta",west:"minecraft:block/lime_terracotta",east:"minecraft:block/lime_terracotta",particle:"minecraft:block/lime_terracotta"}},Wx={id:207,transparent:!1,textures:{down:"minecraft:block/lime_wool",up:"minecraft:block/lime_wool",north:"minecraft:block/lime_wool",south:"minecraft:block/lime_wool",west:"minecraft:block/lime_wool",east:"minecraft:block/lime_wool",particle:"minecraft:block/lime_wool"}},Xx={id:208,transparent:!1,textures:{down:"minecraft:block/lodestone_top",up:"minecraft:block/lodestone_top",north:"minecraft:block/lodestone_side",south:"minecraft:block/lodestone_side",west:"minecraft:block/lodestone_side",east:"minecraft:block/lodestone_side",particle:"minecraft:block/lodestone_side"}},$x={id:209,transparent:!1,textures:{down:"minecraft:block/magenta_concrete",up:"minecraft:block/magenta_concrete",north:"minecraft:block/magenta_concrete",south:"minecraft:block/magenta_concrete",west:"minecraft:block/magenta_concrete",east:"minecraft:block/magenta_concrete",particle:"minecraft:block/magenta_concrete"}},qx={id:210,transparent:!1,textures:{down:"minecraft:block/magenta_concrete_powder",up:"minecraft:block/magenta_concrete_powder",north:"minecraft:block/magenta_concrete_powder",south:"minecraft:block/magenta_concrete_powder",west:"minecraft:block/magenta_concrete_powder",east:"minecraft:block/magenta_concrete_powder",particle:"minecraft:block/magenta_concrete_powder"}},Yx={id:211,transparent:!0,translucent:!0,textures:{down:"minecraft:block/magenta_stained_glass",up:"minecraft:block/magenta_stained_glass",north:"minecraft:block/magenta_stained_glass",south:"minecraft:block/magenta_stained_glass",west:"minecraft:block/magenta_stained_glass",east:"minecraft:block/magenta_stained_glass",particle:"minecraft:block/magenta_stained_glass"}},Kx={id:212,transparent:!1,textures:{down:"minecraft:block/magenta_terracotta",up:"minecraft:block/magenta_terracotta",north:"minecraft:block/magenta_terracotta",south:"minecraft:block/magenta_terracotta",west:"minecraft:block/magenta_terracotta",east:"minecraft:block/magenta_terracotta",particle:"minecraft:block/magenta_terracotta"}},jx={id:213,transparent:!1,textures:{down:"minecraft:block/magenta_wool",up:"minecraft:block/magenta_wool",north:"minecraft:block/magenta_wool",south:"minecraft:block/magenta_wool",west:"minecraft:block/magenta_wool",east:"minecraft:block/magenta_wool",particle:"minecraft:block/magenta_wool"}},Zx={id:214,transparent:!1,textures:{down:"minecraft:block/magma",up:"minecraft:block/magma",north:"minecraft:block/magma",south:"minecraft:block/magma",west:"minecraft:block/magma",east:"minecraft:block/magma",particle:"minecraft:block/magma"}},Jx={id:215,transparent:!1,textures:{down:"minecraft:block/mangrove_log_top",up:"minecraft:block/mangrove_log_top",north:"minecraft:block/mangrove_log",south:"minecraft:block/mangrove_log",west:"minecraft:block/mangrove_log",east:"minecraft:block/mangrove_log",particle:"minecraft:block/mangrove_log"}},Qx={id:216,transparent:!1,textures:{down:"minecraft:block/mangrove_log_top",up:"minecraft:block/mangrove_log_top",north:"minecraft:block/mangrove_log",south:"minecraft:block/mangrove_log",west:"minecraft:block/mangrove_log",east:"minecraft:block/mangrove_log",particle:"minecraft:block/mangrove_log"}},e0={id:217,transparent:!1,textures:{down:"minecraft:block/mangrove_planks",up:"minecraft:block/mangrove_planks",north:"minecraft:block/mangrove_planks",south:"minecraft:block/mangrove_planks",west:"minecraft:block/mangrove_planks",east:"minecraft:block/mangrove_planks",particle:"minecraft:block/mangrove_planks"}},t0={id:218,transparent:!1,textures:{down:"minecraft:block/mangrove_log",up:"minecraft:block/mangrove_log",north:"minecraft:block/mangrove_log",south:"minecraft:block/mangrove_log",west:"minecraft:block/mangrove_log",east:"minecraft:block/mangrove_log",particle:"minecraft:block/mangrove_log"}},n0={id:219,transparent:!1,textures:{down:"minecraft:block/melon_top",up:"minecraft:block/melon_top",north:"minecraft:block/melon_side",south:"minecraft:block/melon_side",west:"minecraft:block/melon_side",east:"minecraft:block/melon_side",particle:"minecraft:block/melon_side"}},i0={id:220,transparent:!1,textures:{down:"minecraft:block/mossy_cobblestone",up:"minecraft:block/mossy_cobblestone",north:"minecraft:block/mossy_cobblestone",south:"minecraft:block/mossy_cobblestone",west:"minecraft:block/mossy_cobblestone",east:"minecraft:block/mossy_cobblestone",particle:"minecraft:block/mossy_cobblestone"}},r0={id:221,transparent:!1,textures:{down:"minecraft:block/mossy_stone_bricks",up:"minecraft:block/mossy_stone_bricks",north:"minecraft:block/mossy_stone_bricks",south:"minecraft:block/mossy_stone_bricks",west:"minecraft:block/mossy_stone_bricks",east:"minecraft:block/mossy_stone_bricks",particle:"minecraft:block/mossy_stone_bricks"}},o0={id:222,transparent:!1,textures:{down:"minecraft:block/moss_block",up:"minecraft:block/moss_block",north:"minecraft:block/moss_block",south:"minecraft:block/moss_block",west:"minecraft:block/moss_block",east:"minecraft:block/moss_block",particle:"minecraft:block/moss_block"}},a0={id:223,transparent:!1,textures:{down:"minecraft:block/mud",up:"minecraft:block/mud",north:"minecraft:block/mud",south:"minecraft:block/mud",west:"minecraft:block/mud",east:"minecraft:block/mud",particle:"minecraft:block/mud"}},s0={id:224,transparent:!1,textures:{down:"minecraft:block/muddy_mangrove_roots_top",up:"minecraft:block/muddy_mangrove_roots_top",north:"minecraft:block/muddy_mangrove_roots_side",south:"minecraft:block/muddy_mangrove_roots_side",west:"minecraft:block/muddy_mangrove_roots_side",east:"minecraft:block/muddy_mangrove_roots_side",particle:"minecraft:block/muddy_mangrove_roots_side"}},c0={id:225,transparent:!1,textures:{down:"minecraft:block/mud_bricks",up:"minecraft:block/mud_bricks",north:"minecraft:block/mud_bricks",south:"minecraft:block/mud_bricks",west:"minecraft:block/mud_bricks",east:"minecraft:block/mud_bricks",particle:"minecraft:block/mud_bricks"}},l0={id:226,transparent:!1,textures:{down:"minecraft:block/mushroom_stem",up:"minecraft:block/mushroom_stem",north:"minecraft:block/mushroom_stem",south:"minecraft:block/mushroom_stem",west:"minecraft:block/mushroom_stem",east:"minecraft:block/mushroom_stem",particle:"minecraft:block/mushroom_stem"}},d0={id:227,transparent:!1,textures:{down:"minecraft:block/netherite_block",up:"minecraft:block/netherite_block",north:"minecraft:block/netherite_block",south:"minecraft:block/netherite_block",west:"minecraft:block/netherite_block",east:"minecraft:block/netherite_block",particle:"minecraft:block/netherite_block"}},u0={id:228,transparent:!1,textures:{down:"minecraft:block/netherrack",up:"minecraft:block/netherrack",north:"minecraft:block/netherrack",south:"minecraft:block/netherrack",west:"minecraft:block/netherrack",east:"minecraft:block/netherrack",particle:"minecraft:block/netherrack"}},h0={id:229,transparent:!1,textures:{down:"minecraft:block/nether_bricks",up:"minecraft:block/nether_bricks",north:"minecraft:block/nether_bricks",south:"minecraft:block/nether_bricks",west:"minecraft:block/nether_bricks",east:"minecraft:block/nether_bricks",particle:"minecraft:block/nether_bricks"}},f0={id:230,transparent:!1,textures:{down:"minecraft:block/nether_gold_ore",up:"minecraft:block/nether_gold_ore",north:"minecraft:block/nether_gold_ore",south:"minecraft:block/nether_gold_ore",west:"minecraft:block/nether_gold_ore",east:"minecraft:block/nether_gold_ore",particle:"minecraft:block/nether_gold_ore"}},p0={id:231,transparent:!1,textures:{down:"minecraft:block/nether_quartz_ore",up:"minecraft:block/nether_quartz_ore",north:"minecraft:block/nether_quartz_ore",south:"minecraft:block/nether_quartz_ore",west:"minecraft:block/nether_quartz_ore",east:"minecraft:block/nether_quartz_ore",particle:"minecraft:block/nether_quartz_ore"}},m0={id:232,transparent:!1,textures:{down:"minecraft:block/nether_wart_block",up:"minecraft:block/nether_wart_block",north:"minecraft:block/nether_wart_block",south:"minecraft:block/nether_wart_block",west:"minecraft:block/nether_wart_block",east:"minecraft:block/nether_wart_block",particle:"minecraft:block/nether_wart_block"}},_0={id:233,transparent:!1,textures:{down:"minecraft:block/note_block",up:"minecraft:block/note_block",north:"minecraft:block/note_block",south:"minecraft:block/note_block",west:"minecraft:block/note_block",east:"minecraft:block/note_block",particle:"minecraft:block/note_block"}},b0={id:234,transparent:!1,textures:{down:"minecraft:block/oak_log_top",up:"minecraft:block/oak_log_top",north:"minecraft:block/oak_log",south:"minecraft:block/oak_log",west:"minecraft:block/oak_log",east:"minecraft:block/oak_log",particle:"minecraft:block/oak_log"}},g0={id:235,transparent:!1,textures:{down:"minecraft:block/oak_log_top",up:"minecraft:block/oak_log_top",north:"minecraft:block/oak_log",south:"minecraft:block/oak_log",west:"minecraft:block/oak_log",east:"minecraft:block/oak_log",particle:"minecraft:block/oak_log"}},k0={id:236,transparent:!1,textures:{down:"minecraft:block/oak_planks",up:"minecraft:block/oak_planks",north:"minecraft:block/oak_planks",south:"minecraft:block/oak_planks",west:"minecraft:block/oak_planks",east:"minecraft:block/oak_planks",particle:"minecraft:block/oak_planks"}},x0={id:237,transparent:!1,textures:{down:"minecraft:block/oak_log",up:"minecraft:block/oak_log",north:"minecraft:block/oak_log",south:"minecraft:block/oak_log",west:"minecraft:block/oak_log",east:"minecraft:block/oak_log",particle:"minecraft:block/oak_log"}},v0={id:238,transparent:!1,textures:{down:"block/observer_top",up:"block/observer_top",north:"block/observer_front",south:"block/observer_back",west:"block/observer_side",east:"block/observer_side",particle:"block/observer_front"}},w0={id:239,transparent:!1,textures:{down:"minecraft:block/obsidian",up:"minecraft:block/obsidian",north:"minecraft:block/obsidian",south:"minecraft:block/obsidian",west:"minecraft:block/obsidian",east:"minecraft:block/obsidian",particle:"minecraft:block/obsidian"}},S0={id:240,transparent:!1,textures:{down:"minecraft:block/ochre_froglight_top",up:"minecraft:block/ochre_froglight_top",north:"minecraft:block/ochre_froglight_side",south:"minecraft:block/ochre_froglight_side",west:"minecraft:block/ochre_froglight_side",east:"minecraft:block/ochre_froglight_side",particle:"minecraft:block/ochre_froglight_side"}},M0={id:241,transparent:!1,textures:{down:"minecraft:block/ochre_froglight_top",up:"minecraft:block/ochre_froglight_top",north:"minecraft:block/ochre_froglight_side",south:"minecraft:block/ochre_froglight_side",west:"minecraft:block/ochre_froglight_side",east:"minecraft:block/ochre_froglight_side",particle:"minecraft:block/ochre_froglight_side"}},y0={id:242,transparent:!1,textures:{down:"minecraft:block/orange_concrete",up:"minecraft:block/orange_concrete",north:"minecraft:block/orange_concrete",south:"minecraft:block/orange_concrete",west:"minecraft:block/orange_concrete",east:"minecraft:block/orange_concrete",particle:"minecraft:block/orange_concrete"}},E0={id:243,transparent:!1,textures:{down:"minecraft:block/orange_concrete_powder",up:"minecraft:block/orange_concrete_powder",north:"minecraft:block/orange_concrete_powder",south:"minecraft:block/orange_concrete_powder",west:"minecraft:block/orange_concrete_powder",east:"minecraft:block/orange_concrete_powder",particle:"minecraft:block/orange_concrete_powder"}},A0={id:244,transparent:!0,translucent:!0,textures:{down:"minecraft:block/orange_stained_glass",up:"minecraft:block/orange_stained_glass",north:"minecraft:block/orange_stained_glass",south:"minecraft:block/orange_stained_glass",west:"minecraft:block/orange_stained_glass",east:"minecraft:block/orange_stained_glass",particle:"minecraft:block/orange_stained_glass"}},T0={id:245,transparent:!1,textures:{down:"minecraft:block/orange_terracotta",up:"minecraft:block/orange_terracotta",north:"minecraft:block/orange_terracotta",south:"minecraft:block/orange_terracotta",west:"minecraft:block/orange_terracotta",east:"minecraft:block/orange_terracotta",particle:"minecraft:block/orange_terracotta"}},C0={id:246,transparent:!1,textures:{down:"minecraft:block/orange_wool",up:"minecraft:block/orange_wool",north:"minecraft:block/orange_wool",south:"minecraft:block/orange_wool",west:"minecraft:block/orange_wool",east:"minecraft:block/orange_wool",particle:"minecraft:block/orange_wool"}},R0={id:247,transparent:!1,textures:{down:"minecraft:block/oxidized_chiseled_copper",up:"minecraft:block/oxidized_chiseled_copper",north:"minecraft:block/oxidized_chiseled_copper",south:"minecraft:block/oxidized_chiseled_copper",west:"minecraft:block/oxidized_chiseled_copper",east:"minecraft:block/oxidized_chiseled_copper",particle:"minecraft:block/oxidized_chiseled_copper"}},P0={id:248,transparent:!1,textures:{down:"minecraft:block/oxidized_copper",up:"minecraft:block/oxidized_copper",north:"minecraft:block/oxidized_copper",south:"minecraft:block/oxidized_copper",west:"minecraft:block/oxidized_copper",east:"minecraft:block/oxidized_copper",particle:"minecraft:block/oxidized_copper"}},L0={id:249,transparent:!1,textures:{down:"minecraft:block/oxidized_copper_bulb",up:"minecraft:block/oxidized_copper_bulb",north:"minecraft:block/oxidized_copper_bulb",south:"minecraft:block/oxidized_copper_bulb",west:"minecraft:block/oxidized_copper_bulb",east:"minecraft:block/oxidized_copper_bulb",particle:"minecraft:block/oxidized_copper_bulb"}},D0={id:250,transparent:!1,textures:{down:"minecraft:block/oxidized_copper_bulb_lit",up:"minecraft:block/oxidized_copper_bulb_lit",north:"minecraft:block/oxidized_copper_bulb_lit",south:"minecraft:block/oxidized_copper_bulb_lit",west:"minecraft:block/oxidized_copper_bulb_lit",east:"minecraft:block/oxidized_copper_bulb_lit",particle:"minecraft:block/oxidized_copper_bulb_lit"}},I0={id:251,transparent:!1,textures:{down:"minecraft:block/oxidized_copper_bulb_lit_powered",up:"minecraft:block/oxidized_copper_bulb_lit_powered",north:"minecraft:block/oxidized_copper_bulb_lit_powered",south:"minecraft:block/oxidized_copper_bulb_lit_powered",west:"minecraft:block/oxidized_copper_bulb_lit_powered",east:"minecraft:block/oxidized_copper_bulb_lit_powered",particle:"minecraft:block/oxidized_copper_bulb_lit_powered"}},U0={id:252,transparent:!1,textures:{down:"minecraft:block/oxidized_copper_bulb_powered",up:"minecraft:block/oxidized_copper_bulb_powered",north:"minecraft:block/oxidized_copper_bulb_powered",south:"minecraft:block/oxidized_copper_bulb_powered",west:"minecraft:block/oxidized_copper_bulb_powered",east:"minecraft:block/oxidized_copper_bulb_powered",particle:"minecraft:block/oxidized_copper_bulb_powered"}},N0={id:253,transparent:!1,textures:{down:"minecraft:block/oxidized_copper_grate",up:"minecraft:block/oxidized_copper_grate",north:"minecraft:block/oxidized_copper_grate",south:"minecraft:block/oxidized_copper_grate",west:"minecraft:block/oxidized_copper_grate",east:"minecraft:block/oxidized_copper_grate",particle:"minecraft:block/oxidized_copper_grate"}},F0={id:254,transparent:!1,textures:{down:"minecraft:block/oxidized_cut_copper",up:"minecraft:block/oxidized_cut_copper",north:"minecraft:block/oxidized_cut_copper",south:"minecraft:block/oxidized_cut_copper",west:"minecraft:block/oxidized_cut_copper",east:"minecraft:block/oxidized_cut_copper",particle:"minecraft:block/oxidized_cut_copper"}},O0={id:255,transparent:!0,textures:{down:"minecraft:block/packed_ice",up:"minecraft:block/packed_ice",north:"minecraft:block/packed_ice",south:"minecraft:block/packed_ice",west:"minecraft:block/packed_ice",east:"minecraft:block/packed_ice",particle:"minecraft:block/packed_ice"}},B0={id:256,transparent:!1,textures:{down:"minecraft:block/packed_mud",up:"minecraft:block/packed_mud",north:"minecraft:block/packed_mud",south:"minecraft:block/packed_mud",west:"minecraft:block/packed_mud",east:"minecraft:block/packed_mud",particle:"minecraft:block/packed_mud"}},z0={id:257,transparent:!1,textures:{down:"minecraft:block/pale_moss_block",up:"minecraft:block/pale_moss_block",north:"minecraft:block/pale_moss_block",south:"minecraft:block/pale_moss_block",west:"minecraft:block/pale_moss_block",east:"minecraft:block/pale_moss_block",particle:"minecraft:block/pale_moss_block"}},V0={id:258,transparent:!1,textures:{down:"minecraft:block/pale_oak_log_top",up:"minecraft:block/pale_oak_log_top",north:"minecraft:block/pale_oak_log",south:"minecraft:block/pale_oak_log",west:"minecraft:block/pale_oak_log",east:"minecraft:block/pale_oak_log",particle:"minecraft:block/pale_oak_log"}},H0={id:259,transparent:!1,textures:{down:"minecraft:block/pale_oak_log_top",up:"minecraft:block/pale_oak_log_top",north:"minecraft:block/pale_oak_log",south:"minecraft:block/pale_oak_log",west:"minecraft:block/pale_oak_log",east:"minecraft:block/pale_oak_log",particle:"minecraft:block/pale_oak_log"}},G0={id:260,transparent:!1,textures:{down:"minecraft:block/pale_oak_planks",up:"minecraft:block/pale_oak_planks",north:"minecraft:block/pale_oak_planks",south:"minecraft:block/pale_oak_planks",west:"minecraft:block/pale_oak_planks",east:"minecraft:block/pale_oak_planks",particle:"minecraft:block/pale_oak_planks"}},W0={id:261,transparent:!1,textures:{down:"minecraft:block/pale_oak_log",up:"minecraft:block/pale_oak_log",north:"minecraft:block/pale_oak_log",south:"minecraft:block/pale_oak_log",west:"minecraft:block/pale_oak_log",east:"minecraft:block/pale_oak_log",particle:"minecraft:block/pale_oak_log"}},X0={id:262,transparent:!1,textures:{down:"minecraft:block/pearlescent_froglight_top",up:"minecraft:block/pearlescent_froglight_top",north:"minecraft:block/pearlescent_froglight_side",south:"minecraft:block/pearlescent_froglight_side",west:"minecraft:block/pearlescent_froglight_side",east:"minecraft:block/pearlescent_froglight_side",particle:"minecraft:block/pearlescent_froglight_side"}},$0={id:263,transparent:!1,textures:{down:"minecraft:block/pearlescent_froglight_top",up:"minecraft:block/pearlescent_froglight_top",north:"minecraft:block/pearlescent_froglight_side",south:"minecraft:block/pearlescent_froglight_side",west:"minecraft:block/pearlescent_froglight_side",east:"minecraft:block/pearlescent_froglight_side",particle:"minecraft:block/pearlescent_froglight_side"}},q0={id:264,transparent:!1,textures:{down:"minecraft:block/pink_concrete",up:"minecraft:block/pink_concrete",north:"minecraft:block/pink_concrete",south:"minecraft:block/pink_concrete",west:"minecraft:block/pink_concrete",east:"minecraft:block/pink_concrete",particle:"minecraft:block/pink_concrete"}},Y0={id:265,transparent:!1,textures:{down:"minecraft:block/pink_concrete_powder",up:"minecraft:block/pink_concrete_powder",north:"minecraft:block/pink_concrete_powder",south:"minecraft:block/pink_concrete_powder",west:"minecraft:block/pink_concrete_powder",east:"minecraft:block/pink_concrete_powder",particle:"minecraft:block/pink_concrete_powder"}},K0={id:266,transparent:!0,translucent:!0,textures:{down:"minecraft:block/pink_stained_glass",up:"minecraft:block/pink_stained_glass",north:"minecraft:block/pink_stained_glass",south:"minecraft:block/pink_stained_glass",west:"minecraft:block/pink_stained_glass",east:"minecraft:block/pink_stained_glass",particle:"minecraft:block/pink_stained_glass"}},j0={id:267,transparent:!1,textures:{down:"minecraft:block/pink_terracotta",up:"minecraft:block/pink_terracotta",north:"minecraft:block/pink_terracotta",south:"minecraft:block/pink_terracotta",west:"minecraft:block/pink_terracotta",east:"minecraft:block/pink_terracotta",particle:"minecraft:block/pink_terracotta"}},Z0={id:268,transparent:!1,textures:{down:"minecraft:block/pink_wool",up:"minecraft:block/pink_wool",north:"minecraft:block/pink_wool",south:"minecraft:block/pink_wool",west:"minecraft:block/pink_wool",east:"minecraft:block/pink_wool",particle:"minecraft:block/pink_wool"}},J0={id:269,transparent:!1,textures:{down:"minecraft:block/polished_andesite",up:"minecraft:block/polished_andesite",north:"minecraft:block/polished_andesite",south:"minecraft:block/polished_andesite",west:"minecraft:block/polished_andesite",east:"minecraft:block/polished_andesite",particle:"minecraft:block/polished_andesite"}},Q0={id:270,transparent:!1,textures:{down:"minecraft:block/polished_basalt_top",up:"minecraft:block/polished_basalt_top",north:"minecraft:block/polished_basalt_side",south:"minecraft:block/polished_basalt_side",west:"minecraft:block/polished_basalt_side",east:"minecraft:block/polished_basalt_side",particle:"minecraft:block/polished_basalt_side"}},ev={id:271,transparent:!1,textures:{down:"minecraft:block/polished_blackstone",up:"minecraft:block/polished_blackstone",north:"minecraft:block/polished_blackstone",south:"minecraft:block/polished_blackstone",west:"minecraft:block/polished_blackstone",east:"minecraft:block/polished_blackstone",particle:"minecraft:block/polished_blackstone"}},tv={id:272,transparent:!1,textures:{down:"minecraft:block/polished_blackstone_bricks",up:"minecraft:block/polished_blackstone_bricks",north:"minecraft:block/polished_blackstone_bricks",south:"minecraft:block/polished_blackstone_bricks",west:"minecraft:block/polished_blackstone_bricks",east:"minecraft:block/polished_blackstone_bricks",particle:"minecraft:block/polished_blackstone_bricks"}},nv={id:273,transparent:!1,textures:{down:"minecraft:block/polished_deepslate",up:"minecraft:block/polished_deepslate",north:"minecraft:block/polished_deepslate",south:"minecraft:block/polished_deepslate",west:"minecraft:block/polished_deepslate",east:"minecraft:block/polished_deepslate",particle:"minecraft:block/polished_deepslate"}},iv={id:274,transparent:!1,textures:{down:"minecraft:block/polished_diorite",up:"minecraft:block/polished_diorite",north:"minecraft:block/polished_diorite",south:"minecraft:block/polished_diorite",west:"minecraft:block/polished_diorite",east:"minecraft:block/polished_diorite",particle:"minecraft:block/polished_diorite"}},rv={id:275,transparent:!1,textures:{down:"minecraft:block/polished_granite",up:"minecraft:block/polished_granite",north:"minecraft:block/polished_granite",south:"minecraft:block/polished_granite",west:"minecraft:block/polished_granite",east:"minecraft:block/polished_granite",particle:"minecraft:block/polished_granite"}},ov={id:276,transparent:!1,textures:{down:"minecraft:block/polished_tuff",up:"minecraft:block/polished_tuff",north:"minecraft:block/polished_tuff",south:"minecraft:block/polished_tuff",west:"minecraft:block/polished_tuff",east:"minecraft:block/polished_tuff",particle:"minecraft:block/polished_tuff"}},av={id:277,transparent:!1,textures:{down:"minecraft:block/prismarine",up:"minecraft:block/prismarine",north:"minecraft:block/prismarine",south:"minecraft:block/prismarine",west:"minecraft:block/prismarine",east:"minecraft:block/prismarine",particle:"minecraft:block/prismarine"}},sv={id:278,transparent:!1,textures:{down:"minecraft:block/prismarine_bricks",up:"minecraft:block/prismarine_bricks",north:"minecraft:block/prismarine_bricks",south:"minecraft:block/prismarine_bricks",west:"minecraft:block/prismarine_bricks",east:"minecraft:block/prismarine_bricks",particle:"minecraft:block/prismarine_bricks"}},cv={id:279,transparent:!1,textures:{down:"block/pumpkin_top",up:"block/pumpkin_top",north:"block/pumpkin_side",south:"block/pumpkin_side",west:"block/pumpkin_side",east:"block/pumpkin_side",particle:"block/pumpkin_side"}},lv={id:280,transparent:!1,textures:{down:"minecraft:block/purple_concrete",up:"minecraft:block/purple_concrete",north:"minecraft:block/purple_concrete",south:"minecraft:block/purple_concrete",west:"minecraft:block/purple_concrete",east:"minecraft:block/purple_concrete",particle:"minecraft:block/purple_concrete"}},dv={id:281,transparent:!1,textures:{down:"minecraft:block/purple_concrete_powder",up:"minecraft:block/purple_concrete_powder",north:"minecraft:block/purple_concrete_powder",south:"minecraft:block/purple_concrete_powder",west:"minecraft:block/purple_concrete_powder",east:"minecraft:block/purple_concrete_powder",particle:"minecraft:block/purple_concrete_powder"}},uv={id:282,transparent:!0,translucent:!0,textures:{down:"minecraft:block/purple_stained_glass",up:"minecraft:block/purple_stained_glass",north:"minecraft:block/purple_stained_glass",south:"minecraft:block/purple_stained_glass",west:"minecraft:block/purple_stained_glass",east:"minecraft:block/purple_stained_glass",particle:"minecraft:block/purple_stained_glass"}},hv={id:283,transparent:!1,textures:{down:"minecraft:block/purple_terracotta",up:"minecraft:block/purple_terracotta",north:"minecraft:block/purple_terracotta",south:"minecraft:block/purple_terracotta",west:"minecraft:block/purple_terracotta",east:"minecraft:block/purple_terracotta",particle:"minecraft:block/purple_terracotta"}},fv={id:284,transparent:!1,textures:{down:"minecraft:block/purple_wool",up:"minecraft:block/purple_wool",north:"minecraft:block/purple_wool",south:"minecraft:block/purple_wool",west:"minecraft:block/purple_wool",east:"minecraft:block/purple_wool",particle:"minecraft:block/purple_wool"}},pv={id:285,transparent:!1,textures:{down:"minecraft:block/purpur_block",up:"minecraft:block/purpur_block",north:"minecraft:block/purpur_block",south:"minecraft:block/purpur_block",west:"minecraft:block/purpur_block",east:"minecraft:block/purpur_block",particle:"minecraft:block/purpur_block"}},mv={id:286,transparent:!1,textures:{down:"minecraft:block/purpur_pillar_top",up:"minecraft:block/purpur_pillar_top",north:"minecraft:block/purpur_pillar",south:"minecraft:block/purpur_pillar",west:"minecraft:block/purpur_pillar",east:"minecraft:block/purpur_pillar",particle:"minecraft:block/purpur_pillar"}},_v={id:287,transparent:!1,textures:{down:"minecraft:block/purpur_pillar_top",up:"minecraft:block/purpur_pillar_top",north:"minecraft:block/purpur_pillar",south:"minecraft:block/purpur_pillar",west:"minecraft:block/purpur_pillar",east:"minecraft:block/purpur_pillar",particle:"minecraft:block/purpur_pillar"}},bv={id:288,transparent:!1,textures:{down:"minecraft:block/quartz_block_top",up:"minecraft:block/quartz_block_top",north:"minecraft:block/quartz_block_side",south:"minecraft:block/quartz_block_side",west:"minecraft:block/quartz_block_side",east:"minecraft:block/quartz_block_side",particle:"minecraft:block/quartz_block_side"}},gv={id:289,transparent:!1,textures:{down:"minecraft:block/quartz_bricks",up:"minecraft:block/quartz_bricks",north:"minecraft:block/quartz_bricks",south:"minecraft:block/quartz_bricks",west:"minecraft:block/quartz_bricks",east:"minecraft:block/quartz_bricks",particle:"minecraft:block/quartz_bricks"}},kv={id:290,transparent:!1,textures:{down:"minecraft:block/quartz_pillar_top",up:"minecraft:block/quartz_pillar_top",north:"minecraft:block/quartz_pillar",south:"minecraft:block/quartz_pillar",west:"minecraft:block/quartz_pillar",east:"minecraft:block/quartz_pillar",particle:"minecraft:block/quartz_pillar"}},xv={id:291,transparent:!1,textures:{down:"minecraft:block/quartz_pillar_top",up:"minecraft:block/quartz_pillar_top",north:"minecraft:block/quartz_pillar",south:"minecraft:block/quartz_pillar",west:"minecraft:block/quartz_pillar",east:"minecraft:block/quartz_pillar",particle:"minecraft:block/quartz_pillar"}},vv={id:292,transparent:!1,textures:{down:"minecraft:block/raw_copper_block",up:"minecraft:block/raw_copper_block",north:"minecraft:block/raw_copper_block",south:"minecraft:block/raw_copper_block",west:"minecraft:block/raw_copper_block",east:"minecraft:block/raw_copper_block",particle:"minecraft:block/raw_copper_block"}},wv={id:293,transparent:!1,textures:{down:"minecraft:block/raw_gold_block",up:"minecraft:block/raw_gold_block",north:"minecraft:block/raw_gold_block",south:"minecraft:block/raw_gold_block",west:"minecraft:block/raw_gold_block",east:"minecraft:block/raw_gold_block",particle:"minecraft:block/raw_gold_block"}},Sv={id:294,transparent:!1,textures:{down:"minecraft:block/raw_iron_block",up:"minecraft:block/raw_iron_block",north:"minecraft:block/raw_iron_block",south:"minecraft:block/raw_iron_block",west:"minecraft:block/raw_iron_block",east:"minecraft:block/raw_iron_block",particle:"minecraft:block/raw_iron_block"}},Mv={id:295,transparent:!1,textures:{down:"minecraft:block/redstone_block",up:"minecraft:block/redstone_block",north:"minecraft:block/redstone_block",south:"minecraft:block/redstone_block",west:"minecraft:block/redstone_block",east:"minecraft:block/redstone_block",particle:"minecraft:block/redstone_block"}},yv={id:296,transparent:!1,textures:{down:"minecraft:block/redstone_lamp",up:"minecraft:block/redstone_lamp",north:"minecraft:block/redstone_lamp",south:"minecraft:block/redstone_lamp",west:"minecraft:block/redstone_lamp",east:"minecraft:block/redstone_lamp",particle:"minecraft:block/redstone_lamp"}},Ev={id:297,transparent:!1,textures:{down:"minecraft:block/redstone_lamp_on",up:"minecraft:block/redstone_lamp_on",north:"minecraft:block/redstone_lamp_on",south:"minecraft:block/redstone_lamp_on",west:"minecraft:block/redstone_lamp_on",east:"minecraft:block/redstone_lamp_on",particle:"minecraft:block/redstone_lamp_on"}},Av={id:298,transparent:!1,textures:{down:"minecraft:block/redstone_ore",up:"minecraft:block/redstone_ore",north:"minecraft:block/redstone_ore",south:"minecraft:block/redstone_ore",west:"minecraft:block/redstone_ore",east:"minecraft:block/redstone_ore",particle:"minecraft:block/redstone_ore"}},Tv={id:299,transparent:!1,textures:{down:"minecraft:block/red_concrete",up:"minecraft:block/red_concrete",north:"minecraft:block/red_concrete",south:"minecraft:block/red_concrete",west:"minecraft:block/red_concrete",east:"minecraft:block/red_concrete",particle:"minecraft:block/red_concrete"}},Cv={id:300,transparent:!1,textures:{down:"minecraft:block/red_concrete_powder",up:"minecraft:block/red_concrete_powder",north:"minecraft:block/red_concrete_powder",south:"minecraft:block/red_concrete_powder",west:"minecraft:block/red_concrete_powder",east:"minecraft:block/red_concrete_powder",particle:"minecraft:block/red_concrete_powder"}},Rv={id:301,transparent:!1,textures:{down:"minecraft:block/red_mushroom_block",up:"minecraft:block/red_mushroom_block",north:"minecraft:block/red_mushroom_block",south:"minecraft:block/red_mushroom_block",west:"minecraft:block/red_mushroom_block",east:"minecraft:block/red_mushroom_block",particle:"minecraft:block/red_mushroom_block"}},Pv={id:302,transparent:!1,textures:{down:"minecraft:block/red_nether_bricks",up:"minecraft:block/red_nether_bricks",north:"minecraft:block/red_nether_bricks",south:"minecraft:block/red_nether_bricks",west:"minecraft:block/red_nether_bricks",east:"minecraft:block/red_nether_bricks",particle:"minecraft:block/red_nether_bricks"}},Lv={id:303,transparent:!1,textures:{down:"minecraft:block/red_sand",up:"minecraft:block/red_sand",north:"minecraft:block/red_sand",south:"minecraft:block/red_sand",west:"minecraft:block/red_sand",east:"minecraft:block/red_sand",particle:"minecraft:block/red_sand"}},Dv={id:304,transparent:!0,translucent:!0,textures:{down:"minecraft:block/red_stained_glass",up:"minecraft:block/red_stained_glass",north:"minecraft:block/red_stained_glass",south:"minecraft:block/red_stained_glass",west:"minecraft:block/red_stained_glass",east:"minecraft:block/red_stained_glass",particle:"minecraft:block/red_stained_glass"}},Iv={id:305,transparent:!1,textures:{down:"minecraft:block/red_terracotta",up:"minecraft:block/red_terracotta",north:"minecraft:block/red_terracotta",south:"minecraft:block/red_terracotta",west:"minecraft:block/red_terracotta",east:"minecraft:block/red_terracotta",particle:"minecraft:block/red_terracotta"}},Uv={id:306,transparent:!1,textures:{down:"minecraft:block/red_wool",up:"minecraft:block/red_wool",north:"minecraft:block/red_wool",south:"minecraft:block/red_wool",west:"minecraft:block/red_wool",east:"minecraft:block/red_wool",particle:"minecraft:block/red_wool"}},Nv={id:307,transparent:!1,textures:{down:"minecraft:block/resin_block",up:"minecraft:block/resin_block",north:"minecraft:block/resin_block",south:"minecraft:block/resin_block",west:"minecraft:block/resin_block",east:"minecraft:block/resin_block",particle:"minecraft:block/resin_block"}},Fv={id:308,transparent:!1,textures:{down:"minecraft:block/resin_bricks",up:"minecraft:block/resin_bricks",north:"minecraft:block/resin_bricks",south:"minecraft:block/resin_bricks",west:"minecraft:block/resin_bricks",east:"minecraft:block/resin_bricks",particle:"minecraft:block/resin_bricks"}},Ov={id:309,transparent:!1,textures:{down:"minecraft:block/rooted_dirt",up:"minecraft:block/rooted_dirt",north:"minecraft:block/rooted_dirt",south:"minecraft:block/rooted_dirt",west:"minecraft:block/rooted_dirt",east:"minecraft:block/rooted_dirt",particle:"minecraft:block/rooted_dirt"}},Bv={id:310,transparent:!1,textures:{down:"minecraft:block/sand",up:"minecraft:block/sand",north:"minecraft:block/sand",south:"minecraft:block/sand",west:"minecraft:block/sand",east:"minecraft:block/sand",particle:"minecraft:block/sand"}},zv={id:311,transparent:!1,textures:{down:"minecraft:block/sculk",up:"minecraft:block/sculk",north:"minecraft:block/sculk",south:"minecraft:block/sculk",west:"minecraft:block/sculk",east:"minecraft:block/sculk",particle:"minecraft:block/sculk"}},Vv={id:312,transparent:!1,textures:{down:"minecraft:block/sea_lantern",up:"minecraft:block/sea_lantern",north:"minecraft:block/sea_lantern",south:"minecraft:block/sea_lantern",west:"minecraft:block/sea_lantern",east:"minecraft:block/sea_lantern",particle:"minecraft:block/sea_lantern"}},Hv={id:313,transparent:!1,textures:{down:"minecraft:block/shroomlight",up:"minecraft:block/shroomlight",north:"minecraft:block/shroomlight",south:"minecraft:block/shroomlight",west:"minecraft:block/shroomlight",east:"minecraft:block/shroomlight",particle:"minecraft:block/shroomlight"}},Gv={id:314,transparent:!1,textures:{down:"block/slime_block",up:"block/slime_block",north:"block/slime_block",south:"block/slime_block",west:"block/slime_block",east:"block/slime_block",particle:"block/slime_block"}},Wv={id:315,transparent:!1,textures:{down:"minecraft:block/smithing_table_bottom",up:"minecraft:block/smithing_table_top",north:"minecraft:block/smithing_table_front",south:"minecraft:block/smithing_table_front",west:"minecraft:block/smithing_table_side",east:"minecraft:block/smithing_table_side",particle:"minecraft:block/smithing_table_front"}},Xv={id:316,transparent:!1,textures:{down:"minecraft:block/smooth_basalt",up:"minecraft:block/smooth_basalt",north:"minecraft:block/smooth_basalt",south:"minecraft:block/smooth_basalt",west:"minecraft:block/smooth_basalt",east:"minecraft:block/smooth_basalt",particle:"minecraft:block/smooth_basalt"}},$v={id:317,transparent:!1,textures:{down:"minecraft:block/quartz_block_bottom",up:"minecraft:block/quartz_block_bottom",north:"minecraft:block/quartz_block_bottom",south:"minecraft:block/quartz_block_bottom",west:"minecraft:block/quartz_block_bottom",east:"minecraft:block/quartz_block_bottom",particle:"minecraft:block/quartz_block_bottom"}},qv={id:318,transparent:!1,textures:{down:"minecraft:block/red_sandstone_top",up:"minecraft:block/red_sandstone_top",north:"minecraft:block/red_sandstone_top",south:"minecraft:block/red_sandstone_top",west:"minecraft:block/red_sandstone_top",east:"minecraft:block/red_sandstone_top",particle:"minecraft:block/red_sandstone_top"}},Yv={id:319,transparent:!1,textures:{down:"minecraft:block/sandstone_top",up:"minecraft:block/sandstone_top",north:"minecraft:block/sandstone_top",south:"minecraft:block/sandstone_top",west:"minecraft:block/sandstone_top",east:"minecraft:block/sandstone_top",particle:"minecraft:block/sandstone_top"}},Kv={id:320,transparent:!1,textures:{down:"minecraft:block/smooth_stone",up:"minecraft:block/smooth_stone",north:"minecraft:block/smooth_stone",south:"minecraft:block/smooth_stone",west:"minecraft:block/smooth_stone",east:"minecraft:block/smooth_stone",particle:"minecraft:block/smooth_stone"}},jv={id:321,transparent:!1,textures:{down:"minecraft:block/smooth_stone",up:"minecraft:block/smooth_stone",north:"minecraft:block/smooth_stone_slab_side",south:"minecraft:block/smooth_stone_slab_side",west:"minecraft:block/smooth_stone_slab_side",east:"minecraft:block/smooth_stone_slab_side",particle:"minecraft:block/smooth_stone_slab_side"}},Zv={id:322,transparent:!1,textures:{down:"minecraft:block/snow",up:"minecraft:block/snow",north:"minecraft:block/snow",south:"minecraft:block/snow",west:"minecraft:block/snow",east:"minecraft:block/snow",particle:"minecraft:block/snow"}},Jv={id:323,transparent:!1,textures:{down:"minecraft:block/soul_sand",up:"minecraft:block/soul_sand",north:"minecraft:block/soul_sand",south:"minecraft:block/soul_sand",west:"minecraft:block/soul_sand",east:"minecraft:block/soul_sand",particle:"minecraft:block/soul_sand"}},Qv={id:324,transparent:!1,textures:{down:"minecraft:block/soul_soil",up:"minecraft:block/soul_soil",north:"minecraft:block/soul_soil",south:"minecraft:block/soul_soil",west:"minecraft:block/soul_soil",east:"minecraft:block/soul_soil",particle:"minecraft:block/soul_soil"}},ew={id:325,transparent:!1,textures:{down:"minecraft:block/sponge",up:"minecraft:block/sponge",north:"minecraft:block/sponge",south:"minecraft:block/sponge",west:"minecraft:block/sponge",east:"minecraft:block/sponge",particle:"minecraft:block/sponge"}},tw={id:326,transparent:!1,textures:{down:"minecraft:block/spruce_log_top",up:"minecraft:block/spruce_log_top",north:"minecraft:block/spruce_log",south:"minecraft:block/spruce_log",west:"minecraft:block/spruce_log",east:"minecraft:block/spruce_log",particle:"minecraft:block/spruce_log"}},nw={id:327,transparent:!1,textures:{down:"minecraft:block/spruce_log_top",up:"minecraft:block/spruce_log_top",north:"minecraft:block/spruce_log",south:"minecraft:block/spruce_log",west:"minecraft:block/spruce_log",east:"minecraft:block/spruce_log",particle:"minecraft:block/spruce_log"}},iw={id:328,transparent:!1,textures:{down:"minecraft:block/spruce_planks",up:"minecraft:block/spruce_planks",north:"minecraft:block/spruce_planks",south:"minecraft:block/spruce_planks",west:"minecraft:block/spruce_planks",east:"minecraft:block/spruce_planks",particle:"minecraft:block/spruce_planks"}},rw={id:329,transparent:!1,textures:{down:"minecraft:block/spruce_log",up:"minecraft:block/spruce_log",north:"minecraft:block/spruce_log",south:"minecraft:block/spruce_log",west:"minecraft:block/spruce_log",east:"minecraft:block/spruce_log",particle:"minecraft:block/spruce_log"}},ow={id:330,transparent:!1,textures:{down:"minecraft:block/acacia_planks",up:"minecraft:block/acacia_planks",north:"minecraft:block/acacia_planks",south:"minecraft:block/acacia_planks",west:"minecraft:block/acacia_planks",east:"minecraft:block/acacia_planks",particle:"minecraft:block/acacia_planks"}},aw={id:331,transparent:!1,textures:{down:"minecraft:block/stone_bricks",up:"minecraft:block/stone_bricks",north:"minecraft:block/stone_bricks",south:"minecraft:block/stone_bricks",west:"minecraft:block/stone_bricks",east:"minecraft:block/stone_bricks",particle:"minecraft:block/stone_bricks"}},sw={id:332,transparent:!1,textures:{down:"minecraft:block/stripped_acacia_log_top",up:"minecraft:block/stripped_acacia_log_top",north:"minecraft:block/stripped_acacia_log",south:"minecraft:block/stripped_acacia_log",west:"minecraft:block/stripped_acacia_log",east:"minecraft:block/stripped_acacia_log",particle:"minecraft:block/stripped_acacia_log"}},cw={id:333,transparent:!1,textures:{down:"minecraft:block/stripped_acacia_log_top",up:"minecraft:block/stripped_acacia_log_top",north:"minecraft:block/stripped_acacia_log",south:"minecraft:block/stripped_acacia_log",west:"minecraft:block/stripped_acacia_log",east:"minecraft:block/stripped_acacia_log",particle:"minecraft:block/stripped_acacia_log"}},lw={id:334,transparent:!1,textures:{down:"minecraft:block/stripped_acacia_log",up:"minecraft:block/stripped_acacia_log",north:"minecraft:block/stripped_acacia_log",south:"minecraft:block/stripped_acacia_log",west:"minecraft:block/stripped_acacia_log",east:"minecraft:block/stripped_acacia_log",particle:"minecraft:block/stripped_acacia_log"}},dw={id:335,transparent:!1,textures:{down:"minecraft:block/stripped_bamboo_block_top",up:"minecraft:block/stripped_bamboo_block_top",north:"minecraft:block/stripped_bamboo_block",south:"minecraft:block/stripped_bamboo_block",west:"minecraft:block/stripped_bamboo_block",east:"minecraft:block/stripped_bamboo_block",particle:"minecraft:block/stripped_bamboo_block"}},uw={id:336,transparent:!1,textures:{down:"minecraft:block/stripped_birch_log_top",up:"minecraft:block/stripped_birch_log_top",north:"minecraft:block/stripped_birch_log",south:"minecraft:block/stripped_birch_log",west:"minecraft:block/stripped_birch_log",east:"minecraft:block/stripped_birch_log",particle:"minecraft:block/stripped_birch_log"}},hw={id:337,transparent:!1,textures:{down:"minecraft:block/stripped_birch_log_top",up:"minecraft:block/stripped_birch_log_top",north:"minecraft:block/stripped_birch_log",south:"minecraft:block/stripped_birch_log",west:"minecraft:block/stripped_birch_log",east:"minecraft:block/stripped_birch_log",particle:"minecraft:block/stripped_birch_log"}},fw={id:338,transparent:!1,textures:{down:"minecraft:block/stripped_birch_log",up:"minecraft:block/stripped_birch_log",north:"minecraft:block/stripped_birch_log",south:"minecraft:block/stripped_birch_log",west:"minecraft:block/stripped_birch_log",east:"minecraft:block/stripped_birch_log",particle:"minecraft:block/stripped_birch_log"}},pw={id:339,transparent:!1,textures:{down:"minecraft:block/stripped_cherry_log_top",up:"minecraft:block/stripped_cherry_log_top",north:"minecraft:block/stripped_cherry_log",south:"minecraft:block/stripped_cherry_log",west:"minecraft:block/stripped_cherry_log",east:"minecraft:block/stripped_cherry_log",particle:"minecraft:block/stripped_cherry_log"}},mw={id:340,transparent:!1,textures:{down:"minecraft:block/stripped_cherry_log",up:"minecraft:block/stripped_cherry_log",north:"minecraft:block/stripped_cherry_log",south:"minecraft:block/stripped_cherry_log",west:"minecraft:block/stripped_cherry_log",east:"minecraft:block/stripped_cherry_log",particle:"minecraft:block/stripped_cherry_log"}},_w={id:341,transparent:!1,textures:{down:"minecraft:block/stripped_crimson_stem",up:"minecraft:block/stripped_crimson_stem",north:"minecraft:block/stripped_crimson_stem",south:"minecraft:block/stripped_crimson_stem",west:"minecraft:block/stripped_crimson_stem",east:"minecraft:block/stripped_crimson_stem",particle:"minecraft:block/stripped_crimson_stem"}},bw={id:342,transparent:!1,textures:{down:"minecraft:block/stripped_crimson_stem_top",up:"minecraft:block/stripped_crimson_stem_top",north:"minecraft:block/stripped_crimson_stem",south:"minecraft:block/stripped_crimson_stem",west:"minecraft:block/stripped_crimson_stem",east:"minecraft:block/stripped_crimson_stem",particle:"minecraft:block/stripped_crimson_stem"}},gw={id:343,transparent:!1,textures:{down:"minecraft:block/stripped_dark_oak_log_top",up:"minecraft:block/stripped_dark_oak_log_top",north:"minecraft:block/stripped_dark_oak_log",south:"minecraft:block/stripped_dark_oak_log",west:"minecraft:block/stripped_dark_oak_log",east:"minecraft:block/stripped_dark_oak_log",particle:"minecraft:block/stripped_dark_oak_log"}},kw={id:344,transparent:!1,textures:{down:"minecraft:block/stripped_dark_oak_log_top",up:"minecraft:block/stripped_dark_oak_log_top",north:"minecraft:block/stripped_dark_oak_log",south:"minecraft:block/stripped_dark_oak_log",west:"minecraft:block/stripped_dark_oak_log",east:"minecraft:block/stripped_dark_oak_log",particle:"minecraft:block/stripped_dark_oak_log"}},xw={id:345,transparent:!1,textures:{down:"minecraft:block/stripped_dark_oak_log",up:"minecraft:block/stripped_dark_oak_log",north:"minecraft:block/stripped_dark_oak_log",south:"minecraft:block/stripped_dark_oak_log",west:"minecraft:block/stripped_dark_oak_log",east:"minecraft:block/stripped_dark_oak_log",particle:"minecraft:block/stripped_dark_oak_log"}},vw={id:346,transparent:!1,textures:{down:"minecraft:block/stripped_jungle_log_top",up:"minecraft:block/stripped_jungle_log_top",north:"minecraft:block/stripped_jungle_log",south:"minecraft:block/stripped_jungle_log",west:"minecraft:block/stripped_jungle_log",east:"minecraft:block/stripped_jungle_log",particle:"minecraft:block/stripped_jungle_log"}},ww={id:347,transparent:!1,textures:{down:"minecraft:block/stripped_jungle_log_top",up:"minecraft:block/stripped_jungle_log_top",north:"minecraft:block/stripped_jungle_log",south:"minecraft:block/stripped_jungle_log",west:"minecraft:block/stripped_jungle_log",east:"minecraft:block/stripped_jungle_log",particle:"minecraft:block/stripped_jungle_log"}},Sw={id:348,transparent:!1,textures:{down:"minecraft:block/stripped_jungle_log",up:"minecraft:block/stripped_jungle_log",north:"minecraft:block/stripped_jungle_log",south:"minecraft:block/stripped_jungle_log",west:"minecraft:block/stripped_jungle_log",east:"minecraft:block/stripped_jungle_log",particle:"minecraft:block/stripped_jungle_log"}},Mw={id:349,transparent:!1,textures:{down:"minecraft:block/stripped_mangrove_log_top",up:"minecraft:block/stripped_mangrove_log_top",north:"minecraft:block/stripped_mangrove_log",south:"minecraft:block/stripped_mangrove_log",west:"minecraft:block/stripped_mangrove_log",east:"minecraft:block/stripped_mangrove_log",particle:"minecraft:block/stripped_mangrove_log"}},yw={id:350,transparent:!1,textures:{down:"minecraft:block/stripped_mangrove_log_top",up:"minecraft:block/stripped_mangrove_log_top",north:"minecraft:block/stripped_mangrove_log",south:"minecraft:block/stripped_mangrove_log",west:"minecraft:block/stripped_mangrove_log",east:"minecraft:block/stripped_mangrove_log",particle:"minecraft:block/stripped_mangrove_log"}},Ew={id:351,transparent:!1,textures:{down:"minecraft:block/stripped_mangrove_log",up:"minecraft:block/stripped_mangrove_log",north:"minecraft:block/stripped_mangrove_log",south:"minecraft:block/stripped_mangrove_log",west:"minecraft:block/stripped_mangrove_log",east:"minecraft:block/stripped_mangrove_log",particle:"minecraft:block/stripped_mangrove_log"}},Aw={id:352,transparent:!1,textures:{down:"minecraft:block/stripped_oak_log_top",up:"minecraft:block/stripped_oak_log_top",north:"minecraft:block/stripped_oak_log",south:"minecraft:block/stripped_oak_log",west:"minecraft:block/stripped_oak_log",east:"minecraft:block/stripped_oak_log",particle:"minecraft:block/stripped_oak_log"}},Tw={id:353,transparent:!1,textures:{down:"minecraft:block/stripped_oak_log_top",up:"minecraft:block/stripped_oak_log_top",north:"minecraft:block/stripped_oak_log",south:"minecraft:block/stripped_oak_log",west:"minecraft:block/stripped_oak_log",east:"minecraft:block/stripped_oak_log",particle:"minecraft:block/stripped_oak_log"}},Cw={id:354,transparent:!1,textures:{down:"minecraft:block/stripped_oak_log",up:"minecraft:block/stripped_oak_log",north:"minecraft:block/stripped_oak_log",south:"minecraft:block/stripped_oak_log",west:"minecraft:block/stripped_oak_log",east:"minecraft:block/stripped_oak_log",particle:"minecraft:block/stripped_oak_log"}},Rw={id:355,transparent:!1,textures:{down:"minecraft:block/stripped_pale_oak_log_top",up:"minecraft:block/stripped_pale_oak_log_top",north:"minecraft:block/stripped_pale_oak_log",south:"minecraft:block/stripped_pale_oak_log",west:"minecraft:block/stripped_pale_oak_log",east:"minecraft:block/stripped_pale_oak_log",particle:"minecraft:block/stripped_pale_oak_log"}},Pw={id:356,transparent:!1,textures:{down:"minecraft:block/stripped_pale_oak_log_top",up:"minecraft:block/stripped_pale_oak_log_top",north:"minecraft:block/stripped_pale_oak_log",south:"minecraft:block/stripped_pale_oak_log",west:"minecraft:block/stripped_pale_oak_log",east:"minecraft:block/stripped_pale_oak_log",particle:"minecraft:block/stripped_pale_oak_log"}},Lw={id:357,transparent:!1,textures:{down:"minecraft:block/stripped_pale_oak_log",up:"minecraft:block/stripped_pale_oak_log",north:"minecraft:block/stripped_pale_oak_log",south:"minecraft:block/stripped_pale_oak_log",west:"minecraft:block/stripped_pale_oak_log",east:"minecraft:block/stripped_pale_oak_log",particle:"minecraft:block/stripped_pale_oak_log"}},Dw={id:358,transparent:!1,textures:{down:"minecraft:block/stripped_spruce_log_top",up:"minecraft:block/stripped_spruce_log_top",north:"minecraft:block/stripped_spruce_log",south:"minecraft:block/stripped_spruce_log",west:"minecraft:block/stripped_spruce_log",east:"minecraft:block/stripped_spruce_log",particle:"minecraft:block/stripped_spruce_log"}},Iw={id:359,transparent:!1,textures:{down:"minecraft:block/stripped_spruce_log_top",up:"minecraft:block/stripped_spruce_log_top",north:"minecraft:block/stripped_spruce_log",south:"minecraft:block/stripped_spruce_log",west:"minecraft:block/stripped_spruce_log",east:"minecraft:block/stripped_spruce_log",particle:"minecraft:block/stripped_spruce_log"}},Uw={id:360,transparent:!1,textures:{down:"minecraft:block/stripped_spruce_log",up:"minecraft:block/stripped_spruce_log",north:"minecraft:block/stripped_spruce_log",south:"minecraft:block/stripped_spruce_log",west:"minecraft:block/stripped_spruce_log",east:"minecraft:block/stripped_spruce_log",particle:"minecraft:block/stripped_spruce_log"}},Nw={id:361,transparent:!1,textures:{down:"minecraft:block/stripped_warped_stem",up:"minecraft:block/stripped_warped_stem",north:"minecraft:block/stripped_warped_stem",south:"minecraft:block/stripped_warped_stem",west:"minecraft:block/stripped_warped_stem",east:"minecraft:block/stripped_warped_stem",particle:"minecraft:block/stripped_warped_stem"}},Fw={id:362,transparent:!1,textures:{down:"minecraft:block/stripped_warped_stem_top",up:"minecraft:block/stripped_warped_stem_top",north:"minecraft:block/stripped_warped_stem",south:"minecraft:block/stripped_warped_stem",west:"minecraft:block/stripped_warped_stem",east:"minecraft:block/stripped_warped_stem",particle:"minecraft:block/stripped_warped_stem"}},Ow={id:363,transparent:!1,textures:{down:"minecraft:block/structure_block",up:"minecraft:block/structure_block",north:"minecraft:block/structure_block",south:"minecraft:block/structure_block",west:"minecraft:block/structure_block",east:"minecraft:block/structure_block",particle:"minecraft:block/structure_block"}},Bw={id:364,transparent:!1,textures:{down:"minecraft:block/structure_block_corner",up:"minecraft:block/structure_block_corner",north:"minecraft:block/structure_block_corner",south:"minecraft:block/structure_block_corner",west:"minecraft:block/structure_block_corner",east:"minecraft:block/structure_block_corner",particle:"minecraft:block/structure_block_corner"}},zw={id:365,transparent:!1,textures:{down:"minecraft:block/structure_block_data",up:"minecraft:block/structure_block_data",north:"minecraft:block/structure_block_data",south:"minecraft:block/structure_block_data",west:"minecraft:block/structure_block_data",east:"minecraft:block/structure_block_data",particle:"minecraft:block/structure_block_data"}},Vw={id:366,transparent:!1,textures:{down:"minecraft:block/structure_block_load",up:"minecraft:block/structure_block_load",north:"minecraft:block/structure_block_load",south:"minecraft:block/structure_block_load",west:"minecraft:block/structure_block_load",east:"minecraft:block/structure_block_load",particle:"minecraft:block/structure_block_load"}},Hw={id:367,transparent:!1,textures:{down:"minecraft:block/structure_block_save",up:"minecraft:block/structure_block_save",north:"minecraft:block/structure_block_save",south:"minecraft:block/structure_block_save",west:"minecraft:block/structure_block_save",east:"minecraft:block/structure_block_save",particle:"minecraft:block/structure_block_save"}},Gw={id:368,transparent:!1,textures:{down:"minecraft:block/suspicious_gravel_0",up:"minecraft:block/suspicious_gravel_0",north:"minecraft:block/suspicious_gravel_0",south:"minecraft:block/suspicious_gravel_0",west:"minecraft:block/suspicious_gravel_0",east:"minecraft:block/suspicious_gravel_0",particle:"minecraft:block/suspicious_gravel_0"}},Ww={id:369,transparent:!1,textures:{down:"minecraft:block/suspicious_gravel_1",up:"minecraft:block/suspicious_gravel_1",north:"minecraft:block/suspicious_gravel_1",south:"minecraft:block/suspicious_gravel_1",west:"minecraft:block/suspicious_gravel_1",east:"minecraft:block/suspicious_gravel_1",particle:"minecraft:block/suspicious_gravel_1"}},Xw={id:370,transparent:!1,textures:{down:"minecraft:block/suspicious_gravel_2",up:"minecraft:block/suspicious_gravel_2",north:"minecraft:block/suspicious_gravel_2",south:"minecraft:block/suspicious_gravel_2",west:"minecraft:block/suspicious_gravel_2",east:"minecraft:block/suspicious_gravel_2",particle:"minecraft:block/suspicious_gravel_2"}},$w={id:371,transparent:!1,textures:{down:"minecraft:block/suspicious_gravel_3",up:"minecraft:block/suspicious_gravel_3",north:"minecraft:block/suspicious_gravel_3",south:"minecraft:block/suspicious_gravel_3",west:"minecraft:block/suspicious_gravel_3",east:"minecraft:block/suspicious_gravel_3",particle:"minecraft:block/suspicious_gravel_3"}},qw={id:372,transparent:!1,textures:{down:"minecraft:block/suspicious_sand_0",up:"minecraft:block/suspicious_sand_0",north:"minecraft:block/suspicious_sand_0",south:"minecraft:block/suspicious_sand_0",west:"minecraft:block/suspicious_sand_0",east:"minecraft:block/suspicious_sand_0",particle:"minecraft:block/suspicious_sand_0"}},Yw={id:373,transparent:!1,textures:{down:"minecraft:block/suspicious_sand_1",up:"minecraft:block/suspicious_sand_1",north:"minecraft:block/suspicious_sand_1",south:"minecraft:block/suspicious_sand_1",west:"minecraft:block/suspicious_sand_1",east:"minecraft:block/suspicious_sand_1",particle:"minecraft:block/suspicious_sand_1"}},Kw={id:374,transparent:!1,textures:{down:"minecraft:block/suspicious_sand_2",up:"minecraft:block/suspicious_sand_2",north:"minecraft:block/suspicious_sand_2",south:"minecraft:block/suspicious_sand_2",west:"minecraft:block/suspicious_sand_2",east:"minecraft:block/suspicious_sand_2",particle:"minecraft:block/suspicious_sand_2"}},jw={id:375,transparent:!1,textures:{down:"minecraft:block/suspicious_sand_3",up:"minecraft:block/suspicious_sand_3",north:"minecraft:block/suspicious_sand_3",south:"minecraft:block/suspicious_sand_3",west:"minecraft:block/suspicious_sand_3",east:"minecraft:block/suspicious_sand_3",particle:"minecraft:block/suspicious_sand_3"}},Zw={id:376,transparent:!1,textures:{down:"minecraft:block/target_top",up:"minecraft:block/target_top",north:"minecraft:block/target_side",south:"minecraft:block/target_side",west:"minecraft:block/target_side",east:"minecraft:block/target_side",particle:"minecraft:block/target_side"}},Jw={id:377,transparent:!1,textures:{down:"minecraft:block/terracotta",up:"minecraft:block/terracotta",north:"minecraft:block/terracotta",south:"minecraft:block/terracotta",west:"minecraft:block/terracotta",east:"minecraft:block/terracotta",particle:"minecraft:block/terracotta"}},Qw={id:378,transparent:!1,textures:{down:"minecraft:block/test_block_accept",up:"minecraft:block/test_block_accept",north:"minecraft:block/test_block_accept",south:"minecraft:block/test_block_accept",west:"minecraft:block/test_block_accept",east:"minecraft:block/test_block_accept",particle:"minecraft:block/test_block_accept"}},eS={id:379,transparent:!1,textures:{down:"minecraft:block/test_block_fail",up:"minecraft:block/test_block_fail",north:"minecraft:block/test_block_fail",south:"minecraft:block/test_block_fail",west:"minecraft:block/test_block_fail",east:"minecraft:block/test_block_fail",particle:"minecraft:block/test_block_fail"}},tS={id:380,transparent:!1,textures:{down:"minecraft:block/test_block_log",up:"minecraft:block/test_block_log",north:"minecraft:block/test_block_log",south:"minecraft:block/test_block_log",west:"minecraft:block/test_block_log",east:"minecraft:block/test_block_log",particle:"minecraft:block/test_block_log"}},nS={id:381,transparent:!1,textures:{down:"minecraft:block/test_block_start",up:"minecraft:block/test_block_start",north:"minecraft:block/test_block_start",south:"minecraft:block/test_block_start",west:"minecraft:block/test_block_start",east:"minecraft:block/test_block_start",particle:"minecraft:block/test_block_start"}},iS={id:382,transparent:!1,textures:{down:"minecraft:block/test_instance_block",up:"minecraft:block/test_instance_block",north:"minecraft:block/test_instance_block",south:"minecraft:block/test_instance_block",west:"minecraft:block/test_instance_block",east:"minecraft:block/test_instance_block",particle:"minecraft:block/test_instance_block"}},rS={id:383,transparent:!0,translucent:!0,textures:{down:"minecraft:block/tinted_glass",up:"minecraft:block/tinted_glass",north:"minecraft:block/tinted_glass",south:"minecraft:block/tinted_glass",west:"minecraft:block/tinted_glass",east:"minecraft:block/tinted_glass",particle:"minecraft:block/tinted_glass"}},oS={id:384,transparent:!1,textures:{down:"minecraft:block/tube_coral_block",up:"minecraft:block/tube_coral_block",north:"minecraft:block/tube_coral_block",south:"minecraft:block/tube_coral_block",west:"minecraft:block/tube_coral_block",east:"minecraft:block/tube_coral_block",particle:"minecraft:block/tube_coral_block"}},aS={id:385,transparent:!1,textures:{down:"minecraft:block/tuff",up:"minecraft:block/tuff",north:"minecraft:block/tuff",south:"minecraft:block/tuff",west:"minecraft:block/tuff",east:"minecraft:block/tuff",particle:"minecraft:block/tuff"}},sS={id:386,transparent:!1,textures:{down:"minecraft:block/tuff_bricks",up:"minecraft:block/tuff_bricks",north:"minecraft:block/tuff_bricks",south:"minecraft:block/tuff_bricks",west:"minecraft:block/tuff_bricks",east:"minecraft:block/tuff_bricks",particle:"minecraft:block/tuff_bricks"}},cS={id:387,transparent:!1,textures:{down:"minecraft:block/verdant_froglight_top",up:"minecraft:block/verdant_froglight_top",north:"minecraft:block/verdant_froglight_side",south:"minecraft:block/verdant_froglight_side",west:"minecraft:block/verdant_froglight_side",east:"minecraft:block/verdant_froglight_side",particle:"minecraft:block/verdant_froglight_side"}},lS={id:388,transparent:!1,textures:{down:"minecraft:block/verdant_froglight_top",up:"minecraft:block/verdant_froglight_top",north:"minecraft:block/verdant_froglight_side",south:"minecraft:block/verdant_froglight_side",west:"minecraft:block/verdant_froglight_side",east:"minecraft:block/verdant_froglight_side",particle:"minecraft:block/verdant_froglight_side"}},dS={id:389,transparent:!1,textures:{down:"minecraft:block/warped_stem",up:"minecraft:block/warped_stem",north:"minecraft:block/warped_stem",south:"minecraft:block/warped_stem",west:"minecraft:block/warped_stem",east:"minecraft:block/warped_stem",particle:"minecraft:block/warped_stem"}},uS={id:390,transparent:!1,textures:{down:"minecraft:block/warped_planks",up:"minecraft:block/warped_planks",north:"minecraft:block/warped_planks",south:"minecraft:block/warped_planks",west:"minecraft:block/warped_planks",east:"minecraft:block/warped_planks",particle:"minecraft:block/warped_planks"}},hS={id:391,transparent:!1,textures:{down:"minecraft:block/warped_stem_top",up:"minecraft:block/warped_stem_top",north:"minecraft:block/warped_stem",south:"minecraft:block/warped_stem",west:"minecraft:block/warped_stem",east:"minecraft:block/warped_stem",particle:"minecraft:block/warped_stem"}},fS={id:392,transparent:!1,textures:{down:"minecraft:block/warped_wart_block",up:"minecraft:block/warped_wart_block",north:"minecraft:block/warped_wart_block",south:"minecraft:block/warped_wart_block",west:"minecraft:block/warped_wart_block",east:"minecraft:block/warped_wart_block",particle:"minecraft:block/warped_wart_block"}},pS={id:393,transparent:!1,textures:{down:"minecraft:block/weathered_chiseled_copper",up:"minecraft:block/weathered_chiseled_copper",north:"minecraft:block/weathered_chiseled_copper",south:"minecraft:block/weathered_chiseled_copper",west:"minecraft:block/weathered_chiseled_copper",east:"minecraft:block/weathered_chiseled_copper",particle:"minecraft:block/weathered_chiseled_copper"}},mS={id:394,transparent:!1,textures:{down:"minecraft:block/weathered_copper",up:"minecraft:block/weathered_copper",north:"minecraft:block/weathered_copper",south:"minecraft:block/weathered_copper",west:"minecraft:block/weathered_copper",east:"minecraft:block/weathered_copper",particle:"minecraft:block/weathered_copper"}},_S={id:395,transparent:!1,textures:{down:"minecraft:block/weathered_copper_bulb",up:"minecraft:block/weathered_copper_bulb",north:"minecraft:block/weathered_copper_bulb",south:"minecraft:block/weathered_copper_bulb",west:"minecraft:block/weathered_copper_bulb",east:"minecraft:block/weathered_copper_bulb",particle:"minecraft:block/weathered_copper_bulb"}},bS={id:396,transparent:!1,textures:{down:"minecraft:block/weathered_copper_bulb_lit",up:"minecraft:block/weathered_copper_bulb_lit",north:"minecraft:block/weathered_copper_bulb_lit",south:"minecraft:block/weathered_copper_bulb_lit",west:"minecraft:block/weathered_copper_bulb_lit",east:"minecraft:block/weathered_copper_bulb_lit",particle:"minecraft:block/weathered_copper_bulb_lit"}},gS={id:397,transparent:!1,textures:{down:"minecraft:block/weathered_copper_bulb_lit_powered",up:"minecraft:block/weathered_copper_bulb_lit_powered",north:"minecraft:block/weathered_copper_bulb_lit_powered",south:"minecraft:block/weathered_copper_bulb_lit_powered",west:"minecraft:block/weathered_copper_bulb_lit_powered",east:"minecraft:block/weathered_copper_bulb_lit_powered",particle:"minecraft:block/weathered_copper_bulb_lit_powered"}},kS={id:398,transparent:!1,textures:{down:"minecraft:block/weathered_copper_bulb_powered",up:"minecraft:block/weathered_copper_bulb_powered",north:"minecraft:block/weathered_copper_bulb_powered",south:"minecraft:block/weathered_copper_bulb_powered",west:"minecraft:block/weathered_copper_bulb_powered",east:"minecraft:block/weathered_copper_bulb_powered",particle:"minecraft:block/weathered_copper_bulb_powered"}},xS={id:399,transparent:!1,textures:{down:"minecraft:block/weathered_copper_grate",up:"minecraft:block/weathered_copper_grate",north:"minecraft:block/weathered_copper_grate",south:"minecraft:block/weathered_copper_grate",west:"minecraft:block/weathered_copper_grate",east:"minecraft:block/weathered_copper_grate",particle:"minecraft:block/weathered_copper_grate"}},vS={id:400,transparent:!1,textures:{down:"minecraft:block/weathered_cut_copper",up:"minecraft:block/weathered_cut_copper",north:"minecraft:block/weathered_cut_copper",south:"minecraft:block/weathered_cut_copper",west:"minecraft:block/weathered_cut_copper",east:"minecraft:block/weathered_cut_copper",particle:"minecraft:block/weathered_cut_copper"}},wS={id:401,transparent:!1,textures:{down:"minecraft:block/wet_sponge",up:"minecraft:block/wet_sponge",north:"minecraft:block/wet_sponge",south:"minecraft:block/wet_sponge",west:"minecraft:block/wet_sponge",east:"minecraft:block/wet_sponge",particle:"minecraft:block/wet_sponge"}},SS={id:402,transparent:!1,textures:{down:"minecraft:block/white_concrete",up:"minecraft:block/white_concrete",north:"minecraft:block/white_concrete",south:"minecraft:block/white_concrete",west:"minecraft:block/white_concrete",east:"minecraft:block/white_concrete",particle:"minecraft:block/white_concrete"}},MS={id:403,transparent:!1,textures:{down:"minecraft:block/white_concrete_powder",up:"minecraft:block/white_concrete_powder",north:"minecraft:block/white_concrete_powder",south:"minecraft:block/white_concrete_powder",west:"minecraft:block/white_concrete_powder",east:"minecraft:block/white_concrete_powder",particle:"minecraft:block/white_concrete_powder"}},yS={id:404,transparent:!0,translucent:!0,textures:{down:"minecraft:block/white_stained_glass",up:"minecraft:block/white_stained_glass",north:"minecraft:block/white_stained_glass",south:"minecraft:block/white_stained_glass",west:"minecraft:block/white_stained_glass",east:"minecraft:block/white_stained_glass",particle:"minecraft:block/white_stained_glass"}},ES={id:405,transparent:!1,textures:{down:"minecraft:block/white_terracotta",up:"minecraft:block/white_terracotta",north:"minecraft:block/white_terracotta",south:"minecraft:block/white_terracotta",west:"minecraft:block/white_terracotta",east:"minecraft:block/white_terracotta",particle:"minecraft:block/white_terracotta"}},AS={id:406,transparent:!1,textures:{down:"minecraft:block/white_wool",up:"minecraft:block/white_wool",north:"minecraft:block/white_wool",south:"minecraft:block/white_wool",west:"minecraft:block/white_wool",east:"minecraft:block/white_wool",particle:"minecraft:block/white_wool"}},TS={id:407,transparent:!1,textures:{down:"minecraft:block/yellow_concrete",up:"minecraft:block/yellow_concrete",north:"minecraft:block/yellow_concrete",south:"minecraft:block/yellow_concrete",west:"minecraft:block/yellow_concrete",east:"minecraft:block/yellow_concrete",particle:"minecraft:block/yellow_concrete"}},CS={id:408,transparent:!1,textures:{down:"minecraft:block/yellow_concrete_powder",up:"minecraft:block/yellow_concrete_powder",north:"minecraft:block/yellow_concrete_powder",south:"minecraft:block/yellow_concrete_powder",west:"minecraft:block/yellow_concrete_powder",east:"minecraft:block/yellow_concrete_powder",particle:"minecraft:block/yellow_concrete_powder"}},RS={id:409,transparent:!0,translucent:!0,textures:{down:"minecraft:block/yellow_stained_glass",up:"minecraft:block/yellow_stained_glass",north:"minecraft:block/yellow_stained_glass",south:"minecraft:block/yellow_stained_glass",west:"minecraft:block/yellow_stained_glass",east:"minecraft:block/yellow_stained_glass",particle:"minecraft:block/yellow_stained_glass"}},PS={id:410,transparent:!1,textures:{down:"minecraft:block/yellow_terracotta",up:"minecraft:block/yellow_terracotta",north:"minecraft:block/yellow_terracotta",south:"minecraft:block/yellow_terracotta",west:"minecraft:block/yellow_terracotta",east:"minecraft:block/yellow_terracotta",particle:"minecraft:block/yellow_terracotta"}},LS={id:411,transparent:!1,textures:{down:"minecraft:block/yellow_wool",up:"minecraft:block/yellow_wool",north:"minecraft:block/yellow_wool",south:"minecraft:block/yellow_wool",west:"minecraft:block/yellow_wool",east:"minecraft:block/yellow_wool",particle:"minecraft:block/yellow_wool"}},DS={id:412,transparent:!1,textures:{down:"minecraft:block/amethyst_block",up:"minecraft:block/amethyst_block",north:"minecraft:block/amethyst_block",south:"minecraft:block/amethyst_block",west:"minecraft:block/amethyst_block",east:"minecraft:block/amethyst_block",particle:"minecraft:block/amethyst_block"}},IS={dirt:eb,stone:tb,grass_block:nb,water:ib,ancient_debris:rb,andesite:ob,azalea_leaves:ab,bamboo_block:sb,bamboo_mosaic:cb,bamboo_planks:lb,basalt:db,bedrock:ub,birch_log:hb,birch_log_horizontal:fb,birch_planks:pb,birch_wood:mb,blackstone:_b,black_concrete:bb,black_concrete_powder:gb,black_stained_glass:kb,black_terracotta:xb,black_wool:vb,blast_furnace:wb,blast_furnace_on:Sb,blue_concrete:Mb,blue_concrete_powder:yb,blue_ice:Eb,blue_stained_glass:Ab,blue_terracotta:Tb,blue_wool:Cb,bone_block:Rb,bookshelf:Pb,brain_coral_block:Lb,bricks:Db,brown_concrete:Ib,brown_concrete_powder:Ub,brown_mushroom_block_inventory:Nb,brown_stained_glass:Fb,brown_terracotta:Ob,brown_wool:Bb,bubble_coral_block:zb,budding_amethyst:Vb,calcite:Hb,cartography_table:Gb,carved_pumpkin:Wb,cherry_log:Xb,cherry_planks:$b,cherry_wood:qb,chiseled_bookshelf_inventory:Yb,chiseled_copper:Kb,chiseled_deepslate:jb,chiseled_nether_bricks:Zb,chiseled_polished_blackstone:Jb,chiseled_quartz_block:Qb,chiseled_red_sandstone:eg,chiseled_resin_bricks:tg,chiseled_sandstone:ng,chiseled_stone_bricks:ig,chiseled_tuff:rg,chiseled_tuff_bricks:og,clay:ag,coal_block:sg,coal_ore:cg,coarse_dirt:lg,cobbled_deepslate:dg,cobblestone:ug,copper_block:hg,copper_bulb:fg,copper_bulb_lit:pg,copper_bulb_lit_powered:mg,copper_bulb_powered:_g,copper_grate:bg,copper_ore:gg,cracked_deepslate_bricks:kg,cracked_deepslate_tiles:xg,cracked_nether_bricks:vg,cracked_polished_blackstone_bricks:wg,cracked_stone_bricks:Sg,crafter:Mg,crafting_table:yg,creaking_heart:Eg,creaking_heart_awake:Ag,creaking_heart_awake_horizontal:Tg,creaking_heart_dormant:Cg,creaking_heart_dormant_horizontal:Rg,creaking_heart_horizontal:Pg,crimson_hyphae:Lg,crimson_planks:Dg,crimson_stem:Ig,crying_obsidian:Ug,cut_copper:Ng,cut_red_sandstone:Fg,cut_sandstone:Og,cyan_concrete:Bg,cyan_concrete_powder:zg,cyan_stained_glass:Vg,cyan_terracotta:Hg,cyan_wool:Gg,dark_oak_log:Wg,dark_oak_log_horizontal:Xg,dark_oak_planks:$g,dark_oak_wood:qg,dark_prismarine:Yg,dead_brain_coral_block:Kg,dead_bubble_coral_block:jg,dead_fire_coral_block:Zg,dead_horn_coral_block:Jg,dead_tube_coral_block:Qg,deepslate:ek,deepslate_bricks:tk,deepslate_coal_ore:nk,deepslate_copper_ore:ik,deepslate_diamond_ore:rk,deepslate_emerald_ore:ok,deepslate_gold_ore:ak,deepslate_iron_ore:sk,deepslate_lapis_ore:ck,deepslate_redstone_ore:lk,deepslate_tiles:dk,diamond_block:uk,diamond_ore:hk,diorite:fk,acacia_log:pk,dispenser:mk,dried_kelp_block:_k,dripstone_block:bk,dropper:gk,emerald_block:kk,emerald_ore:xk,end_stone:vk,end_stone_bricks:wk,exposed_chiseled_copper:Sk,exposed_copper:Mk,exposed_copper_bulb:yk,exposed_copper_bulb_lit:Ek,exposed_copper_bulb_lit_powered:Ak,exposed_copper_bulb_powered:Tk,exposed_copper_grate:Ck,exposed_cut_copper:Rk,fire_coral_block:Pk,fletching_table:Lk,acacia_leaves:Dk,flowering_azalea_leaves:Ik,birch_leaves:Uk,cherry_leaves:Nk,dark_oak_leaves:Fk,jungle_leaves:Ok,mangrove_leaves:Bk,oak_leaves:zk,pale_oak_leaves:Vk,spruce_leaves:Hk,frosted_ice_0:Gk,frosted_ice_1:Wk,frosted_ice_2:Xk,frosted_ice_3:$k,furnace:qk,furnace_on:Yk,gilded_blackstone:Kk,glass:jk,glowstone:Zk,gold_block:Jk,gold_ore:Qk,granite:ex,acacia_wood:tx,gravel:nx,gray_concrete:ix,gray_concrete_powder:rx,gray_stained_glass:ox,gray_terracotta:ax,gray_wool:sx,green_concrete:cx,green_concrete_powder:lx,green_stained_glass:dx,green_terracotta:ux,green_wool:hx,hay_block:fx,hay_block_horizontal:px,honeycomb_block:mx,honey_block:_x,horn_coral_block:bx,ice:gx,iron_block:kx,iron_ore:xx,jack_o_lantern:vx,jigsaw:wx,jukebox:Sx,jungle_log:Mx,jungle_log_horizontal:yx,jungle_planks:Ex,jungle_wood:Ax,lapis_block:Tx,lapis_ore:Cx,light_blue_concrete:Rx,light_blue_concrete_powder:Px,light_blue_stained_glass:Lx,light_blue_terracotta:Dx,light_blue_wool:Ix,light_gray_concrete:Ux,light_gray_concrete_powder:Nx,light_gray_stained_glass:Fx,light_gray_terracotta:Ox,light_gray_wool:Bx,lime_concrete:zx,lime_concrete_powder:Vx,lime_stained_glass:Hx,lime_terracotta:Gx,lime_wool:Wx,lodestone:Xx,magenta_concrete:$x,magenta_concrete_powder:qx,magenta_stained_glass:Yx,magenta_terracotta:Kx,magenta_wool:jx,magma_block:Zx,mangrove_log:Jx,mangrove_log_horizontal:Qx,mangrove_planks:e0,mangrove_wood:t0,melon:n0,mossy_cobblestone:i0,mossy_stone_bricks:r0,moss_block:o0,mud:a0,muddy_mangrove_roots:s0,mud_bricks:c0,mushroom_stem_inventory:l0,netherite_block:d0,netherrack:u0,nether_bricks:h0,nether_gold_ore:f0,nether_quartz_ore:p0,nether_wart_block:m0,note_block:_0,oak_log:b0,oak_log_horizontal:g0,oak_planks:k0,oak_wood:x0,observer:v0,obsidian:w0,ochre_froglight:S0,ochre_froglight_horizontal:M0,orange_concrete:y0,orange_concrete_powder:E0,orange_stained_glass:A0,orange_terracotta:T0,orange_wool:C0,oxidized_chiseled_copper:R0,oxidized_copper:P0,oxidized_copper_bulb:L0,oxidized_copper_bulb_lit:D0,oxidized_copper_bulb_lit_powered:I0,oxidized_copper_bulb_powered:U0,oxidized_copper_grate:N0,oxidized_cut_copper:F0,packed_ice:O0,packed_mud:B0,pale_moss_block:z0,pale_oak_log:V0,pale_oak_log_horizontal:H0,pale_oak_planks:G0,pale_oak_wood:W0,pearlescent_froglight:X0,pearlescent_froglight_horizontal:$0,pink_concrete:q0,pink_concrete_powder:Y0,pink_stained_glass:K0,pink_terracotta:j0,pink_wool:Z0,polished_andesite:J0,polished_basalt:Q0,polished_blackstone:ev,polished_blackstone_bricks:tv,polished_deepslate:nv,polished_diorite:iv,polished_granite:rv,polished_tuff:ov,prismarine:av,prismarine_bricks:sv,pumpkin:cv,purple_concrete:lv,purple_concrete_powder:dv,purple_stained_glass:uv,purple_terracotta:hv,purple_wool:fv,purpur_block:pv,purpur_pillar:mv,purpur_pillar_horizontal:_v,quartz_block:bv,quartz_bricks:gv,quartz_pillar:kv,quartz_pillar_horizontal:xv,raw_copper_block:vv,raw_gold_block:wv,raw_iron_block:Sv,redstone_block:Mv,redstone_lamp:yv,redstone_lamp_on:Ev,redstone_ore:Av,red_concrete:Tv,red_concrete_powder:Cv,red_mushroom_block_inventory:Rv,red_nether_bricks:Pv,red_sand:Lv,red_stained_glass:Dv,red_terracotta:Iv,red_wool:Uv,resin_block:Nv,resin_bricks:Fv,rooted_dirt:Ov,sand:Bv,sculk:zv,sea_lantern:Vv,shroomlight:Hv,slime_block:Gv,smithing_table:Wv,smooth_basalt:Xv,smooth_quartz:$v,smooth_red_sandstone:qv,smooth_sandstone:Yv,smooth_stone:Kv,smooth_stone_slab_double:jv,snow_block:Zv,soul_sand:Jv,soul_soil:Qv,sponge:ew,spruce_log:tw,spruce_log_horizontal:nw,spruce_planks:iw,spruce_wood:rw,acacia_planks:ow,stone_bricks:aw,stripped_acacia_log:sw,stripped_acacia_log_horizontal:cw,stripped_acacia_wood:lw,stripped_bamboo_block:dw,stripped_birch_log:uw,stripped_birch_log_horizontal:hw,stripped_birch_wood:fw,stripped_cherry_log:pw,stripped_cherry_wood:mw,stripped_crimson_hyphae:_w,stripped_crimson_stem:bw,stripped_dark_oak_log:gw,stripped_dark_oak_log_horizontal:kw,stripped_dark_oak_wood:xw,stripped_jungle_log:vw,stripped_jungle_log_horizontal:ww,stripped_jungle_wood:Sw,stripped_mangrove_log:Mw,stripped_mangrove_log_horizontal:yw,stripped_mangrove_wood:Ew,stripped_oak_log:Aw,stripped_oak_log_horizontal:Tw,stripped_oak_wood:Cw,stripped_pale_oak_log:Rw,stripped_pale_oak_log_horizontal:Pw,stripped_pale_oak_wood:Lw,stripped_spruce_log:Dw,stripped_spruce_log_horizontal:Iw,stripped_spruce_wood:Uw,stripped_warped_hyphae:Nw,stripped_warped_stem:Fw,structure_block:Ow,structure_block_corner:Bw,structure_block_data:zw,structure_block_load:Vw,structure_block_save:Hw,suspicious_gravel_0:Gw,suspicious_gravel_1:Ww,suspicious_gravel_2:Xw,suspicious_gravel_3:$w,suspicious_sand_0:qw,suspicious_sand_1:Yw,suspicious_sand_2:Kw,suspicious_sand_3:jw,target:Zw,terracotta:Jw,test_block_accept:Qw,test_block_fail:eS,test_block_log:tS,test_block_start:nS,test_instance_block:iS,tinted_glass:rS,tube_coral_block:oS,tuff:aS,tuff_bricks:sS,verdant_froglight:cS,verdant_froglight_horizontal:lS,warped_hyphae:dS,warped_planks:uS,warped_stem:hS,warped_wart_block:fS,weathered_chiseled_copper:pS,weathered_copper:mS,weathered_copper_bulb:_S,weathered_copper_bulb_lit:bS,weathered_copper_bulb_lit_powered:gS,weathered_copper_bulb_powered:kS,weathered_copper_grate:xS,weathered_cut_copper:vS,wet_sponge:wS,white_concrete:SS,white_concrete_powder:MS,white_stained_glass:yS,white_terracotta:ES,white_wool:AS,yellow_concrete:TS,yellow_concrete_powder:CS,yellow_stained_glass:RS,yellow_terracotta:PS,yellow_wool:LS,amethyst_block:DS},ja="air",Za=IS;BS(Za);const $r=new Map,Ji=new Map;bl({id:rn,name:ja,transparent:!0,textures:{}});Object.entries(Za).forEach(([i,e])=>{bl({...e,name:i})});const US=FS();function NS(){return[...Ji.entries()].sort(([i],[e])=>i-e).map(([,i])=>i.name)}function FS(){return NS().filter(i=>i!==ja)}function OS(i){const e=typeof i=="string"?i:Ji.get(i).name;return $r.get(e).transparent}function _l(i){const e=typeof i=="string"?i:Ji.get(i).name;return $r.get(e).translucent===!0}function bl(i){$r.set(i.name,i),Ji.set(i.id,i)}function gl(i){return $r.get(i).id}function kl(i){return Ji.get(i).name}function BS(i){Object.values(i).map(t=>t.id).sort((t,n)=>t-n).forEach((t,n)=>{const r=n+1;if(t!==r)throw new Error(`Expected blocks.json ids to be sequential starting at 1. Found ${t}, expected ${r}.`)})}class zS{constructor(e,t,n,r){this.inputManager=e,this.playerController=t,this.chunkLoader=n,this.blockTargetingSystem=r}inputManager;playerController;chunkLoader;blockTargetingSystem;lastBreakTime=Number.NEGATIVE_INFINITY;lastPlaceTime=Number.NEGATIVE_INFINITY;wasRotatePressed=!1;update(e){const t=this.inputManager.isPressed("ROTATE_BLOCK");let n=!1;return!this.wasRotatePressed&&t&&this.rotateHoveredBlock()&&(n=!0),this.wasRotatePressed=t,this.inputManager.isPressed("BREAK_BLOCK")&&e-this.lastBreakTime>=No.breakRepeatMs&&this.breakHoveredBlock()&&(this.lastBreakTime=e,n=!0),this.inputManager.isPressed("PLACE_BLOCK")&&e-this.lastPlaceTime>=No.placeRepeatMs&&this.placeSelectedBlock()&&(this.lastPlaceTime=e,n=!0),n}suspend(){this.wasRotatePressed=!1}rotateHoveredBlock(){const e=this.blockTargetingSystem.getHoveredBlock();return e?this.chunkLoader.rotateVoxelWorld(e.blockX,e.blockY,e.blockZ):!1}breakHoveredBlock(){const e=this.blockTargetingSystem.getHoveredBlock();return e?(this.chunkLoader.setVoxelWorld(e.blockX,e.blockY,e.blockZ,rn),!0):!1}placeSelectedBlock(){const e=this.blockTargetingSystem.getHoveredBlock();if(!e||e.normalX===0&&e.normalY===0&&e.normalZ===0)return!1;const t=this.playerController.player.getSelectedBlockName();if(!t)return!1;const n=e.blockX+e.normalX,r=e.blockY+e.normalY,o=e.blockZ+e.normalZ;if(r<kt.WORLD_BOTTOM_Y||r>=Fe.height)return!1;const a=this.chunkLoader.getVoxelIdWorld(n,r,o);return a===null||a!==rn||this.playerController.occupiesBlock(n,r,o)?!1:(this.chunkLoader.setVoxelWorld(n,r,o,gl(t)),!0)}}function VS(i,e,t,n){const r=Math.hypot(e.x,e.y,e.z);if(r===0)return null;const o=e.x/r,a=e.y/r,s=e.z/r;let c=Math.floor(i.x),l=Math.floor(i.y),d=Math.floor(i.z);const h=Math.sign(o),f=Math.sign(a),m=Math.sign(s),b=h===0?Number.POSITIVE_INFINITY:Math.abs(1/o),g=f===0?Number.POSITIVE_INFINITY:Math.abs(1/a),p=m===0?Number.POSITIVE_INFINITY:Math.abs(1/s);let u=h===0?Number.POSITIVE_INFINITY:Ur(i.x,o),v=f===0?Number.POSITIVE_INFINITY:Ur(i.y,a),M=m===0?Number.POSITIVE_INFINITY:Ur(i.z,s),y=0,E=0,A=0,T=0;for(;T<=t;){const I=n(c,l,d);if(I===null)return null;if(I!==rn)return{blockX:c,blockY:l,blockZ:d,blockId:I,normalX:y,normalY:E,normalZ:A};if(u<=v&&u<=M){T=u,c+=h,u+=b,y=-h,E=0,A=0;continue}if(v<=M){T=v,l+=f,v+=g,y=0,E=-f,A=0;continue}T=M,d+=m,M+=p,y=0,E=0,A=-m}return null}function Ur(i,e){return e<0?Ur(-i,-e):(1-(i-Math.floor(i)))/e}class HS{playerController;chunkLoader;lookDirection=new U;blockOutlineGeometry=new ol(new Sn(1,1,1));blockOutlineMaterial=new Zi({color:16767053,depthTest:!0,depthWrite:!1,transparent:!0,opacity:.95});blockOutline=null;hoveredBlock=null;constructor(e,t){this.playerController=e,this.chunkLoader=t}getHoveredBlock(){return this.hoveredBlock}getHoveredBlockId(){return this.hoveredBlock?.blockId??null}update(e){const t=this.ensureBlockOutline(e),n=this.playerController.camera;if(n.getWorldDirection(this.lookDirection),this.hoveredBlock=VS(n.position,this.lookDirection,No.maxReach,(r,o,a)=>this.chunkLoader.getVoxelIdWorld(r,o,a)),!this.hoveredBlock){t.visible=!1;return}t.position.set(this.hoveredBlock.blockX+.5,this.hoveredBlock.blockY+.5,this.hoveredBlock.blockZ+.5),t.visible=!0}clear(){this.hoveredBlock=null,this.blockOutline&&(this.blockOutline.visible=!1)}ensureBlockOutline(e){if(this.blockOutline)return this.blockOutline;const t=new Vr(this.blockOutlineGeometry,this.blockOutlineMaterial);return t.renderOrder=1e3,t.visible=!1,e.add(t),this.blockOutline=t,t}}class GS extends Y_{uiHandler;lastFrameTime;chunkLoader;hudSystem;blockTargetingSystem;blockInteractionSystem;constructor(e,t,n,r,o){super(e,n),this.uiHandler=t,this.lastFrameTime=null,this.chunkLoader=r,this.hudSystem=o,this.blockTargetingSystem=new HS(n,r),this.blockInteractionSystem=new zS(e,n,r,this.blockTargetingSystem)}toggleHUD(){this.hudSystem.toggle(),this.chunkLoader.toggleChunkWireframes()}getHoveredBlockId(){return this.blockTargetingSystem.getHoveredBlockId()}worldUpdate(e,t){this.playerController.updatePlayer(t),this.chunkLoader.updateWorldChunks(e,this.playerController.getPosition())}animate(e,t,n,r){const o=this.lastFrameTime===null?0:(e-this.lastFrameTime)/1e3;this.lastFrameTime=e;const a=this.playerController.getPosition();this.hudSystem.update({playerPosition:a,deltaTime:o,loadedChunkCount:this.chunkLoader.getLoadedChunkCount(),cachedChunkCount:this.chunkLoader.getCachedChunkCount(),pointerLocked:this.uiHandler.isPointerLocked(),uiOpen:this.uiHandler.isUIOpen()}),this.isGameplayActive()?(this.worldUpdate(n,o),this.blockTargetingSystem.update(n),this.blockInteractionSystem.update(e)&&this.blockTargetingSystem.update(n)):(this.blockInteractionSystem.suspend(),this.blockTargetingSystem.clear()),t.render(n,r)}isGameplayActive(){return this.uiHandler.isPointerLocked()&&!this.uiHandler.isUIOpen()}}const an=16,Yn="__missing__",bc=["east","west","up","down","north","south"],WS=new al,XS=new gu,Io=new Map;function xl(i){return typeof i!="string"||i.length===0?Yn:i.split("/").pop()??Yn}async function $S({blocks:i}){const{atlasLayout:e,blockFaceUvs:t,textureKeys:n}=vl(i),r=document.createElement("canvas");r.width=e.size,r.height=e.size;const o=r.getContext("2d");if(!o)throw new Error("Could not create block texture atlas canvas context.");o.imageSmoothingEnabled=!1;for(let c=0;c<n.length;c+=1){const l=n[c],d=wl(c,e);if(l===Yn)gc(o,d.x,d.y);else{const h=await eM(l);h?tM(o,h,d.x,d.y):gc(o,d.x,d.y)}}const a=new uu(r);a.colorSpace=Tt,a.magFilter=ut,a.minFilter=ut,a.wrapS=Bt,a.wrapT=Bt,a.generateMipmaps=!1,a.needsUpdate=!0;const s=r.toDataURL("image/png");return{atlasTexture:a,atlasTextureUrl:s,atlasCanvas:r,blockFaceUvs:t}}async function qS({blocks:i,textureAtlasUrl:e}){const{atlasLayout:t,blockFaceUvs:n}=vl(i),r=await new Promise((a,s)=>{XS.load(e,a,void 0,s)});r.colorSpace=Tt,r.magFilter=ut,r.minFilter=ut,r.wrapS=Bt,r.wrapT=Bt,r.generateMipmaps=!1,r.needsUpdate=!0;const o=r.image;if(o?.width!==void 0&&o?.height!==void 0&&(o.width!==t.size||o.height!==t.size))throw new Error(`Block texture atlas dimensions mismatch. Expected ${t.size}x${t.size}, received ${o.width}x${o.height}.`);return{atlasTexture:r,atlasTextureUrl:e,blockFaceUvs:n}}async function YS({blocks:i,params:e={}}){const{source:t="static",staticTextureAtlasUrl:n="/images/block-texture-atlas.png"}=e;return t==="generated"?$S({blocks:i}):qS({blocks:i,textureAtlasUrl:n})}function KS(i){const e=new Sn(1,1,1),t=e.getAttribute("uv");return i.forEach((n,r)=>{const o=r*4;for(let a=0;a<4;a+=1){const s=o+a;t.setXY(s,kc(n.minU,n.maxU,t.getX(s)),kc(n.minV,n.maxV,t.getY(s)))}}),t.needsUpdate=!0,e}function jS(i,e){const t=new Set([Yn]);return Object.values(i).forEach(n=>{const r=n.textures??{};e.forEach(o=>{t.add(xl(r[o]))})}),[...t].sort((n,r)=>n===Yn?-1:r===Yn?1:n.localeCompare(r))}function vl(i){const e=jS(i,bc),t=ZS(e.length),n=new Map;e.forEach((a,s)=>{const c=wl(s,t);n.set(a,JS({column:c.column,row:c.row,tilesPerSide:t.tilesPerSide}))});const r=n.get(Yn);if(!r)throw new Error("Missing atlas UV rect was not generated.");const o=new Map;return Object.entries(i).forEach(([a,s])=>{const c=s.textures??{},l=bc.map(d=>{const h=xl(c[d]);return n.get(h)??r});o.set(a,l)}),{atlasLayout:t,atlasUvsByTextureKey:n,blockFaceUvs:o,textureKeys:e}}function ZS(i){const e=Math.max(1,Math.ceil(Math.sqrt(i))),t=QS(e);return{tilesPerSide:t,size:t*an}}function wl(i,e){const t=i%e.tilesPerSide,n=Math.floor(i/e.tilesPerSide);return{column:t,row:n,x:t*an,y:n*an}}function JS({column:i,row:e,tilesPerSide:t}){const n=1/t;return{minU:i*n,maxU:(i+1)*n,minV:1-(e+1)*n,maxV:1-e*n}}function QS(i){return 2**Math.ceil(Math.log2(i))}async function eM(i){if(Io.has(i))return Io.get(i)??null;const e="/thr33craft",t=await new Promise(n=>{WS.load(`${e}/blocks/${i}.png`,r=>n(r),void 0,()=>n(null))});return Io.set(i,t),t}function tM(i,e,t,n){const r=Math.min(an,e.naturalWidth||e.width),o=Math.min(an,e.naturalHeight||e.height);i.drawImage(e,0,0,r,o,t,n,an,an)}function gc(i,e,t){const n=an/2;i.fillStyle="#ff00ff",i.fillRect(e,t,an,an),i.fillStyle="#111111",i.fillRect(e,t,n,n),i.fillRect(e+n,t+n,n,n)}function kc(i,e,t){return i+(e-i)*t}function Xe(...i){console.log("[DEBUG]",...i)}const xc=new Map,vc=new Map,wc=new Map,Sc=new Map;Xe("Fetching block texture atlas");const Dn=await YS({blocks:Za,params:Tc});Xe("Block texture atlas fetched");async function nM(i){Xe("Creating block mesh",i);const e=new zt(Ja(i),Qa());return Xe("Block mesh created",i),e}function Ja(i,e){const t=typeof i=="number"?kl(i):i,n=Sc.get(t);if(n)return n;const r=Dn.blockFaceUvs.get(t);if(!r)throw new Error(`Block atlas UVs for "${t}" not found`);const o=KS(r);return Sc.set(t,o),o}function Qa(i=Dn.atlasTexture){const e=xc.get(i);if(e)return e;const t=new qa({map:i,alphaTest:.5,depthWrite:!0});return xc.set(i,t),t}function Sl(i=Dn.atlasTexture){const e=vc.get(i);if(e)return e;const t=new qa({map:i,transparent:!0,opacity:.7,depthWrite:!1});return vc.set(i,t),t}function Ml(i=Dn.atlasTexture){const e=wc.get(i);if(e)return e;const t=new qa({map:i,transparent:!0,opacity:.2,depthWrite:!1});return wc.set(i,t),t}class iM{mesh;constructor(e){this.mesh=e}}class rM extends iM{speed;position;velocity;height;width;hotbarSlots;activeHotbarSlotIndex;constructor(e,t){super(e),this.speed=t.speed??7,this.position=this.mesh.position,this.velocity=new U,this.height=t.height??1.85,this.width=t.width??.6,this.hotbarSlots=Array.from({length:Gi},()=>null),this.activeHotbarSlotIndex=0}selectHotbarSlot(e){e<0||e>=this.hotbarSlots.length||(this.activeHotbarSlotIndex=e)}assignHotbarItem(e){const t=this.hotbarSlots.findIndex(o=>o?.id===e.id);if(t!==-1)return this.hotbarSlots[t]={...e},{slotIndex:t,mode:"existing"};const n=this.hotbarSlots.findIndex(o=>o===null),r=n!==-1?n:this.activeHotbarSlotIndex;return this.hotbarSlots[r]={...e},{slotIndex:r,mode:n!==-1?"empty":"replaced"}}clearActiveHotbarItem(){const e=this.hotbarSlots[this.activeHotbarSlotIndex];return e?(this.hotbarSlots[this.activeHotbarSlotIndex]=null,e):null}getSelectedBlockName(){return this.hotbarSlots[this.activeHotbarSlotIndex]?.id??null}getHotbarSnapshot(){return{slots:[...this.hotbarSlots],activeSlotIndex:this.activeHotbarSlotIndex}}move(e,t,n){this.velocity.lerp(e,Math.min(1,t*n)),this.position.addScaledVector(this.velocity,n)}}class qr{htmlElement;events;constructor(e){this.htmlElement=e,this.events=new EventTarget}show(){this.htmlElement.classList.remove("hidden")}hide(){this.htmlElement.classList.add("hidden")}on(e,t,n){return typeof t!="function"?()=>{}:(this.events.addEventListener(e,t,n),()=>{this.events.removeEventListener(e,t,n)})}off(e,t,n){typeof t=="function"&&this.events.removeEventListener(e,t,n)}emit(e,t){return this.events.dispatchEvent(new CustomEvent(e,{detail:t}))}}class yl extends qr{constructor(e){super(e),this.close()}close(){super.hide()}open(){super.show()}isVisible(){return!this.htmlElement.classList.contains("hidden")}}class oM{inputManager;ptrControls;activeUI;containedElements;constructor(e,t){this.inputManager=e,this.ptrControls=t,this.activeUI=null,this.containedElements=new Set}onActiveUIChange(e){}isUIOpen(){return this.activeUI!==null}isActiveUI(e){return this.activeUI===e}closeActiveUI(){this.activeUI!==null&&(this.activeUI.close(),this.activeUI=null,this.lockPointer(),this.onActiveUIChange(this.activeUI))}closeUI(e){this.isActiveUI(e)&&this.closeActiveUI()}setActiveUI(e){if(this.activeUI===null){this.activeUI=e,this.activeUI.open(),this.unlockPointer(),this.onActiveUIChange(this.activeUI);return}this.activeUI.close(),this.activeUI=e,this.activeUI.open(),this.unlockPointer(),this.onActiveUIChange(this.activeUI)}lockPointer(){this.ptrControls.lock()}unlockPointer(){this.ptrControls.unlock()}isPointerLocked(){return this.ptrControls.isLocked}registerContainedElement(e){this.containedElements.add(e)}unregisterContainedElement(e){this.containedElements.delete(e)}isPointInsideActiveUI(e,t){if(this.activeUI&&this.isPointInsideElement(this.activeUI.htmlElement,e,t))return!0;for(const n of this.containedElements)if(this.isPointInsideElement(n,e,t))return!0;return!1}isTargetInsideActiveUI(e){if(!(e instanceof Node))return!1;if(this.activeUI?.htmlElement.contains(e))return!0;for(const t of this.containedElements)if(t.contains(e))return!0;return!1}isPointInsideElement(e,t,n){const r=e.getBoundingClientRect();return t>=r.left&&t<=r.right&&n>=r.top&&n<=r.bottom}}class aM extends oM{modals;modalListeners;constructor(e,t){super(e,t),this.modals=new Map,this.modalListeners=new Map,this.onActiveUIChange(this.activeUI)}onActiveUIChange(e){document.body.classList.toggle("ui-open",e!==null)}registerModal(e,t){return this.modalListeners.get(e)?.(),this.modals.set(e,t),this.modalListeners.set(e,t.on("close-request",()=>{this.isActiveUI(t)&&this.closeUI(t)})),t}closeModal(e){const t=this.getModal(e);this.isActiveUI(t)&&(Xe(`Closing modal: ${e}`),this.closeUI(t))}openModal(e){const t=this.getModal(e);Xe(`Opening modal: ${e}`),this.setActiveUI(t)}toggleModal(e){const t=this.getModal(e);if(this.isActiveUI(t)){Xe(`Closing modal: ${e}`),this.closeUI(t);return}Xe(`Opening modal: ${e}`),this.setActiveUI(t)}getModal(e){if(!this.modals.has(e))throw new Error(`No modal registered with name: ${e}`);return this.modals.get(e)}}function El(i,e,t){const n=Math.max(1,e),r=Math.ceil(i/n),o=n*t,a=r*t;return{columns:n,rows:r,logicalWidth:o,logicalHeight:a,backgroundSize:`${o}px ${a}px`}}function Al(i,e,t,n){const r={};return i.forEach((o,a)=>{const s=a%e,c=Math.floor(a/e),l=s*t,d=c*t;r[o]={id:o,backgroundPosition:`-${l}px -${d}px`,backgroundSize:n}}),r}async function sM(i,e={}){const t=e.columns??16,n=e.iconSize??64,r=e.chunkSize??20,o=e.renderScale??Math.min(window.devicePixelRatio||1,2),a=e.onProgress,s=El(i.length,t,n),c=document.createElement("canvas");c.width=s.logicalWidth*o,c.height=s.logicalHeight*o;const l=c.getContext("2d");if(!l)throw new Error("Could not create the block texture sheet canvas context.");l.imageSmoothingEnabled=!0,l.clearRect(0,0,c.width,c.height);const d=new fl({alpha:!0,antialias:!0,preserveDrawingBuffer:!0});d.setPixelRatio(o),d.outputColorSpace=Tt,d.setSize(n,n,!1),d.setClearColor(0,0);const h=new nl,f=new Gr(-1.15,1.15,1.15,-1.15,.1,10);f.position.set(-2.6,1.8,2.6),f.lookAt(0,0,0),f.updateProjectionMatrix();const m=new vu(16777215,3);m.position.set(-5,10,1),m.lookAt(0,0,0),h.add(m);const b=new Sn(1,1,1),g=new Wa({transparent:!0,opacity:0}),p=new zt(b,g);h.add(p);const u=Al(i,s.columns,n,s.backgroundSize),v=i.length;Xe("Starting texture sheet generation",{totalBlocks:v,columns:t,iconSize:n,chunkSize:r,renderScale:o}),a?.({completed:0,total:v});for(let y=0;y<i.length;y+=1){const E=i[y];Xe("Generating texture sheet block",{index:y,blockName:E});const A=Ja(E),T=gl(E)===Wt?Ml(Dn.atlasTexture):_l(E)?Sl(Dn.atlasTexture):Qa(Dn.atlasTexture);p.geometry=A,p.material=T,d.clear(),d.render(h,f);const I=y%s.columns,k=Math.floor(y/s.columns),w=I*n,P=k*n;l.drawImage(d.domElement,w*o,P*o),a?.({completed:y+1,total:v}),(y+1)%r===0&&await cM()}p.material=g,p.geometry=b,b.dispose(),g.dispose(),d.dispose();const M=c.toDataURL("image/png");return{sheetCanvas:c,sheetUrl:M,textureSheetUrl:M,iconSize:n,items:i.map(y=>({...u[y],textureSheetUrl:M})),metadata:u}}function cM(){return new Promise(i=>{requestAnimationFrame(()=>i())})}class lM extends qr{slots;tooltipElement;constructor(){const e=document.createElement("div");e.className="inventory-grid hidden",super(e),this.slots=[],this.tooltipElement=document.createElement("div"),this.tooltipElement.className="inventory-tooltip inventory-tooltip-hidden tooltip-corners",(document.body??document.documentElement).appendChild(this.tooltipElement)}hide(){this.hideTooltip(),super.hide()}hideTooltip(){this.tooltipElement.classList.remove("inventory-tooltip-visible"),this.tooltipElement.classList.add("inventory-tooltip-hidden")}setTextureSheet(e){this.slots=e.items.filter(t=>t.id!==ja).map(t=>this.createSlot(t)),this.htmlElement.replaceChildren(...this.slots),this.show()}applyFilter(e){const t=e.trim().toLowerCase();let n=0;return this.slots.forEach(r=>{const a=(r.dataset.name??"").includes(t);r.classList.toggle("hidden",!a),a&&(n+=1)}),{query:t,totalCount:this.slots.length,visibleCount:n}}createSlot(e){const t=document.createElement("button");t.type="button",t.className="inventory-slot";const n=Tl(e.id),r={id:e.id,label:n,textureSheetUrl:e.textureSheetUrl,backgroundPosition:e.backgroundPosition,backgroundSize:e.backgroundSize};t.setAttribute("aria-label",n),t.dataset.name=n.toLowerCase(),t.dataset.blockId=e.id;const o=s=>{this.tooltipElement.textContent=n,this.tooltipElement.classList.remove("inventory-tooltip-hidden"),this.tooltipElement.classList.add("inventory-tooltip-visible"),this.positionTooltip(s)};t.addEventListener("mouseenter",o),t.addEventListener("pointermove",o),t.addEventListener("mouseleave",()=>this.hideTooltip()),t.addEventListener("blur",()=>this.hideTooltip()),t.addEventListener("click",()=>{this.hideTooltip(),this.emit("blockselect",r)});const a=document.createElement("span");return a.className="inventory-icon",a.style.backgroundImage=`url(${e.textureSheetUrl})`,a.style.backgroundPosition=e.backgroundPosition,a.style.backgroundSize=e.backgroundSize,t.append(a),t}positionTooltip(e){const t=this.tooltipElement,n=14,r=window.innerWidth,o=window.innerHeight,a=t.getBoundingClientRect();let s=e.clientX+n,c=e.clientY-a.height-n;s+a.width+n>r&&(s=Math.max(n,e.clientX-a.width-n)),c<n&&(c=e.clientY+n),c+a.height+n>o&&(c=Math.max(n,o-a.height-n)),s+a.width+n>r&&(s=Math.max(n,r-a.width-n)),t.style.left=`${s}px`,t.style.top=`${c}px`}}function Tl(i){return i.split("_").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" ")}class dM extends qr{inputElement;constructor(){const e=document.createElement("div");e.className="inventory-search-container",super(e),this.inputElement=document.createElement("input"),this.inputElement.autocorrect=!1,this.inputElement.type="search",this.inputElement.className="inventory-search",this.inputElement.setAttribute("aria-label","Search inventory blocks"),this.inputElement.id="inventory-search-input";const t=document.createElement("label");t.textContent="Search Blocks:",t.className="inventory-search-label",t.setAttribute("for","inventory-search-input"),this.htmlElement.append(t),this.inputElement.addEventListener("input",()=>{this.emit("querychange",{query:this.inputElement.value})}),this.htmlElement.append(this.inputElement)}clear(){this.inputElement.value=""}setDisabled(e){this.inputElement.disabled=e}}class uM{status;search;grid;downloadButtons;constructor({status:e,search:t,grid:n,downloadButtons:r}){this.status=e,this.search=t,this.grid=n,this.downloadButtons=r}showLoading(e){this.resetUnavailableView(e,"default")}showError(e){this.resetUnavailableView(e,"error")}showTextureSheet(e){this.grid.setTextureSheet(e),this.status.setMessage(this.getLoadedMessage(e.items.length),"success"),this.search.setDisabled(!1),this.setDownloadButtonsDisabled(!1),this.search.clear()}showFilterResult({query:e,totalCount:t,visibleCount:n}){this.status.setMessage(e?`${n} of ${t} blocks`:this.getLoadedMessage(t),"success")}showActionResult(e){this.status.setMessage(e,"success")}resetToLoadedState(e){this.grid.setTextureSheet(e),this.search.clear(),this.search.setDisabled(!1),this.setDownloadButtonsDisabled(!1),this.status.setMessage(this.getLoadedMessage(e.items.length),"success")}resetUnavailableView(e,t){this.status.setMessage(e,t),this.grid.hide(),this.search.setDisabled(!0),this.setDownloadButtonsDisabled(!0)}setDownloadButtonsDisabled(e){this.downloadButtons.forEach(t=>{if(e){t.setAttribute("disabled","true");return}t.removeAttribute("disabled")})}getLoadedMessage(e){return`${e} blocks loaded`}}class hM{htmlElement;constructor(e){this.htmlElement=e??document.createElement("p"),this.htmlElement.className="inventory-status"}setMessage(e,t="default"){this.htmlElement.textContent=e,this.htmlElement.classList.toggle("error",t==="error"),this.htmlElement.classList.toggle("success",t==="success")}}class fM extends yl{textureSheetDownloadFileName;textureAtlasDownloadFileName;textureSheet;textureAtlasUrl;statusComponent;headerElement;actionsElement;closeButton;downloadButton;atlasDownloadButton;searchComponent;gridComponent;stateController;constructor(e,t={}){super(e);const{showDownloadButton:n=!1,downloadFileName:r="block-texture-sheet.png"}=t.textureSheet??{},{showDownloadButton:o=!1,downloadFileName:a="block-texture-atlas.png"}=t.textureAtlas??{};this.textureSheetDownloadFileName=r,this.textureAtlasDownloadFileName=a,this.textureSheet=null,this.textureAtlasUrl=null,this.headerElement=document.createElement("div"),this.headerElement.className="inventory-header",this.actionsElement=document.createElement("div"),this.actionsElement.className="inventory-actions",this.closeButton=document.createElement("button"),this.closeButton.type="button",this.closeButton.className="inventory-action-button inventory-close-button",this.closeButton.setAttribute("aria-label","Close inventory"),this.closeButton.addEventListener("click",()=>{this.emit("close-request")}),this.downloadButton=null,n&&(this.downloadButton=document.createElement("button"),this.downloadButton.type="button",this.downloadButton.className="inventory-action-button",this.downloadButton.textContent="Download Texture Sheet",this.downloadButton.setAttribute("aria-label","Download block texture sheet"),this.downloadButton.disabled=!0,this.downloadButton.addEventListener("click",()=>{this.downloadTextureSheet()})),this.atlasDownloadButton=null,o&&(this.atlasDownloadButton=document.createElement("button"),this.atlasDownloadButton.type="button",this.atlasDownloadButton.className="inventory-action-button",this.atlasDownloadButton.textContent="Download Texture Atlas",this.atlasDownloadButton.setAttribute("aria-label","Download block texture atlas"),this.atlasDownloadButton.disabled=!0,this.atlasDownloadButton.addEventListener("click",()=>{this.downloadTextureAtlas()})),this.searchComponent=new dM,this.searchComponent.on("querychange",s=>{if(!(s instanceof CustomEvent))return;const c=s.detail;this.applyFilter(c?.query??"")}),this.gridComponent=new lM,this.gridComponent.on("blockselect",s=>{if(!(s instanceof CustomEvent))return;const c=s.detail;c&&this.emit("blockselect",c)}),this.statusComponent=new hM,this.stateController=new uM({status:this.statusComponent,search:this.searchComponent,grid:this.gridComponent,downloadButtons:[this.downloadButton,this.atlasDownloadButton].filter(s=>s!==null)}),this.actionsElement.append(this.searchComponent.htmlElement,...this.downloadButton?[this.downloadButton]:[],...this.atlasDownloadButton?[this.atlasDownloadButton]:[]),this.headerElement.append(this.statusComponent.htmlElement,this.closeButton),this.htmlElement.replaceChildren(this.headerElement,this.actionsElement,this.gridComponent.htmlElement),this.setLoadingState("Loading block texture sheet...")}setLoadingState(e){this.textureSheet=null,this.stateController.showLoading(e)}setErrorState(e){this.textureSheet=null,this.stateController.showError(e)}close(){super.close(),this.gridComponent?.hideTooltip(),this.textureSheet&&this.stateController.resetToLoadedState(this.textureSheet)}setGridTextureSheet(e){this.textureSheet=e,this.stateController.showTextureSheet(e),this.applyFilter("")}setTextureAtlasDownloadUrl(e){this.textureAtlasUrl=e,this.atlasDownloadButton?.removeAttribute("disabled")}applyFilter(e){const{query:t,totalCount:n,visibleCount:r}=this.gridComponent.applyFilter(e);this.stateController.showFilterResult({query:t,totalCount:n,visibleCount:r})}showSelectionFeedback(e){this.stateController.showActionResult(e)}downloadTextureSheet(){const e=this.textureSheet?.textureSheetUrl;e&&this.downloadUrl(e,this.textureSheetDownloadFileName)}downloadTextureAtlas(){this.textureAtlasUrl&&this.downloadUrl(this.textureAtlasUrl,this.textureAtlasDownloadFileName)}downloadUrl(e,t){const n=document.createElement("a");n.href=e,n.download=t,document.body.append(n),n.click(),n.remove()}}async function pM(i,e={}){const t=e.textureSheetUrl??"/images/block-texture-sheet.png",n=e.columns??16,r=e.iconSize??64,o=await mM(t),a=El(i.length,n,r),s=Al(i,a.columns,r,a.backgroundSize);return{textureSheetUrl:t,textureSheetImage:o,iconSize:r,items:i.map(c=>({...s[c],textureSheetUrl:t})),metadata:s}}function mM(i){return Xe("Loading block texture sheet",i),new Promise((e,t)=>{const n=new Image;n.addEventListener("load",()=>{Xe("Block texture sheet loaded",i),e(n)},{once:!0}),n.addEventListener("error",()=>{t(new Error(`Failed to load block texture sheet image: ${i}`))},{once:!0}),n.src=i})}function _M({inputManager:i,pointerControls:e,gameParams:t}){const n=new aM(i,e),r=n.registerModal("menu",new yl(t.menuHtmlElm)),o=n.registerModal("inventory",new fM(t.inventoryHtmlElm,{textureSheet:t.inventoryBlockTextureSheetParams,textureAtlas:t.blockTextureAtlasParams}));return n.openModal("menu"),Xe("Menu modal opened and inventory initialization started"),document.getElementById("reset-world")?.addEventListener("click",()=>window.location.reload()),bM(o,t.inventoryBlockTextureSheetParams),{uiHandler:n,menu:r,inventory:o}}async function bM(i,e={}){try{const{source:t="static",staticTextureSheetUrl:n="/images/block-texture-sheet.png",columns:r=16,iconSize:o=64,chunkSize:a=20,renderScale:s}=e,c=US;Xe("Initializing inventory UI",{source:t,staticTextureSheetUrl:n,columns:r,iconSize:o});const l=t==="generated"?await gM(i,c,{columns:r,iconSize:o,chunkSize:a,renderScale:s}):await kM(i,c,{textureSheetUrl:n,columns:r,iconSize:o});Xe("Inventory texture sheet loaded",{source:t,blockCount:c.length}),i.setGridTextureSheet(l),i.setTextureAtlasDownloadUrl(Dn.atlasTextureUrl)}catch(t){console.error(t),i.setErrorState("Failed to load block texture sheet.")}}function gM(i,e,t){return i.setLoadingState(`Generating block texture sheet... 0/${e.length} blocks`),sM(e,{...t,onProgress:({completed:n,total:r})=>{i.setLoadingState(`Generating block texture sheet... ${n}/${r} blocks`)}})}async function kM(i,e,t){return i.setLoadingState(`Loading block texture sheet... ${e.length} blocks`),pM(e,t)}class xM extends qr{selectedBlockLabel;slots;icons;numberBadges;constructor(e){const t=document.createElement("div");t.className="hotbar-overlay",t.setAttribute("aria-label","Player hotbar"),super(t),this.selectedBlockLabel=document.createElement("div"),this.selectedBlockLabel.className="hotbar-selected-block hidden",this.slots=[],this.icons=[],this.numberBadges=[];for(let n=0;n<e;n+=1){const r=document.createElement("div");r.className="hotbar-slot",r.setAttribute("role","listitem");const o=document.createElement("span");o.className="hotbar-slot-number",o.textContent=String(n+1);const a=document.createElement("span");a.className="hotbar-icon hotbar-icon-empty",a.setAttribute("aria-hidden","true"),r.append(a,o),this.slots.push(r),this.icons.push(a),this.numberBadges.push(o)}this.htmlElement.setAttribute("role","list"),this.htmlElement.replaceChildren(this.selectedBlockLabel,...this.slots)}render(e){const t=e.slots[e.activeSlotIndex];t?(this.selectedBlockLabel.textContent=t.label,this.selectedBlockLabel.classList.remove("hidden")):(this.selectedBlockLabel.textContent="",this.selectedBlockLabel.classList.add("hidden")),e.slots.forEach((n,r)=>{this.renderSlot(r,n,r===e.activeSlotIndex)})}renderSlot(e,t,n){const r=this.slots[e],o=this.icons[e];if(r.classList.toggle("hotbar-slot-active",n),!t){o.classList.add("hotbar-icon-empty"),o.style.backgroundImage="",o.style.backgroundPosition="",o.style.backgroundSize="",r.title=`Slot ${e+1}`,r.setAttribute("aria-label",`Slot ${e+1}, empty`);return}o.classList.remove("hotbar-icon-empty"),o.style.backgroundImage=`url(${t.textureSheetUrl})`,o.style.backgroundPosition=t.backgroundPosition,o.style.backgroundSize=t.backgroundSize,r.title=t.label,r.setAttribute("aria-label",`Slot ${e+1}, ${t.label}${n?", selected":""}`)}}class vM{constructor(e){this.chunkManager=e}chunkManager;subchunkMeshes=new Map;instancePosition=new U;instanceRotation=new Mi;instanceScale=new U(1,1,1);yAxis=new U(0,1,0);rebuildChunkMeshes(e){for(const t of e.subchunks)this.rebuildSubchunkMesh(e,t)}freeChunkMeshes(e){for(const t of e.subchunks){const n=this.subchunkMeshes.get(t);if(!n){t.dirty=!0;continue}for(const r of n.values())e.container.remove(r),r.dispose();n.clear(),this.subchunkMeshes.delete(t),t.dirty=!0}}rebuildSubchunkMesh(e,t){if(!t.dirty)return;const n=this.subchunkMeshes.get(t);if(n){for(const h of n.values())e.container.remove(h),h.dispose();n.clear()}const r=new Map,o=t.yIndex*dt.height,a=e.getWorldX(),s=e.getWorldZ();for(let h=0;h<Fe.size;h++)for(let f=0;f<dt.height;f++)for(let m=0;m<Fe.size;m++){const b=t.getVoxelId(h,f,m);if(b===rn)continue;const g=a+h,p=o+f,u=s+m;b===Wt&&this.isWaterHidden(g,p,u)||b!==Wt&&this.isHidden(g,p,u)||(r.has(b)||r.set(b,[]),r.get(b).push([h,f,m,t.getVoxelRotation(h,f,m)]))}const c=t.yIndex*dt.height,l=new tt,d=new Map;r.forEach((h,f)=>{const m=Ja(f),b=_l(f),g=f===Wt?Ml():b?Sl():Qa(),p=new au(m,g,h.length);b&&(p.renderOrder=1),p.position.set(0,c,0),h.forEach((u,v)=>{this.instancePosition.set(u[0]+.5,u[1]+.5,u[2]+.5),this.instanceRotation.setFromAxisAngle(this.yAxis,u[3]*-(Math.PI/2)),l.compose(this.instancePosition,this.instanceRotation,this.instanceScale),p.setMatrixAt(v,l)}),p.instanceMatrix.needsUpdate=!0,e.container.add(p),d.set(f,p)}),this.subchunkMeshes.set(t,d),t.dirty=!1}isHidden(e,t,n){return this.chunkManager.isVoxelOpaqueForMeshing(e,t+1,n)&&this.chunkManager.isVoxelOpaqueForMeshing(e,t-1,n)&&this.chunkManager.isVoxelOpaqueForMeshing(e+1,t,n)&&this.chunkManager.isVoxelOpaqueForMeshing(e-1,t,n)&&this.chunkManager.isVoxelOpaqueForMeshing(e,t,n+1)&&this.chunkManager.isVoxelOpaqueForMeshing(e,t,n-1)}isWaterHidden(e,t,n){return this.chunkManager.getVoxelIdWorld(e,t+1,n)===Wt&&this.chunkManager.getVoxelIdWorld(e,t-1,n)===Wt&&this.chunkManager.getVoxelIdWorld(e+1,t,n)===Wt&&this.chunkManager.getVoxelIdWorld(e-1,t,n)===Wt&&this.chunkManager.getVoxelIdWorld(e,t,n+1)===Wt&&this.chunkManager.getVoxelIdWorld(e,t,n-1)===Wt}}class wM{PRIME_X=0x5205402b9270c86fn;PRIME_Y=0x598cd327003817b5n;PRIME_Z=0x5bcc226e9fa0bacbn;HASH_MULTIPLIER=0x53a3f72deec546f5n;SEED_FLIP_3D=-0x52d547b2e96ed629n;ROOT3OVER3=.577350269189626;RSQUARED_3D=3/4;N_GRADS_3D=256;NORMALIZER_3D=.2781926117527186;gradients3D;seed;constructor(e=0){this.seed=BigInt(Math.trunc(e)),this.gradients3D=this.initGradients()}noise3ImproveXZ(e,t,n){const r=e+n,o=r*-.211324865405187,a=t*this.ROOT3OVER3,s=e+o+a,c=n+o+a,l=r*-this.ROOT3OVER3+a;return this.noise3UnrotatedBase(this.seed,s,l,c)}initGradients(){const e=[2.22474487139,2.22474487139,-1,0,2.22474487139,2.22474487139,1,0,3.0862664687972017,1.1721513422464978,0,0,1.1721513422464978,3.0862664687972017,0,0,-2.22474487139,2.22474487139,-1,0,-2.22474487139,2.22474487139,1,0,-1.1721513422464978,3.0862664687972017,0,0,-3.0862664687972017,1.1721513422464978,0,0,2.22474487139,-2.22474487139,-1,0,2.22474487139,-2.22474487139,1,0,3.0862664687972017,-1.1721513422464978,0,0,1.1721513422464978,-3.0862664687972017,0,0,-2.22474487139,-2.22474487139,-1,0,-2.22474487139,-2.22474487139,1,0,-1.1721513422464978,-3.0862664687972017,0,0,-3.0862664687972017,-1.1721513422464978,0,0,2.22474487139,-1,2.22474487139,0,2.22474487139,1,2.22474487139,0,-2.22474487139,-1,2.22474487139,0,-2.22474487139,1,2.22474487139,0,2.22474487139,-1,-2.22474487139,0,2.22474487139,1,-2.22474487139,0,-2.22474487139,-1,-2.22474487139,0,-2.22474487139,1,-2.22474487139,0];for(let n=0;n<e.length;n++)e[n]/=this.NORMALIZER_3D;const t=new Float32Array(this.N_GRADS_3D*4);for(let n=0;n<t.length;n++)t[n]=e[n%e.length];return t}fastFloor(e){return Math.floor(e)}gradient(e,t,n,r,o,a,s){const c=BigInt.asUintN(64,(e^t^n^r)*this.HASH_MULTIPLIER),l=Number(BigInt.asUintN(32,c))&this.N_GRADS_3D-1<<2;return this.gradients3D[l]*o+this.gradients3D[l+1]*a+this.gradients3D[l+2]*s}noise3UnrotatedBase(e,t,n,r){const o=this.fastFloor(t),a=this.fastFloor(n),s=this.fastFloor(r),c=t-o,l=n-a,d=r-s,h=BigInt(o)*this.PRIME_X,f=BigInt(a)*this.PRIME_Y,m=BigInt(s)*this.PRIME_Z,b=e^this.SEED_FLIP_3D,g=c>.5?1:-1,p=l>.5?1:-1,u=d>.5?1:-1,v=c-(g===1?.5:-.5),M=l-(p===1?.5:-.5),y=d-(u===1?.5:-.5),E=this.RSQUARED_3D-v*v-M*M-y*y;let A=E>0?Math.pow(E,4)*this.gradient(e,h,f,m,v,M,y):0;const T=c-.5,I=l-.5,k=d-.5,w=this.RSQUARED_3D-T*T-I*I-k*k;return A+=w>0?Math.pow(w,4)*this.gradient(b,h+this.PRIME_X,f+this.PRIME_Y,m+this.PRIME_Z,T,I,k):0,A}}const SM=new wM(xt.seed);function MM(i){return Math.max(kt.WORLD_BOTTOM_Y+1,Math.min(Fe.height-1,i))}function yM(i,e){const t=SM.noise3ImproveXZ(i*xt.noiseScale,xt.surfaceSampleY,e*xt.noiseScale),n=Math.max(-1,Math.min(1,t));return MM(Math.round(xt.baseHeight+n*xt.heightVariation))}function Cl(i){return i<=xt.seaLevel+xt.beachBand}function EM(i){return i>=xt.snowStartHeight}function AM(i){return EM(i)?Q_:Cl(i)?ml:J_}function TM(i,e){return Cl(e)&&e-i<=xt.sandDepth?ml:e-i<=xt.topsoilDepth?j_:Z_}function CM(i,e){return i===kt.WORLD_BOTTOM_Y?pl:i===e?AM(e):TM(i,e)}function RM(i,e){const t=i.getWorldX(),n=i.getWorldZ();for(let r=0;r<Fe.size;r++)for(let o=0;o<Fe.size;o++){const a=t+r,s=n+o,c=yM(a,s),l=Math.min(Fe.height-1,Math.max(c,xt.seaLevel));for(let d=kt.WORLD_BOTTOM_Y;d<=l;d++){const h=d<=c?CM(d,c):Wt;e.setVoxelInChunk(i,r,d,o,h,!1)}}}class PM{worldChunksMap=new Map;meshManager;constructor(){this.meshManager=new vM(this)}getOrCreateChunk(e,t){const n=this.getChunkKey(e,t),r=this.worldChunksMap.get(n);if(r)return r;const o=new Fe(e,t);return this.worldChunksMap.set(n,o),o}getChunkIfExists(e,t){return this.worldChunksMap.get(this.getChunkKey(e,t))??null}getNeighborChunk(e,t,n){const r=this.getChunkKey(e.chunkX+t,e.chunkZ+n);return this.worldChunksMap.get(r)??null}deleteChunk(e){this.worldChunksMap.delete(e.getKey())}ensureChunkGenerated(e){return e.isDataGenerated?[]:(RM(e,this),e.isDataGenerated=!0,this.markGeneratedNeighborChunksDirty(e))}setVoxelInChunk(e,t,n,r,o,a){const s=e.getSubchunk(n),c=n%dt.height;s.setVoxel(t,c,r,o),this.markNeighborSubchunksDirtyForEdgeVoxel(e,s.yIndex,t,c,r),a&&(e.isModified=!0)}setVoxelWorld(e,t,n,r){const{chunkX:o,chunkZ:a}=Fe.worldToChunkCoords(e,n),s=this.getOrCreateChunk(o,a),c=Pn(e,Fe.size),l=Pn(n,Fe.size);return this.setVoxelInChunk(s,c,t,l,r,s.isDataGenerated),this.collectChunksNeedingMeshRebuild(s,c,l)}getVoxelIdWorld(e,t,n){return this.tryGetVoxelIdWorld(e,t,n)}rotateVoxelWorld(e,t,n){const r=this.tryGetVoxelRefWorld(e,t,n);if(!r)return!1;const{chunk:o,subchunk:a,localX:s,localY:c,localZ:l}=r;return a.getVoxelId(s,c,l)===rn?!1:(a.setVoxelRotation(s,c,l,a.getVoxelRotation(s,c,l)+1),o.isDataGenerated&&(o.isModified=!0),!0)}isVoxelSolidWorld(e,t,n){if(t<kt.WORLD_BOTTOM_Y)return!0;const r=this.tryGetVoxelIdWorld(e,t,n);return r!==null&&r!==rn&&r!==Wt}isVoxelSolidForMeshing(e,t,n){if(t<kt.WORLD_BOTTOM_Y)return!0;const r=this.tryGetVoxelIdWorld(e,t,n);return r===null?!0:r!==rn}isVoxelOpaqueForMeshing(e,t,n){if(t<kt.WORLD_BOTTOM_Y)return!0;const r=this.tryGetVoxelIdWorld(e,t,n);return r===null?!0:r!==rn&&!OS(r)}rebuildChunkMeshes(e){this.meshManager.rebuildChunkMeshes(e)}freeChunkMeshes(e){this.meshManager.freeChunkMeshes(e)}getChunkCount(){return this.worldChunksMap.size}tryGetVoxelIdWorld(e,t,n){if(t<kt.WORLD_BOTTOM_Y||t>=Fe.height)return rn;const r=this.tryGetVoxelRefWorld(e,t,n);return r?r.subchunk.getVoxelId(r.localX,r.localY,r.localZ):null}tryGetVoxelRefWorld(e,t,n){if(t<kt.WORLD_BOTTOM_Y||t>=Fe.height)return null;const{chunkX:r,chunkZ:o}=Fe.worldToChunkCoords(e,n),a=this.worldChunksMap.get(this.getChunkKey(r,o));if(!a||!a.isDataGenerated)return null;const s=Pn(e,Fe.size),c=Pn(n,Fe.size),l=a.getSubchunk(t),d=t%dt.height;return{chunk:a,subchunk:l,localX:s,localY:d,localZ:c}}markNeighborSubchunksDirtyForEdgeVoxel(e,t,n,r,o){n===0&&this.getNeighborChunk(e,-1,0)?.getSubchunk(t*dt.height).markDirty(),n===Fe.size-1&&this.getNeighborChunk(e,1,0)?.getSubchunk(t*dt.height).markDirty(),o===0&&this.getNeighborChunk(e,0,-1)?.getSubchunk(t*dt.height).markDirty(),o===Fe.size-1&&this.getNeighborChunk(e,0,1)?.getSubchunk(t*dt.height).markDirty(),r===0&&t>0&&e.getSubchunk((t-1)*dt.height).markDirty(),r===dt.height-1&&t<e.subchunkCount-1&&e.getSubchunk((t+1)*dt.height).markDirty()}collectChunksNeedingMeshRebuild(e,t,n){const r=new Set;return e.isDataGenerated&&r.add(e),t===0&&this.addGeneratedNeighborChunk(r,e,-1,0),t===Fe.size-1&&this.addGeneratedNeighborChunk(r,e,1,0),n===0&&this.addGeneratedNeighborChunk(r,e,0,-1),n===Fe.size-1&&this.addGeneratedNeighborChunk(r,e,0,1),Array.from(r)}addGeneratedNeighborChunk(e,t,n,r){const o=this.getNeighborChunk(t,n,r);o?.isDataGenerated&&e.add(o)}markGeneratedNeighborChunksDirty(e){const t=[this.getNeighborChunk(e,-1,0),this.getNeighborChunk(e,1,0),this.getNeighborChunk(e,0,-1),this.getNeighborChunk(e,0,1)].filter(n=>n?.isDataGenerated===!0);for(const n of t)this.markAllSubchunksDirty(n);return t}markAllSubchunksDirty(e){for(const t of e.subchunks)t.markDirty()}getChunkKey(e,t){return`${e},${t}`}}class LM{constructor(e){this.chunkManager=e}chunkManager;activeChunkKeys=new Set;buildQueue=[];refreshVisibleChunks(e,t,n,r){const o=this.collectChunkKeysWithinRadius(t,n,r),a=[];for(const s of this.activeChunkKeys){if(o.has(s))continue;const{chunkX:c,chunkZ:l}=this.parseChunkKey(s),d=this.chunkManager.getChunkIfExists(c,l);d&&a.push(d)}return this.activeChunkKeys=o,this.buildQueue=this.getChunkCoordsWithinRadiusSorted(t,n,r).filter(({chunkX:s,chunkZ:c})=>{const l=this.chunkManager.getChunkIfExists(s,c);return!l||l.container.parent!==e}),a}dequeueChunkToBuild(){return this.buildQueue.shift()}getLoadedChunkCount(){return this.activeChunkKeys.size}collectChunkKeysWithinRadius(e,t,n){const r=new Set;for(let o=e-n;o<=e+n;o++)for(let a=t-n;a<=t+n;a++)r.add(this.getChunkKey(o,a));return r}getChunkCoordsWithinRadiusSorted(e,t,n){return Array.from(this.activeChunkKeys,o=>this.parseChunkKey(o)).filter(({chunkX:o,chunkZ:a})=>this.getChunkDistance(o,a,e,t)<=n).sort((o,a)=>{const s=this.getChunkDistance(o.chunkX,o.chunkZ,e,t),c=this.getChunkDistance(a.chunkX,a.chunkZ,e,t);return s-c})}getChunkDistance(e,t,n,r){return Math.max(Math.abs(e-n),Math.abs(t-r))}getChunkKey(e,t){return`${e},${t}`}parseChunkKey(e){const[t,n]=e.split(",").map(r=>Number.parseInt(r,10));return{chunkX:t,chunkZ:n}}}function DM(){const i=[],e=Fe.size,t=Fe.height,n=dt.height,r=t/n;for(let c=0;c<=e;c++)i.push(0,0,c,e,0,c),i.push(c,0,0,c,0,e),i.push(0,t,c,e,t,c),i.push(c,t,0,c,t,e);for(let c=0;c<=e;c++)i.push(c,0,0,c,t,0),i.push(c,0,e,c,t,e),i.push(0,0,c,0,t,c),i.push(e,0,c,e,t,c);for(let c=1;c<r;c++){const l=c*n;for(let d=0;d<=e;d++)i.push(d,l,0,d,l,e);for(let d=0;d<=e;d++)i.push(0,l,d,e,l,d)}for(let c=0;c<=t;c++)i.push(0,c,0,e,c,0),i.push(0,c,e,e,c,e),i.push(0,c,0,0,c,e),i.push(e,c,0,e,c,e);const o=new Vt;o.setAttribute("position",new Ct(i,3));const a=new Zi({color:16711680,transparent:!0,opacity:.55,depthTest:!0,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1}),s=new Vr(o,a);return s.renderOrder=999,s.visible=!1,s}function IM(i,e,t){i.position.set(e*Fe.size,0,t*Fe.size)}class UM{wireframeVisible=!1;wireframe;currentChunkKey=null;constructor(){this.wireframe=DM()}attachChunk(e,t){t.container.parent!==e&&e.add(t.container)}removeChunk(e,t){e.remove(t.container)}toggleChunkWireframes(){this.setWireframeVisibility(!this.wireframeVisible)}setWireframeVisibility(e){this.wireframeVisible=e,this.wireframe.visible=e}updateCurrentChunkWireframe(e,t,n){if(!this.wireframeVisible)return;const r=`${t},${n}`;this.currentChunkKey!==r&&(this.currentChunkKey=r,IM(this.wireframe,t,n),this.wireframe.parent!==e&&e.add(this.wireframe))}}class NM{chunkManager;loadPlanner;sceneController;pendingChunkRefreshKeys=new Set;pendingChunkRefreshQueue=[];framesSinceLastLoad=kt.CHUNK_LOAD_INTERVAL;constructor(){this.chunkManager=new PM,this.loadPlanner=new LM(this.chunkManager),this.sceneController=new UM}updateWorldChunks(e,t){const{chunkX:n,chunkZ:r}=Fe.worldToChunkCoords(t.x,t.z);this.shouldRefreshVisibleChunks()?(this.refreshVisibleChunks(e,n,r),this.framesSinceLastLoad=0):this.framesSinceLastLoad++,this.processBuildQueue(e),this.sceneController.updateCurrentChunkWireframe(e,n,r)}shouldRefreshVisibleChunks(){return this.framesSinceLastLoad>=kt.CHUNK_LOAD_INTERVAL}refreshVisibleChunks(e,t,n){const r=kt.RENDER_DISTANCE,o=this.loadPlanner.refreshVisibleChunks(e,t,n,r);this.purgeUnmodifiedChunksOutsideRadius(e,o)}processBuildQueue(e){const t=this.loadPlanner.dequeueChunkToBuild();if(!t){this.processPendingChunkRefresh();return}const n=this.chunkManager.getOrCreateChunk(t.chunkX,t.chunkZ),r=this.chunkManager.ensureChunkGenerated(n);this.chunkManager.rebuildChunkMeshes(n),this.enqueueChunkRefreshes(r),this.sceneController.attachChunk(e,n)}purgeUnmodifiedChunksOutsideRadius(e,t){for(const n of t)this.sceneController.removeChunk(e,n),this.chunkManager.freeChunkMeshes(n),n.isModified||this.chunkManager.deleteChunk(n),this.pendingChunkRefreshKeys.delete(n.getKey())}enqueueChunkRefreshes(e){for(const t of e){const n=t.getKey();this.pendingChunkRefreshKeys.has(n)||(this.pendingChunkRefreshKeys.add(n),this.pendingChunkRefreshQueue.push(n))}}processPendingChunkRefresh(){const e=this.pendingChunkRefreshQueue.shift();if(!e)return;this.pendingChunkRefreshKeys.delete(e);const[t,n]=e.split(",").map(o=>Number.parseInt(o,10)),r=this.chunkManager.getChunkIfExists(t,n);r?.isDataGenerated&&this.chunkManager.rebuildChunkMeshes(r)}setVoxelWorld(e,t,n,r){const o=this.chunkManager.setVoxelWorld(e,t,n,r);for(const a of o)this.chunkManager.rebuildChunkMeshes(a)}isVoxelSolidWorld(e,t,n){return this.chunkManager.isVoxelSolidWorld(e,t,n)}getVoxelIdWorld(e,t,n){return this.chunkManager.getVoxelIdWorld(e,t,n)}rotateVoxelWorld(e,t,n){if(!this.chunkManager.rotateVoxelWorld(e,t,n))return!1;const{chunkX:o,chunkZ:a}=Fe.worldToChunkCoords(e,n),s=this.chunkManager.getChunkIfExists(o,a);return s?(this.chunkManager.rebuildChunkMeshes(s),!0):!1}getLoadedChunkCount(){return this.loadPlanner.getLoadedChunkCount()}getCachedChunkCount(){return this.chunkManager.getChunkCount()}toggleChunkWireframes(){this.sceneController.toggleChunkWireframes()}setWireframeVisibility(e){this.sceneController.setWireframeVisibility(e)}}class FM{htmlElement;visible;smoothedFps;toggleElements;constructor(){this.htmlElement=document.createElement("div"),this.htmlElement.className="hud gameplay",document.body.appendChild(this.htmlElement),this.visible=!1,this.smoothedFps=0,this.toggleElements=[]}registerToggleElement(e){this.toggleElements.push(e),this.syncElementVisibility(e)}toggle(){this.visible=!this.visible,this.syncVisibility()}update(e){const{playerPosition:t,deltaTime:n}=e,r=Math.floor(t.x),o=Math.floor(t.y),a=Math.floor(t.z),s=Math.floor(r/Fe.size),c=Math.floor(a/Fe.size),l=Math.floor(o/dt.height),d=Pn(r,Fe.size),h=Pn(o,Fe.height),f=Pn(a,Fe.size),m=Pn(o,dt.height),b=n*1e3,g=n>0?1/n:0;this.smoothedFps=this.smoothedFps===0?g:this.smoothedFps*.9+g*.1,this.htmlElement.textContent=[`FPS: ${this.formatNumber(this.smoothedFps,1)} | Frame: ${this.formatNumber(b,2)} ms`,`World: (${this.formatNumber(t.x,2)}, ${this.formatNumber(t.y,2)}, ${this.formatNumber(t.z,2)})`,`Block: (${r}, ${o}, ${a})`,`Chunk: (${s}, ${c}) | Local: (${d}, ${h}, ${f})`,`Subchunk: (${s}, ${l}, ${c}) | Local Y: ${m}`,`Loaded Chunks: ${e.loadedChunkCount} | Cached Chunks: ${e.cachedChunkCount}`,`Render Distance: ${kt.RENDER_DISTANCE} | Pointer: ${e.pointerLocked?"locked":"free"} | UI: ${e.uiOpen?"open":"closed"}`].join(`
`),this.syncVisibility()}syncVisibility(){this.htmlElement.classList.toggle("hidden",!this.visible),this.toggleElements.forEach(e=>{this.syncElementVisibility(e)})}syncElementVisibility(e){e.classList.toggle("hidden",!this.visible)}formatNumber(e,t){return Number.isFinite(e)?e.toFixed(t):"0.00"}}async function OM({scene:i,camera:e,pointerControls:t,gameParams:n,options:r={}}){const{keyPreset:o=n.keysPreset??La,player:a={},actions:s={}}=r,{blockName:c="redstone_block",spawnPosition:l=kt.PLAYER_STARTING_POSITION,params:d=n.playerParams}=a,{menu:h="MENU",inventory:f="INVENTORY",hud:m="HUD_TOGGLE"}=s,b=new W_;b.init(o);const g=new X_,p=new G_(b,g);Xe("Creating player mesh",c);const u=await nM(c);Xe("Player mesh created",{blockName:c}),u.position.set(...l),i.add(u);const v=new rM(u,d),M=new NM,y=new q_(v,p,e,M),E=new FM,{uiHandler:A,inventory:T}=_M({inputManager:p,pointerControls:t,gameParams:n});HM(i,M,E,y,A);const I=new xM(Gi);document.body.appendChild(I.htmlElement),A.registerContainedElement(I.htmlElement),I.render(v.getHotbarSnapshot());const k=new GS(p,A,y,M,E),w=F=>{const V=v.assignHotbarItem(F);I.render(v.getHotbarSnapshot()),T.showSelectionFeedback(BM(F.label,V,v)),Xe("Hotbar item assigned",{blockId:F.id,slot:V.slotIndex+1,mode:V.mode,selectedBlock:v.getSelectedBlockName()})},P=F=>{const V=kl(F),$=T.textureSheet?.metadata[V],H=T.textureSheet?.textureSheetUrl;return!$||!H?null:{id:V,label:Tl(V),textureSheetUrl:H,backgroundPosition:$.backgroundPosition,backgroundSize:$.backgroundSize}},z=()=>{const F=v.clearActiveHotbarItem();if(I.render(v.getHotbarSnapshot()),!F){T.showSelectionFeedback("Active hotbar slot is already empty");return}T.showSelectionFeedback(`Removed ${F.label} from hotbar slot ${v.activeHotbarSlotIndex+1}`),Xe("Hotbar item removed",{blockId:F.id,slot:v.activeHotbarSlotIndex+1})};return Xe("UI initialized"),T.on("blockselect",F=>{if(!(F instanceof CustomEvent))return;const V=F.detail;V&&w(V)}),zM({system:k,player:v,hotbar:I,keyStore:g,uiHandler:A,assignHotbarItem:w,removeActiveHotbarItem:z,getInventorySelectionDetailForBlock:P,menuAction:h,inventoryAction:f,hudAction:m}),{player:v,system:k,uiHandler:A,inputManager:p,keyStore:g}}function BM(i,e,t){const n=e.slotIndex+1;return e.mode==="existing"?`${i} is already in hotbar slot ${n}`:e.mode==="replaced"?`Replaced active slot ${t.activeHotbarSlotIndex+1} with ${i}`:`Added ${i} to hotbar slot ${n}`}function zM({system:i,player:e,hotbar:t,keyStore:n,uiHandler:r,assignHotbarItem:o,removeActiveHotbarItem:a,getInventorySelectionDetailForBlock:s,menuAction:c,inventoryAction:l,hudAction:d}){const h=(g,p)=>{const u=v=>{Rl(v)||p(v.key.toLowerCase(),v)};document.addEventListener(g,u)},f=VM(),m=g=>g===0?"mouse-left":g===1?"mouse-middle":g===2?"mouse-right":null,b=g=>{e.selectHotbarSlot(g),t.render(e.getHotbarSnapshot()),Xe("Hotbar slot selected",{slot:g+1,selectedBlock:e.getSelectedBlockName()})};h("keydown",g=>{Xe(g,"pressed"),n.addPressedKey(g)}),h("keyup",g=>{Xe(g,"released"),n.removePressedKey(g)}),h("keydown",(g,p)=>{!p.repeat&&i.inputManager.isPressed(c)&&r.toggleModal("menu")}),h("keydown",(g,p)=>{!p.repeat&&i.inputManager.isPressed(l)&&r.toggleModal("inventory")}),h("keydown",(g,p)=>{!p.repeat&&i.inputManager.isPressed(d)&&i.toggleHUD()}),h("keydown",(g,p)=>{p.repeat||r.isUIOpen()||!r.isPointerLocked()||i.inputManager.isPressed("REMOVE_HOTBAR_ITEM")&&(p.preventDefault(),a())}),h("keydown",(g,p)=>{if(!p.repeat){for(let u=0;u<Gi;u+=1)if(i.inputManager.isPressed(`HOTBAR_SLOT_${u+1}`)){b(u);return}}}),document.addEventListener("wheel",g=>{if(r.isUIOpen()||!r.isPointerLocked()||g.deltaY===0)return;g.preventDefault();const p=g.deltaY<0?-1:1,u=(e.activeHotbarSlotIndex+p+Gi)%Gi;b(u)},{passive:!1}),document.addEventListener("pointerdown",g=>{const p=m(g.button);if(!p||(g.button===1&&g.preventDefault(),!r.isPointerLocked()||r.isUIOpen())||(n.addPressedKey(p),g.button!==1))return;const u=i.getHoveredBlockId();if(u===null)return;const v=s(u);v&&o(v)}),document.addEventListener("pointerup",g=>{const p=m(g.button);p&&n.removePressedKey(p)}),document.addEventListener("click",g=>{r.isTargetInsideActiveUI(g.target)||g instanceof MouseEvent&&r.isPointInsideActiveUI(g.clientX,g.clientY)||r.isPointerLocked()||(r.closeActiveUI(),r.lockPointer())}),window.addEventListener("blur",()=>{Xe("Window blurred, clearing key store"),n.clear(),f.classList.add("visible")}),window.addEventListener("focus",()=>{Xe("Window focused"),setTimeout(()=>{f.classList.remove("visible")},400)}),document.addEventListener("contextmenu",g=>{g.preventDefault()}),document.addEventListener("auxclick",g=>{g.button===1&&g.preventDefault()})}function VM(){const i=document.createElement("div");return i.className="focus-window-message",i.textContent="Window out of focus",document.body.appendChild(i),i}function Rl(i){const e=i.target;return e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement||e instanceof HTMLElement&&e.isContentEditable}function HM(i,e,t,n,r){const o=new ol(new Sn(1,1,1)),a=new Zi({color:16767053}),s=()=>new Vr(o,a),c={x:0,y:30,z:0,collisionEnabled:n.isCollisionEnabled(),placeDebugBlock(){const{x:b,y:g,z:p}=c;e.setVoxelWorld(b,g,p,pl);const u=s();u.position.set(b+.5,g+.5,p+.5),i.add(u),Xe(`Origin alignment debug marker placed at world cell (${b}, ${g}, ${p})`)},clearDebugBlock(){const{x:b,y:g,z:p}=c;e.setVoxelWorld(b,g,p,0),Xe(`Cleared block at world cell (${b}, ${g}, ${p})`)}},l=s();l.position.set(c.x+.5,c.y+.5,c.z+.5),i.add(l);const d={...Ec(),...xt,applyTerrainSettings(){Ac({seed:d.seed,noiseScale:d.noiseScale,surfaceSampleY:d.surfaceSampleY,baseHeight:d.baseHeight,heightVariation:d.heightVariation,topsoilDepth:d.topsoilDepth,beachBand:d.beachBand,sandDepth:d.sandDepth,snowStartHeight:d.snowStartHeight,seaLevel:d.seaLevel,spawnClearance:d.spawnClearance}),window.location.reload()},resetTerrainSettings(){Gl(),window.location.reload()}},h=new Ka({title:"Debug Controls"});t.registerToggleElement(h.domElement),r.registerContainedElement(h.domElement);const f=h.addFolder("Debug Placement");f.add(c,"x").name("World X").step(1).onChange(b=>{l.position.x=b+.5}),f.add(c,"y").name("World Y").step(1).onChange(b=>{l.position.y=b+.5}),f.add(c,"z").name("World Z").step(1).onChange(b=>{l.position.z=b+.5}),f.add(c,"collisionEnabled").name("Player Collision").onChange(b=>{n.setCollisionEnabled(b),Xe(`Player collision ${b?"enabled":"disabled"}`)}),f.add(c,"placeDebugBlock").name("Place Debug Block"),f.add(c,"clearDebugBlock").name("Set To Air"),f.open();const m=h.addFolder("Terrain Generation");m.add(d,"seed").name("Seed").step(1),m.add(d,"noiseScale").name("Noise Scale").min(.001).max(.25).step(.001),m.add(d,"surfaceSampleY").name("Noise Sample Y").min(-128).max(128).step(.5),m.add(d,"baseHeight").name("Base Height").min(1).max(96).step(1),m.add(d,"heightVariation").name("Height Range").min(0).max(48).step(1),m.add(d,"topsoilDepth").name("Topsoil Depth").min(1).max(12).step(1),m.add(d,"beachBand").name("Beach Band").min(0).max(8).step(1),m.add(d,"sandDepth").name("Sand Depth").min(1).max(8).step(1),m.add(d,"snowStartHeight").name("Snow Line").min(0).max(127).step(1),m.add(d,"seaLevel").name("Sea Level").min(0).max(127).step(1),m.add(d,"spawnClearance").name("Spawn Clearance").min(2).max(24).step(1),m.add(d,"applyTerrainSettings").name("Apply + Reload"),m.add(d,"resetTerrainSettings").name("Reset Terrain"),document.addEventListener("keydown",b=>{b.repeat||Rl(b)||b.key.toLowerCase()==="p"&&c.placeDebugBlock()})}async function GM(){Xe("Bootstrapping game...");const{scene:i,renderer:e,camera:t,pointerControls:n}=R_(ls);Xe("Scene initialized",ls);const{system:r}=await OM({scene:i,camera:t,pointerControls:n,gameParams:$l,options:ed});Xe("System initialized",{system:r}),Mc.remove(),globalThis.system=r,globalThis.scene=i,e.setAnimationLoop(o=>{r.animate(o,e,i,t)}),Xe("Render loop started"),Bl(t,e)}await GM();
